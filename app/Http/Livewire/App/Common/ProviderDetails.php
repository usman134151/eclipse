...
{
    public $user, $userid , $accommodation_catalog;
    ...
    public function showDetails($user){
		...
		$query->select([
			...
			'service_categories.id as service_id','service_categories.name as service_name','service_categories.id as service_id',
