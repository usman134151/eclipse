...
final class AssignmentLogs extends PowerGridComponent
{
    use ActionButton;
    public $booking_id;
    ...
    */
    public function datasource(): Builder
    {
        ...
        if(session()->get('isCustomer'))
            $query->whereNotIn('type',['Booking Invitation','Assignment Invitation','auto-assigned','auto-notified','checkout update','surrendered']);
        $query->latest(); 
        return $query;
    }
    ...
    */
    ...
    {
        return [
            Column::make('DATE & TIME', 'created_at_formatted', 'created_at')
            ->searchable(),
