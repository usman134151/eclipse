...
class Tags extends PowerGridComponent
{
    use ActionButton;
    protected $listeners = ['refresh'=>'setUp'];
    public $name;
    protected $deleteRecordId;
    /*
    |--------------------------------------------------------------------------
    |  Features Setup
    |--------------------------------------------------------------------------
    ...
    */
     ...
     *
     * @return Builder<\App\Models\Tenant\Tag>
     */
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ->addColumn('name')
            ->addColumn('status', function (Tag $model) {
                return ($model->status);
            })
            ->addColumn('edit',function(Tag $model){
                return '<div class="d-flex actions">
                <a href="#" title="Edit Tag" wire:click="edit('.$model->id.')"  aria-label="Edit Tag" class="btn btn-sm btn-secondary rounded btn-hs-icon">
                   <svg aria-label="Edit Tag" width="30" height="30" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><use xlink:href="/css/sprite.svg#edit-icon"></use></svg>
                </a>

            <a href="#" title="Delete Tag" aria-label="Delete Tag" wire:click="deleteRecord('.$model->id.')"  class="btn btn-sm btn-secondary rounded btn-hs-icon">
            <svg aria-label="Delete Tag" width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg"><use xlink:href="/css/sprite.svg#delete-icon"></use></svg>
            </a>
              </div>';
            });
    }
    ...
    function edit($id){
        ...
        $this->emit('showForm', Tag::find($id));
    }
