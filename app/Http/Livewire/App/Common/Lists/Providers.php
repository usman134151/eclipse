	...
	public function addColumns(): PowerGridEloquent
	{
		...
		->addColumn('customer', function (User $model) {
			if($model->profile_pic==null)
				...
				$col = '<div class="row g-2 align-items-center"><div class="col-md-2"><img src="' . $model->profile_pic . '" style="height=86px" class="img-fluid rounded-circle" alt="Profile Image"></div><div class="col-md-10"><h6 class="fw-semibold">' . $model->name . '</h6><p>' . $model->email . '</p></div></div>';
			return $col;
		})
		->addColumn('phone')
