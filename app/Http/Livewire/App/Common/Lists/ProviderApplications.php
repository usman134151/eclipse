...
final class ProviderApplications extends PowerGridComponent
{
    use ActionButton;
    ...
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('edit',function(User $model){
                ...
                <a href="#" title="Edit User" wire:click="edit('.$model->id.')"  aria-label="Edit User" class="btn btn-sm btn-secondary rounded btn-hs-icon">
            ...
            <a href="#" title="Delete User" aria-label="Delete User" wire:click="deleteRecord('.$model->id.')"  class="btn btn-sm btn-secondary rounded btn-hs-icon">
