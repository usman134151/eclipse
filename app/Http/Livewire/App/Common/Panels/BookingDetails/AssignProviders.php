...
class AssignProviders extends Component
{
    ...
    public $b_hours_duration = 0, $a_hours_duration = 0, $expedited_hours=0;
    public $setupValues = [
    ...
    public function mount($service_id = null, $panelType = 1)
    {
        ...
        if ($panelType == 2) {
            ...
            if ($booking_service) {
                ...
                // $this->bookingService['calculations'] = $booking_service['service_calculations'];
