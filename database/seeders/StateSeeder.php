...
class StateSeeder extends Seeder
{
  ...
  */
  ...
  {
    $states = array(
      array('name' => "Alabama","short_name" => "AL",'country_id' => 231),
      array('name' => "Alaska","short_name" => "AK",'country_id' => 231),
      array('name' => "Arizona","short_name" => "AZ",'country_id' => 231),
      array('name' => "Arkansas","short_name" => "AR",'country_id' => 231),
      // array('name' => "Byram","short_name" => "",'country_id' => 231),
      array('name' => "California","short_name" => "CA",'country_id' => 231),
      // array('name' => "Cokato","short_name" => "",'country_id' => 231),
      array('name' => "Colorado","short_name" => "CO",'country_id' => 231),
      array('name' => "Connecticut","short_name" => "CT",'country_id' => 231),
      array('name' => "Delaware","short_name" => "DE",'country_id' => 231),
      array('name' => "District of Columbia","short_name" => "DC",'country_id' => 231),
      array('name' => "Florida","short_name" => "FL",'country_id' => 231),
      array('name' => "Georgia","short_name" => "GA",'country_id' => 231),
      array('name' => "Hawaii","short_name" => "HI",'country_id' => 231),
      array('name' => "Idaho","short_name" => "ID",'country_id' => 231),
      array('name' => "Illinois","short_name" => "IL",'country_id' => 231),
      array('name' => "Indiana","short_name" => "IN",'country_id' => 231),
      array('name' => "Iowa","short_name" => "IA",'country_id' => 231),
      array('name' => "Kansas","short_name" => "KS",'country_id' => 231),
      array('name' => "Kentucky","short_name" => "KY",'country_id' => 231),
      array('name' => "Louisiana","short_name" => "LA",'country_id' => 231),
      // array('name' => "Lowa","short_name" => "",'country_id' => 231),
      array('name' => "Maine","short_name" => "ME",'country_id' => 231),
      array('name' => "Maryland","short_name" => "MD",'country_id' => 231),
      array('name' => "Massachusetts","short_name" => "MA",'country_id' => 231),
      // array('name' => "Medfield","short_name" => "",'country_id' => 231),
      array('name' => "Michigan","short_name" => "MI",'country_id' => 231),
      array('name' => "Minnesota","short_name" => "MN",'country_id' => 231),
      array('name' => "Mississippi","short_name" => "MS",'country_id' => 231),
      array('name' => "Missouri","short_name" => "MO",'country_id' => 231),
      array('name' => "Montana","short_name" => "MT",'country_id' => 231),
      array('name' => "Nebraska","short_name" => "NE",'country_id' => 231),
      array('name' => "Nevada","short_name" => "NV",'country_id' => 231),
      array('name' => "New Hampshire","short_name" => "NH",'country_id' => 231),
      array('name' => "New Jersey","short_name" => "NJ",'country_id' => 231),
      // array('name' => "New Jersy","short_name" => "",'country_id' => 231),
      array('name' => "New Mexico","short_name" => "NM",'country_id' => 231),
      array('name' => "New York","short_name" => "NY",'country_id' => 231),
      array('name' => "North Carolina","short_name" => "NC",'country_id' => 231),
      array('name' => "North Dakota","short_name" => "ND",'country_id' => 231),
      array('name' => "Ohio","short_name" => "OH",'country_id' => 231),
      array('name' => "Oklahoma","short_name" => "OK",'country_id' => 231),
      // array('name' => "Ontario","short_name" => "",'country_id' => 231),
      array('name' => "Oregon","short_name" => "OR",'country_id' => 231),
      array('name' => "Pennsylvania","short_name" => "PA",'country_id' => 231),
      // array('name' => "Ramey","short_name" => "",'country_id' => 231),
      array('name' => "Rhode Island","short_name" => "RI",'country_id' => 231),
      array('name' => "South Carolina","short_name" => "SC",'country_id' => 231),
      array('name' => "South Dakota","short_name" => "SD",'country_id' => 231),
      // array('name' => "Sublimity","short_name" => "",'country_id' => 231),
      array('name' => "Tennessee","short_name" => "TN",'country_id' => 231),
      array('name' => "Texas","short_name" => "TX",'country_id' => 231),
      // array('name' => "Trimble","short_name" => "",'country_id' => 231),
      array('name' => "Utah","short_name" => "UT",'country_id' => 231),
      array('name' => "Vermont","short_name" => "VT",'country_id' => 231),
      array('name' => "Virginia","short_name" => "VA",'country_id' => 231),
      array('name' => "Washington","short_name" => "WA",'country_id' => 231),
      array('name' => "West Virginia","short_name" => "WV",'country_id' => 231),
      array('name' => "Wisconsin","short_name" => "WI",'country_id' => 231),
      array('name' => "Wyoming","short_name" => "WY",'country_id' => 231),
