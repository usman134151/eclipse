...
Route::group([
	...
	Route::middleware(['auth', 'otpcheck', CheckSubscription::class])->group(function () {
		...
		Route::middleware(['role:admin'])->group(function () {
			...
			Route::view('/admin/teams', 'tenant/admin/teams', ["showForm" => false, "showProfile" => false]);
			Route::view('/admin/teams/create-team', 'tenant/admin/teams', ["showForm" => true, "showProfile" => false]);
	...
	Route::get('/closeactivebookings', [BookingOperationsService::class, 'closeAllActiveBookings']);
