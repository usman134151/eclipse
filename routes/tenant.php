...
Route::group([
	...
	Route::middleware(['auth', 'otpcheck', CheckSubscription::class])->group(function () {
		...
		Route::middleware(['role:admin'])->group(function () {
			...
			Route::view('/admin/department/edit-department/{departmentID}', 'tenant/common/department', ["showForm" => true, 'status' => 1])->middleware(DecryptRouteParamater::class);
			Route::view('/admin/department/profile/{departmentID}', 'tenant/common/department', ["showForm" => false, "showProfile"=>true , 'status' => 1])->middleware(DecryptRouteParamater::class);
