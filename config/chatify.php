...
return [
    ...
    */
    'routes' => [
        ...
        'middleware' => env('CHATIFY_ROUTES_MIDDLEWARE', ['web','tenant', 'auth', 'otpcheck']),
        'namespace' => env('CHATIFY_ROUTES_NAMESPACE', 'App\Http\Controllers\Tenant'),
    ],
    'api_routes' => [
        'prefix' => env('CHATIFY_API_ROUTES_PREFIX', 'chat/api'),
        'middleware' => env('CHATIFY_API_ROUTES_MIDDLEWARE',  ['api','tenant', 'auth', 'otpcheck']),
        'namespace' => env('CHATIFY_API_ROUTES_NAMESPACE', 'App\Http\Controllers\Tenant\Api'),
    ],
