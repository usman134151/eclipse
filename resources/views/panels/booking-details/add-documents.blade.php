		...
		<div class="col-lg-12">
			...
			<div class="col-lg-8 mb-4">
				<div class="row">
					...
					<div class="text-center col-lg-3 d-flex">
						<a href="#" class="btn btn-outline-dark d-block px-2 pb-0">
							<svg class="mb-2" width="42" height="35" viewBox="0 0 42 35" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path d="M20.6185 6.57682L10.3093 13.1536L20.6185 19.7305L10.3093 26.3073L0 19.6944L10.3093 13.1176L0 6.57682L10.3093 0L20.6185 6.57682ZM10.2552 28.4232L20.567 21.8464L30.8763 28.4232L20.567 35L10.2552 28.4232ZM20.6185 19.697L30.9278 13.1176L20.6185 6.57682L30.8763 0L41.1856 6.57682L30.8763 13.1536L41.1856 19.7305L30.8763 26.3073L20.6185 19.6944V19.697Z" fill="url(#paint0_linear_7724_170911)"/>
								<defs>
									<linearGradient id="paint0_linear_7724_170911" x1="20.5928" y1="0" x2="37.1163" y2="0" gradientUnits="userSpaceOnUse">
										<stop stop-color="#213969"/>
										<stop offset="1" stop-color="#204387"/>
									</linearGradient>
								</defs>
			...
			<div class="col-lg-8 mb-4">
				<div class="form-check">
					<input class="form-check-input" id="AttachtoProviderConfirmation" name="" type="checkbox" tabindex="">
					<label class="form-check-label" for="AttachtoProviderConfirmation">
						Attach to Provider Confirmation
					</label>
				</div>
				<div class="form-check">
					<input class="form-check-input" id="AttachtoCustomerConfirmation" name="" type="checkbox" tabindex="">
					...
					<div>
						...
						<div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" id="WhenshouldtheyfirstbenotifiedNow" name="" type="checkbox" tabindex="">
								<label class="form-check-label" for="WhenshouldtheyfirstbenotifiedNow">
									Now
								</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" id="WhenshouldtheyfirstbenotifiedLater" name="" type="checkbox" tabindex="">
			...
			<div class="col-lg-8 mb-4">
				<div class="d-flex flex-column gap-4">
					<div>
						...
						<div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" id="HowoftenshouldtheybenotifiedTime" name="" type="radio" tabindex="">
								<label class="form-check-label" for="HowoftenshouldtheybenotifiedTime">
									Time(s)
								</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" id="HowoftenshouldtheybenotifiedEveryDay" name="" type="radio" tabindex="" checked>
