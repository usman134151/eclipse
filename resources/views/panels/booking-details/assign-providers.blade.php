	  ...
	  <div class="table-responsive">
		<table class="table table-fs-md table-hover" aria-label="">
		  <thead>
			<tr>
			  <th>Provider</th>
			  <th>Additional Provider Payment</th>
			  <th scope="col" width="60%">Total Service Payment</th>
			</tr>
		  </thead>
		  <tbody>
			<tr>
				...
				<div class="d-flex gap-2 align-items-start">
				  <div>
					...
					<div class="input-group">
					  <input type="" name="" class="form-control form-control-sm text-center w-au" placeholder="0">
				  ...
				  <div>
					<label class="form-label-sm">Average Rate</label>
					<input type="" name="" class="form-control form-control-sm w-auto" placeholder="$00:00">
				  </div>
				  <div>
					<div class="mb-2">
					  <label class="form-label-sm">Total Service Payment</label>
					  <input type="" name="" class="form-control form-control-sm w-auto" placeholder="$00:00">
					</div>
					<div class="">
				  ...
				  <div>
					...
					<div class="form-check">
					  <input class="form-check-input" id="ReimburseTravelTime" name="" type="checkbox" tabindex="">
					  <label class="form-check-label text-nowrap" for="ReimburseTravelTime"><small>Assign Partial Coverage</small></label>
					</div>
