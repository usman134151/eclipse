				...
				<div class="accordion-body">
					<div class="row">
						<div class="col-lg-6 mb-4">
							...
							<select data-placeholder="Select Accommodation" multiple class="form-select chosen-select" tabindex="8">
								<option value=""></option>
						...
						<div class="col-lg-12">
							<div class="d-flex justify-content-start gap-2 mb-4">
								<div class="mb-4 mb-lg-0">
									<button class="btn btn-xs btn-inactive dropdown-toggle bg-secondary rounded" data-bs-toggle="collapse" href="#collapseAdvanceFilter" role="button" aria-expanded="false" aria-controls="collapseAdvanceFilter">
										Advance Filter
									</button>
								</div>
								<div class="mb-4 mb-lg-0">
								...
								<div class="row">
									<div class="col-lg-6 mb-4">
										<div class="d-lg-flex justify-content-between align-items-center">
											...
											<div class="form-check">
												<input class="form-check-input" id="MatchAllPreferredProviders" name="" type="checkbox" tabindex="">
						...
						<div class="mt-2">
						  <div class="form-check form-check-inline">
							...
							<label class="form-check-label" for="Requester"><small>Requester</small></label>
						  </div>
						  <div class="form-check form-check-inline">
							<input class="form-check-input" id="ServiceConsumers" name="" type="checkbox" tabindex="">
							<label class="form-check-label" for="ServiceConsumers"><small>Service Consumer(s)</small></label>
						  </div>
						  <div class="form-check form-check-inline">
							<input class="form-check-input" id="Participants" name="" type="checkbox" tabindex="">
							<label class="form-check-label" for="Participants"><small>Participant(s)</small></label>
						  </div>
						</div>
					  </div>
					  <div class="col-lg-6 mb-4">
						...
						<div class="mt-2">
						  <div class="form-check">
							<input class="form-check-input" id="AssignedProviders" name="" type="checkbox" tabindex="">
							<label class="form-check-label" for="AssignedProviders"><small>Assigned Providers</small></label>
						  </div>
						</div>
					  </div>
					  ...
					  <div class="col-lg-4 mb-4">
						<div class="d-lg-flex justify-content-between align-items-center mb-2">
						  ...
						  <div>
							...
							<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
							  <path d="M1 12.0837V15H3.91626L12.5173 6.39897L9.60103 3.48271L1 12.0837ZM14.7725 4.14373C15.0758 3.84044 15.0758 3.35051 14.7725 3.04722L12.9528 1.22747C12.6495 0.924177 12.1596 0.924177 11.8563 1.22747L10.4331 2.6506L13.3494 5.56687L14.7725 4.14373Z" fill="#0A1E46"/>
							</svg>
						  </div>
						</div>
						<select class="form-select">
						...
						<div class="mt-2 d-flex gap-2">
						  <div class="form-check">
							<input class="form-check-input" id="ReimburseTravelTime" name="" type="checkbox" tabindex="">
							<label class="form-check-label" for="ReimburseTravelTime"><small>Reimburse Travel Time</small></label>
						  </div>
						  <div class="form-check">
							<input class="form-check-input" id="ReimburseTravelTime" name="" type="checkbox" tabindex="">
							<label class="form-check-label" for="ReimburseTravelTime"><small>Reimburse Mileage</small></label>
						  </div>
						</div>
					  </div>
					  <div class="col-lg-4 mb-4">
					  ...
					  <div class="col-lg-4 mb-4">
						<div class="mt-5 d-flex gap-1">
						  <div class="form-check">
							<input class="form-check-input" id="ProviderAvailability" name="" type="checkbox" tabindex="">
							<label class="form-check-label text-nowrap" for="ProviderAvailability"><small>Provider Availability</small></label>
						  </div>
						  <div class="form-check">
							<input class="form-check-input" id="ProviderServiceRadius" name="" type="checkbox" tabindex="">
							<label class="form-check-label text-nowrap" for="ProviderServiceRadius"><small>Provider Service Radius</small></label>
						  </div>
						</div>
					  </div>
					</div>
			...
			<tr>
			  <td>
				<div class="d-flex gap-2 align-items-center">
				  ...
				  <div class="pt-2">
					...
					<a href="#" class="font-family-secondary text-sm"><small>signlanguage@gmail.com</small></a>
			  ...
			  <td>
				<div class="d-grid grid-cols-2 gap-3 mb-3">
				  <div>
					...
					<input type="" name="" class="form-control form-control-sm" placeholder="Payment Label" aria-label="Payment Label">
				  </div>
				  <div>
					<label class="form-label-sm text-nowrap">Additional Payment</label>
					<input type="" name="" class="form-control form-control-sm" placeholder="$00:00" aria-label="Additional Payment">
				  </div>
				  <div>
					<label class="form-label-sm">Label</label>
					<input type="" name="" class="form-control form-control-sm" placeholder="Payment Label" aria-label="Payment Label">
				  ...
				  <div>
					<label class="form-label-sm text-nowrap" for="additional=payment">Additional Payment</label>
					...
					<div class="form-check mb-0">
					  ...
					  <label class="form-check-label text-nowrap" for="ChargetoCustomer"><small>Charge to Customer</small></label>
					</div>
				  </div>
				</div>
				<div class="mb-2">
				...
				<div>
				  <div class="form-check">
					<input class="form-check-input" id="ChargetoCustomer" name="" type="checkbox" tabindex="">
					<label class="form-check-label" for="ChargetoCustomer"><small>Reimburse Mileage</small></label>
				  </div>
				  <div class="form-check">
					<input class="form-check-input" id="ReimburseTravelTime" name="" type="checkbox" tabindex="">
					<label class="form-check-label" for="ReimburseTravelTime"><small>Reimburse Mileage</small></label>
				...
				<div class="d-flex gap-2 justify-content-center mb-3">
					<div class="col-md-4">
					  ...
					  <div class="input-group">
						<input type="" name="" class="form-control form-control-sm text-center" placeholder="0" aria-label="Hours">
					...
					<div class="col-md-4">
					  ...
					  <input type="" id="average-rate" name="" class="form-control form-control-sm w-25%" placeholder="$00:00">
					</div>
					</div>
					<div class="d-flex justify-content-center">
						<div class="form-check mb-3 col-md-3">
							<div class="">
								<input class="form-check-input" id="reimburse-mileage" name="" type="checkbox" tabindex="" checked>
							<label class="form-check-label text-nowrap" for="reimburse-mileage"><small>Reimburse Mileage</small></label>
							<div>
								<input type="" name="" class="form-control form-control-sm text-center" placeholder="10 km" aria-label="Distance">
							</div>
							</div>
						</div>
					</div>
					<div class="d-flex justify-content-center">
						...
						<div class="form-check mb-3 col-md-3">
							<div>
								<input class="form-check-input" id="reimburse-travel-time" name="" type="checkbox" tabindex="" checked>
								<label class="form-check-label text-nowrap" for="reimburse-travel-time"><small>Reimburse Travel Time</small></label>
							</div>
							<div class="d-inline-flex">
								<input type="" name="" class="form-control form-control-sm text-center rounded-0" placeholder="1 hr" aria-label="Reimburse Travel Time">
								<input type="" name="" class="form-control form-control-sm text-center rounded-0" placeholder="32 m" aria-label="Reimburse Travel Time">
							</div>
						</div>
					</div>
			  </td>
			  <td>
				<div class="d-inline-flex">
					<div class="col-md-6">
						<div class="mb-2">
						  <label class="form-label-sm" for="total-service-payment">Total Service Payment</label>
						  <input type="" name="" class="form-control form-control-sm" placeholder="$00:00" id="total-service-payment">
						</div>
						<div class="">
