	  ...
	  <div class="row mb-2">
		...
		<div class="col-lg-6">
		  <div class="d-flex gap-2 justify-content-end">
			<a href="#" class="btn btn-sm btn-primary btn-has-icon rounded px-4">
			  ...
			  <table id="" class="table table-fs-md table-hover" aria-label="">
				<thead>
				  <tr role="row">
					...
					<th scope="col" class="">Total pay<br> Total pending</th>
				...
				<tbody>
					...
					<td class="position-relative">
					    <div class="d-flex gap-2 align-items-center mb-1">
					        ...
					        <div class="position-relative">
					            <a href="" title="Edit" aria-label="Edit" class="btn btn-xs btn-secondary rounded btn-hs-icon icon-edit">
					    ...
					    <div class="text-primary">
					        Additional Charges:
					        <svg class="icon-arrow ms-3" width="17" height="8" viewBox="0 0 17 8" fill="none" xmlns="http://www.w3.org/2000/svg">
					            <path d="M0.50728 7.69408C0.74087 7.88996 1.05764 8 1.38794 8C1.71823 8 2.03501 7.88996 2.26859 7.69408L8.43444 2.52205L14.6003 7.69408C14.8352 7.88441 15.1499 7.98973 15.4765 7.98734C15.8031 7.98496 16.1155 7.87508 16.3464 7.68135C16.5774 7.48763 16.7084 7.22557 16.7112 6.95161C16.7141 6.67765 16.5885 6.41372 16.3616 6.21666L9.3151 0.305918C9.08151 0.110038 8.76474 -1.1216e-07 8.43444 -1.07863e-07C8.10415 -1.03567e-07 7.78737 0.110038 7.55378 0.305918L0.50728 6.21666C0.273762 6.4126 0.142578 6.67831 0.142578 6.95537C0.142578 7.23243 0.273762 7.49814 0.50728 7.69408Z" fill="#023DB0"/>
					        </svg>
					    </div>
					    <hr>
					    <div class="d-flex gap-2 align-items-center mb-1">
					...
					<td>
					  <div class="d-flex actions justify-content-center">
						<a href="#" title="View" aria-label="View" class="btn btn-sm btn-secondary rounded btn-hs-icon">
						  <svg class="fill-stroke" width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<td class="position-relative">
					    ...
					    <div class="d-flex gap-2 align-items-center mb-1">
					        ...
					        <div class="d-flex gap-2">
					            <div>
					                ...
					                <input type="" name="" class="form-control text-center form-control-xs form-control-max-w-xs">
					            </div>
					            <div>
					                <div class="text-center">
					                    Mints
					    ...
					    <div>
					        ...
					        <div class="mb-2 d-flex align-items-center gap-2">
					            ...
					            <div class="">
					                <input type="" name="" class="form-control form-control-xs form-control-max-w-xs text-center" value="05">
					            </div>
					        </div>
					    </div>
					    <hr>
					    ...
					    <div>
					        <div class="text-primary mb-3">
					            ...
					            <svg width="17" height="8" viewBox="0 0 17 8" fill="none" xmlns="http://www.w3.org/2000/svg">
					                <path d="M16.2603 0.305919C16.0267 0.110039 15.7099 -3.44874e-08 15.3796 -4.69357e-08C15.0493 -5.9384e-08 14.7326 0.110039 14.499 0.305919L8.33314 5.47795L2.16729 0.305919C1.93236 0.11559 1.61771 0.0102742 1.29112 0.0126548C0.964517 0.0150354 0.652099 0.124922 0.42115 0.318646C0.190201 0.512371 0.0591983 0.774433 0.0563602 1.04839C0.053522 1.32235 0.179075 1.58628 0.405977 1.78334L7.45248 7.69408C7.68607 7.88996 8.00284 8 8.33314 8C8.66343 8 8.9802 7.88996 9.21379 7.69408L16.2603 1.78334C16.4938 1.5874 16.625 1.32169 16.625 1.04463C16.625 0.767573 16.4938 0.501858 16.2603 0.305919Z" fill="#023DB0"/>
					            </svg>
					        </div>
					        <div class="d-flex flex-column gap-1">
					            <div class="d-flex gap-2 align-items-center">
					                ...
					                <div class="col-lg-2">
					                    <input type="" name="" class="form-control form-control-xs text-center" value="20">
					                </div>
					                <div>
					            ...
					            <div>
					                <div class="form-check mb-0">
					                    <input class="form-check-input" type="checkbox" value="" id="BillToCustomer" checked>
					            ...
					            <div class="d-flex gap-2 align-items-center">
					                ...
					                <div class="col-lg-2">
					                    <input type="" name="" class="form-control form-control-xs text-center" value="15">
					                </div>
					                <div>
					                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
					                        <path d="M6.4 3.2H9.6C9.6 2.77565 9.43143 2.36869 9.13137 2.06863C8.83131 1.76857 8.42435 1.6 8 1.6C7.57565 1.6 7.16869 1.76857 6.86863 2.06863C6.56857 2.36869 6.4 2.77565 6.4 3.2ZM4.8 3.2C4.8 2.35131 5.13714 1.53737 5.73726 0.937258C6.33737 0.337142 7.15131 0 8 0C8.84869 0 9.66263 0.337142 10.2627 0.937258C10.8629 1.53737 11.2 2.35131 11.2 3.2H15.2C15.4122 3.2 15.6157 3.28429 15.7657 3.43431C15.9157 3.58434 16 3.78783 16 4C16 4.21217 15.9157 4.41566 15.7657 4.56569C15.6157 4.71571 15.4122 4.8 15.2 4.8H14.4944L13.7856 13.072C13.7175 13.8708 13.352 14.6149 12.7615 15.1571C12.171 15.6993 11.3985 16.0001 10.5968 16H5.4032C4.60153 16.0001 3.82902 15.6993 3.23852 15.1571C2.64802 14.6149 2.28254 13.8708 2.2144 13.072L1.5056 4.8H0.8C0.587827 4.8 0.384344 4.71571 0.234315 4.56569C0.0842854 4.41566 0 4.21217 0 4C0 3.78783 0.0842854 3.58434 0.234315 3.43431C0.384344 3.28429 0.587827 3.2 0.8 3.2H4.8ZM10.4 8C10.4 7.78783 10.3157 7.58434 10.1657 7.43432C10.0157 7.28429 9.81217 7.2 9.6 7.2C9.38783 7.2 9.18434 7.28429 9.03432 7.43432C8.88429 7.58434 8.8 7.78783 8.8 8V11.2C8.8 11.4122 8.88429 11.6157 9.03432 11.7657C9.18434 11.9157 9.38783 12 9.6 12C9.81217 12 10.0157 11.9157 10.1657 11.7657C10.3157 11.6157 10.4 11.4122 10.4 11.2V8ZM6.4 7.2C6.61217 7.2 6.81566 7.28429 6.96569 7.43432C7.11571 7.58434 7.2 7.78783 7.2 8V11.2C7.2 11.4122 7.11571 11.6157 6.96569 11.7657C6.81566 11.9157 6.61217 12 6.4 12C6.18783 12 5.98434 11.9157 5.83432 11.7657C5.68429 11.6157 5.6 11.4122 5.6 11.2V8C5.6 7.78783 5.68429 7.58434 5.83432 7.43432C5.98434 7.28429 6.18783 7.2 6.4 7.2ZM3.808 12.936C3.84208 13.3355 4.02493 13.7077 4.32035 13.9788C4.61577 14.2499 5.00223 14.4002 5.4032 14.4H10.5968C10.9975 14.3998 11.3836 14.2494 11.6786 13.9783C11.9737 13.7072 12.1563 13.3352 12.1904 12.936L12.888 4.8H3.112L3.8096 12.936H3.808Z" fill="#888575"/>
				  ...
				  <tr role="row" class="odd">
					...
					<td class="position-relative">
					  <a href="#" title="Edit" aria-label="Edit" class="btn btn-sm btn-secondary rounded btn-hs-icon icon-edit">
						<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
						  <path d="M19.2555 4.11766L15.8304 0.680256C15.3834 0.258855 14.7977 0.017061 14.1846 0.000869084C13.5715 -0.0153228 12.9739 0.195217 12.5054 0.592439L1.25527 11.8832C0.85122 12.2921 0.599641 12.8281 0.54276 13.4012L0.00525375 18.6325C-0.0115852 18.8163 0.0121717 19.0015 0.074831 19.175C0.13749 19.3485 0.237509 19.5059 0.367758 19.6362C0.484559 19.7524 0.623081 19.8444 0.775379 19.9069C0.927678 19.9693 1.09076 20.0009 1.25527 20H1.36777L6.58033 19.5233C7.15133 19.4662 7.68538 19.2137 8.09284 18.8082L19.343 7.51743C19.7796 7.05447 20.0156 6.43667 19.9992 5.7994C19.9828 5.16213 19.7154 4.55738 19.2555 4.11766ZM6.35532 17.0142L2.60528 17.3655L2.94279 13.6019L10.0054 6.60163L13.3804 9.98885L6.35532 17.0142ZM15.0054 8.30778L11.6554 4.94565L14.0929 2.43659L17.5054 5.86145L15.0054 8.30778Z" fill="black"></path>
						</svg>
					  </a>
