			...
			<div class="col-lg-8 mb-4">
				...
				<div class="d-flex align-items-center w-100">
					<div class="position-relative flex-grow-1">
						<input type="text" class="form-control js-single-date" placeholder="Select Expiration Date" aria-label="Expiration Date" aria-describedby="" id="expiration-date-column">
