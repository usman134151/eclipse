...
<x-off-canvas show="teamsProviderAccess">
	<x-slot name="title">Providers & Teams Access</x-slot>
    <div class="row mb-4 mt-4">
        <div class="col-md-4">
            <h4>Team Name:</h4>
            <span>Language Interpreting</span>
        </div>
        <div class="col-md-4">
            <h4>No. of Provider::</h4>
            <span>10</span>
        </div>
    </div>
	<div class="d-flex justify-content-between mb-2">
        <div class="d-inline-flex align-items-center gap-4">
            <label for="showRecordsNumber" class="form-label">Show</label>
            <select class="form-select py-2" id="showRecordsNumber">
                <option>10</option>
                <option>15</option>
                <option>20</option>
                <option>25</option>
        ...
        <div class="d-inline-flex align-items-center gap-4">
            <label for="search-provider" class="form-label fw-semibold">Search</label>
            <input type="search" class="form-control py-2" id="search-provider" name="search" placeholder="Search here" autocomplete="on"/>
        </div>
    </div>
		...
		<table id="" class="table table-hover" aria-label="Companies And Customer Access Table">
            ...
            <tbody>
                <tr role="row" class="odd">
                    ...
                    <input class="form-check-input" type="checkbox" value="" aria-label="Providers & Teams Access">
                    </td>
                    <td>
                       <div class="row g-2">
                            <div class="col-md-2">
                    ...
                    <td>
                        <div class="d-flex actions">
                            <a href="javascript:void(0)" title="Delete Team" aria-label="Delete Provider" class="btn btn-sm btn-secondary rounded btn-hs-icon">
