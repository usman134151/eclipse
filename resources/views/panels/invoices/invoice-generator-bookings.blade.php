        ...
        <tbody>
          ...
          <td class="position-relative">
                        <div class="d-flex align-items-center gap-2 mb-2">
                          ...
                          <input type="" name="" class="form-control form-control-xs form-control-max-w-xs text-center" value="5"> h
                          <input type="" name="" class="form-control form-control-xs form-control-max-w-xs text-center" value="5"> m
                        ...
                        <div class="row g-0 mb-2">
                          ...
                          <div class="col-8 d-flex align-items-center gap-2"><input type="" name="" class="form-control form-control-xs form-control-max-w-xs text-center" value="5"> $</div>
                        </div>
                        <div class="row g-0 mb-2">
