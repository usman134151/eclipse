				...
				<tbody>
				  <tr role="row" class="odd">
					...
					<td class="position-relative">
                        ...
                        <div class="">$20.00</div>
                        <div class="text-primary mb-2"><small>Details: </small></div>
					...
					<td class="position-relative">
                        ...
                        <div class="mb-3">$70.00</div>
                      <div class="d-inline-flex mb-1">
                        <div class="col-lg-6 d-inline-flex">
                            <input type="text" class="form-control form-control-xs rounded-0 text-center px-0 " aria-label="Discount Amount" placeholder="20" aria-label="" aria-describedby="">
                            <select class="form-select-xs rounded-0 p-0" aria-label="discount type" id="">
                                <option>$</option>
                                <option>%</option>
                              </select>
                        </div>
