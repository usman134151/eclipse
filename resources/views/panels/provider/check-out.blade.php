          ...
          <div class="row">
            ...
            <div class="col-lg-8">
              <div class="form-check">
                <input class="form-check-input" type="radio" name="Print&SignDigitalSignature" id="Print&SignDigitalSignature1">
                ...
                <div class="py-4">
                  <div class="d-flex gap-5 align-items-center mb-4">
                    <div class="d-flex align-items-center gap-3">
                      1 <button type="" class="btn btn-sm rounded btn-outline-dark">Download Timesheet</button>
                    </div>
                    <div class="d-flex align-items-center gap-3">
                      2 <button type="" class="btn btn-sm rounded btn-outline-dark">Upload Timesheet</button>
                    </div>
                  </div>
              ...
              <div class="form-check">
                ...
                <div class="py-4">
                  ...
                  <div class="d-flex gap-5 align-items-center mb-4">
                    <div class="d-flex align-items-center gap-3">
                      <button type="" class="btn btn-sm rounded btn-outline-dark">Upload Signature</button>
                    </div>
                    <div class="d-flex align-items-center gap-3">
                      <button type="" class="btn btn-sm rounded btn-outline-dark">Create Signature</button>
                    </div>
                  </div>
                  <div class="text-center">
                    <img src="/tenant/images/portrait/small/img-timesheet.jpg" alt="Image">
      ...
      <div class="hidden js-checkout-step-4-content">
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="form-check mb-0">
                    <input class="form-check-input" type="checkbox" value="" id="PendingServiceAddressLink">
                    <label class="form-check-label" for="PendingServiceAddressLink">
                      I agree that the information I have provided is complete, accurate, and truthful. I understand that I am responsible for ensuring the information I provide is correct.
                    </label>
                  </div>
                </div>
              </div>
        ...
        <div class="mb-4">
          <div class="form-actions d-flex gap-3 justify-content-center mt-5">
            <button type="submit" class="btn btn-primary rounded" x-on:click="offcanvasOpenCheckOut = !offcanvasOpenCheckOut">Back</button>
            <button type="button" class="btn btn-outline-dark rounded">Cancel</button>
            <button type="submit" class="btn btn-primary rounded" x-on:click="offcanvasOpenCheckOut = !offcanvasOpenCheckOut">Submit</button>
          </div>
        </div>
      </div>
      <!-- END: Step 4 -->
