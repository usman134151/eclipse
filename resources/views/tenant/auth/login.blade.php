...
@section('content')
    {{-- Left Text --}}
    <div class="row">
        <div class="col-md-12 top-image"></div>
    </div>
    ...
    <div class="container">
        ...
        <!-- Content Section -->
        <div class="row">
            <!-- Left Column (60%) with Animated SVG -->
            <div class="col-md-7 col-lg-6 order-lg-1">
                <div class="image-container">
                    <object data="/tenant-resources/images/eclipse_logo.svg" type="image/svg+xml" width="80%">
...
<form method="POST" action="{{ route('tenant.login') }}" name="loginForm" onsubmit="return handleValidation()">
    ...
    <div class="mb-3">
        ...
        <div class="input-group input-group-merge form-password-toggle">
            <input class="form-control form-control-merge" :type="show ? 'password' : 'text'" id="password"
            ...
            <span class="input-group-text cursor-pointer">
                ...
                <svg class="d-block" width="20" height="20" fill="none" @click="show = !show"
                    :class="{ 'd-none': !show, 'd-block': show }" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 576 512">
                ...
                <svg class="d-none" width="20" height="20" fill="none" @click="show = !show"
                    :class="{ 'd-block': !show, 'd-none': show }" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 640 512">
                    <path fill="currentColor"
    ...
    <a style="display:none" class="otpF" href="">
        ...
        <div class="row">
            <div class="col-md-12 bottom-image"></div>
        </div>
    </div>
@endsection
@push('scripts')
