        ...
        <div class="navbar-container d-flex content">
            <div class="bookmark-wrapper d-flex align-items-center">
                ...
                <ul class="nav navbar-nav bookmark-icons">
                    <li class="nav-item d-none d-lg-block"><a href="{{session('isCustomer')? url('/customer/dashboard') : url('/admin/dashboard') }}" title="Dashboard"
                    ...
                    <li class="nav-item d-none d-lg-block"><a href="{{session('isCustomer')? url('/customer/chat') : url('/admin/chat') }}" title="Chat"
                    ...
                    <li class="nav-item d-none d-lg-block"><a href="{{ session('isCustomer')? url('/customer/bookings/today') : url('/admin/bookings/today') }}"
            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                <li class="nav-item d-none d-lg-block">
                    <a class="nav-link nav-link-style">
                        <svg aria-label="Change light Mode" xmlns="http://www.w3.org/2000/svg" width="14"
                ...
                <li class="nav-item dropdown dropdown-notification me-25">
                    <a href="#" aria-label="Eclipse Scheduling Notification" id="dropdownNotification"
                        class="nav-link" data-bs-toggle="dropdown">
                        <svg aria-label="Notifications" width="20" height="20" viewBox="0 0 20 20"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                fill="black" />
                            <mask id="mask0_207_5890" style="mask-type:alpha" maskUnits="userSpaceOnUse"
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        ...
                        <li class="dropdown-menu-footer"><a href="{{ url('/admin/notifications') }}"
                                aria-label="Read All Notifications" class="btn btn-primary w-100 all_notify">Read all
                                notifications</a></li>
                    </ul>
                </li>
                <li class="nav-item">
