      ...
      <div class="navbar-container d-flex content">
        ...
        <div class="mx-auto  d-none d-xl-flex gap-3 align-items-center">
          <div class="search-by-keyword position-relative">
            <svg aria-label="Search by Keyword" width="15" height="15" class="icon-search-keyword-no" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <defs>
              <linearGradient id="paint0_linear_8033_213447" x1="7.5" y1="0" x2="13.518" y2="0" gradientUnits="userSpaceOnUse">
              <stop stop-color="#213969"/>
              <stop offset="1" stop-color="#204387"/>
              </linearGradient>
              </defs>
            </svg>
            <input type="" name="" class="form-control rounded js-search-by-keyword" placeholder="Search by Keyword" aria-label="Search by Keyword">
          </div>
          <div class="search-by-no position-relative">
            <svg aria-label="Search by No" width="15" height="15" class="icon-search-keyword-no" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M11.0086 9.69676C11.9163 8.45791 12.3229 6.92194 12.1469 5.39615C11.971 3.87036 11.2255 2.46727 10.0596 1.4676C8.89374 0.467925 7.39345 -0.0546141 5.8589 0.00452304C4.32436 0.0636602 2.86872 0.700112 1.78321 1.78655C0.697708 2.87298 0.0623867 4.32928 0.00435596 5.86409C-0.0536748 7.39889 0.469864 8.89902 1.47023 10.0643C2.4706 11.2297 3.87402 11.9743 5.39972 12.1491C6.92542 12.324 8.46088 11.9163 9.69892 11.0075H9.69798C9.7261 11.045 9.7561 11.0807 9.78985 11.1153L13.3991 14.7251C13.5749 14.901 13.8133 14.9999 14.062 15C14.3107 15.0001 14.5492 14.9014 14.7251 14.7256C14.901 14.5498 14.9999 14.3113 15 14.0625C15.0001 13.8138 14.9014 13.5753 14.7256 13.3993L11.1164 9.78959C11.0828 9.75565 11.0468 9.72431 11.0086 9.69583V9.69676ZM11.2504 6.09264C11.2504 6.76984 11.1171 7.44041 10.8579 8.06606C10.5988 8.69171 10.219 9.26019 9.74025 9.73904C9.26146 10.2179 8.69306 10.5977 8.0675 10.8569C7.44194 11.116 6.77147 11.2494 6.09436 11.2494C5.41726 11.2494 4.74679 11.116 4.12123 10.8569C3.49566 10.5977 2.92726 10.2179 2.44848 9.73904C1.9697 9.26019 1.5899 8.69171 1.33079 8.06606C1.07167 7.44041 0.938307 6.76984 0.938307 6.09264C0.938307 4.72498 1.48153 3.41333 2.44848 2.44625C3.41543 1.47916 4.72689 0.93586 6.09436 0.93586C7.46183 0.93586 8.7733 1.47916 9.74025 2.44625C10.7072 3.41333 11.2504 4.72498 11.2504 6.09264Z" fill="url(#paint0_linear_8033_213447)"/>
                <defs>
                <linearGradient id="paint0_linear_8033_213447" x1="7.5" y1="0" x2="13.518" y2="0" gradientUnits="userSpaceOnUse">
                <stop stop-color="#213969"/>
            ...
            <input type="" name="" class="form-control rounded js-search-by-no" placeholder="Search by No" aria-label="Search by No">
          </div>
        </div>
        ...
        <ul class="nav navbar-nav align-items-center ms-auto">
               ...
               <a aria-label="Notification User Avatar" class="d-flex"  href="#">
                    <div class="list-item d-flex align-items-start">
                      ...
                      <div class="list-item-body flex-grow-1">
                        ALB Requests  has approved a new service request for Consumer User_company  ( 102391 , 9:41 AM  )
                      </div>
                    </div>
                  </a>
          ...
          <li class="nav-item">
            <a href="javascript:void();" aria-label="Eclipse Scheduling Tenant Logout" class="nav-link"
              ...
              <svg aria-label="Logout" width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li class="nav-item dropdown dropdown-user">
            ...
            <div class="dropdown-menu dropdown-menu-end p-0" aria-labelledby="dropdown-user" data-bs-popper="static" >
              <a href="/admin/profile" class="dropdown-item" href="#">
                <svg aria-label="Profile" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user me-50">
              ...
              <a href="{{ url('/admin/bookings/upcoming') }}" class="dropdown-item" href="#">
                <svg aria-label="Upcoming Assignments" aria-label="Upcoming Assignments" width="15" height="20" viewBox="0 0 15 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="{{ url('/admin/bookings/pending-approval') }}" class="dropdown-item" href="#">
                <svg aria-label="Pending Assignments" aria-label="Pending Assignments" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <use xlink:href="/css/common-icons.svg#pending-assignments-icon"></use>
                </svg> 
                Pending Assignments
              </a>
              <a href="{{ url('/admin/chat') }}" class="dropdown-item" href="#">
                <svg aria-label="Chats" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-message-square me-50">
              ...
              <a href="{{ url('/admin/business-setup') }}" class="dropdown-item" href="#">
                <svg aria-label="Business Setup" aria-label="Business Setup" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <use xlink:href="/css/common-icons.svg#business-setup-icon"></use>
                </svg>
                Business Setup
              </a>
              <a href="{{ url('/admin/reports') }}" class="dropdown-item" href="#">
                <svg aria-label="Reports" aria-label="Business Setup" width="13" height="19" viewBox="0 0 13 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <use xlink:href="/css/common-icons.svg#reports-header-icons"></use>
                </svg>     
                Reports
              </a>
              <a href="{{ url('/admin/jira-status') }}" class="dropdown-item" href="#">
                <svg aria-label="Support Tickets" aria-label="Support Tickets" width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              document.getElementById('logout-form').submit();">
                <svg aria-label="Logout" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-power me-50">
    ...
    <div class="modal fade" id="searchByKeywordModal" tabindex="-1" aria-labelledby="searchByKeywordModalLabel" aria-hidden="true">
    ...
    <!-- Modal - Search by No -->
    <div class="modal fade" id="searchByNoModal" tabindex="-1" aria-labelledby="searchByNoModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
