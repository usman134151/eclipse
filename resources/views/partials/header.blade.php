        ...
        <div class="navbar-container d-flex content">
            <div class="bookmark-wrapper d-flex align-items-center">
                ...
                <ul class="nav navbar-nav bookmark-icons">
                    <li class="nav-item d-none d-lg-block"><a href="{{ url('/admin/dashboard') }}" title="Dashboard"
                    ...
                    <li class="nav-item d-none d-lg-block"><a href="{{ url('/admin/chat') }}" title="Chat"
                    ...
                    <li class="nav-item d-none d-lg-block"><a href="{{ url('/admin/bookings/today') }}"
                    ...
                    <li class="nav-item d-none d-lg-block"><a href="{{ url('/admin/reports') }}" title="Reports"
