      ...
      <div class="navbar-container d-flex content">
        <div class="bookmark-wrapper d-flex align-items-center">
          <ul class="nav navbar-nav d-xl-none">
              <li class="nav-item"><a title="Navbar Toggler" aria-label="Navbar Toggler" class="nav-link menu-toggle" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-menu ficon"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg></a></li>
          </ul>
          <ul class="nav navbar-nav bookmark-icons">
            <li class="nav-item d-none d-lg-block"><a href="{{ url('/admin/chat') }}" title="Chat" aria-label="Eclipse Scheduling Chat" class="nav-link" data-bs-toggle="tooltip" data-bs-placement="bottom"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="nav-item d-none d-lg-block"><a href="{{ url('/admin/dashboard') }}" title="Dashboard" aria-label="Eclipse Scheduling Dashboard" class="nav-link" data-bs-toggle="tooltip" data-bs-placement="bottom"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
