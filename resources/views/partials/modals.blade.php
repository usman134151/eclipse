...
{{-- Assigned Billing Manager Modal - Start --}}
<div class="modal fade" id="assignedBillingManagerModal" tabindex="-1" aria-labelledby="assignedBillingManagerModalLabel" aria-hidden="true">
<div class="modal-dialog modal-md modal-dialog-centered">
  <div class="modal-content">
    <div class="modal-header">
...
{{-- Assigned Billing Manager Modal - End --}}
{{-- Assigned Supervisor(s) Modal - Start --}}
<div class="modal fade" id="assignedSupervisorModal" tabindex="-1" aria-labelledby="assignedSupervisorModalLabel" aria-hidden="true">
<div class="modal-dialog modal-md modal-dialog-centered">
  <div class="modal-content">
    <div class="modal-header">
      <h2 class="modal-title fs-5" id="assignedSupervisorModalLabel">Assigned Supervisor(s)</h2>
      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    <div class="modal-body">
      <div class="row">
            ...
            <table id="" class="table table-fs-md table-hover border" aria-label="">
              ...
              <tbody>
                ...
                <tr role="row" class="even">
                  ...
                  <td class="align-middle text-center">
                    <div class="form-check d-inline-block mx-auto">
                      <input class="form-check-input" type="radio" name="AssignedSupervisor" id="AssignedSupervisor2">
                    </div>
                  </td>
                </tr>
                <tr role="row" class="odd">
                  ...
                  <td class="align-middle text-center">
                    <div class="form-check d-inline-block mx-auto">
                      <input class="form-check-input" type="radio" name="AssignedSupervisor" id="AssignedSupervisor3">
                    </div>
                  </td>
                </tr>
                <tr role="row" class="even">
                  ...
                  <td class="align-middle text-center">
                    <div class="form-check d-inline-block mx-auto">
                      <input class="form-check-input" type="radio" name="AssignedSupervisor" id="AssignedSupervisor4">
                    </div>
                  </td>
                </tr>
                <tr role="row" class="odd">
                  ...
                  <td class="align-middle text-center">
                    <div class="form-check d-inline-block mx-auto">
                      <input class="form-check-input" type="radio" name="AssignedSupervisor" id="AssignedSupervisor5">
                    </div>
                  </td>
                </tr>
                <tr role="row" class="even">
                  ...
                  <td class="align-middle text-center">
                    <div class="form-check d-inline-block mx-auto">
                      <input class="form-check-input" type="radio" name="AssignedSupervisor" id="AssignedSupervisor6">
                    </div>
                  </td>
                </tr>
                <tr role="row" class="odd">
                  ...
                  <td class="align-middle text-center">
                    <div class="form-check d-inline-block mx-auto">
                      <input class="form-check-input" type="radio" name="AssignedSupervisor" id="AssignedSupervisor7">
                    </div>
                  </td>
                </tr>
                <tr role="row" class="even">
                  ...
                  <td class="align-middle text-center">
                    <div class="form-check d-inline-block mx-auto">
                      <input class="form-check-input" type="radio" name="AssignedSupervisor" id="AssignedSupervisor8">
                    </div>
                  </td>
                </tr>
              </tbody>
...
{{-- Assigned Supervisor(s) Modal - End --}}
{{-- Supervising Modal - Start --}}
<div class="modal fade" id="supervisingModal" tabindex="-1" aria-labelledby="supervisingModalLabel" aria-hidden="true">
<div class="modal-dialog modal-dialog-centered">
  <div class="modal-content">
    <div class="modal-header">
      <h2 class="modal-title fs-5" id="supervisingModalLabel">Supervising</h2>
      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    <div class="modal-body">
      <div class="row">
...
{{-- Supervising Modal - End --}}
{{-- Bill Managing Modal - Start --}}
<div class="modal fade" id="billManagingModal" tabindex="-1" aria-labelledby="billManagingModalLabel" aria-hidden="true">
<div class="modal-dialog modal-dialog-centered">
  <div class="modal-content">
    <div class="modal-header">
...
{{-- Bill Managing Modal - End --}}
{{-- Admin Staff Modal - Start --}}
<div class="modal fade" id="adminStaffModal" tabindex="-1" aria-labelledby="adminStaffModalLabel" aria-hidden="true">
<div class="modal-dialog modal-md modal-dialog-centered">
  <div class="modal-content">
    <div class="modal-header">
            ...
            <table id="" class="table table-fs-md table-hover border" aria-label="">
              ...
              <tbody>
                ...
                <tr role="row" class="even">
                  ...
                  <td class="align-middle text-center">
                    <div class="form-check form-switch">
                      <input class="form-check-input" type="checkbox" role="switch" id="adminStaff2">
                      <label class="form-check-label" for="adminStaff2">Visible</label>
                      <label class="form-check-label" for="adminStaff2">Manage</label>
                    </div>
                  </td>
                  <td class="align-middle text-center">
                    <a href="" title="Delete" aria-label="Delete" class="btn btn-sm btn-secondary rounded btn-hs-icon mx-auto">
                ...
                <tr role="row" class="odd">
                  ...
                  <td class="align-middle text-center">
                    <div class="form-check form-switch">
                      <input class="form-check-input" type="checkbox" role="switch" id="adminStaff3" checked>
                      <label class="form-check-label" for="adminStaff3">Visible</label>
                      <label class="form-check-label" for="adminStaff3">Manage</label>
                    </div>
                  </td>
                  <td class="align-middle text-center">
                    <a href="" title="Delete" aria-label="Delete" class="btn btn-sm btn-secondary rounded btn-hs-icon mx-auto">
                ...
                <tr role="row" class="even">
                  ...
                  <td class="align-middle text-center">
                    <div class="form-check form-switch">
                      <input class="form-check-input" type="checkbox" role="switch" id="adminStaff4">
                      <label class="form-check-label" for="adminStaff4">Visible</label>
                      <label class="form-check-label" for="adminStaff4">Manage</label>
                    </div>
                  </td>
                  <td class="align-middle text-center">
                    <a href="" title="Delete" aria-label="Delete" class="btn btn-sm btn-secondary rounded btn-hs-icon mx-auto">
                ...
                <tr role="row" class="odd">
                  ...
                  <td class="align-middle text-center">
                    <div class="form-check form-switch">
                      <input class="form-check-input" type="checkbox" role="switch" id="adminStaff5" checked>
                      <label class="form-check-label" for="adminStaff5">Visible</label>
                      <label class="form-check-label" for="adminStaff5">Manage</label>
                    </div>
                  </td>
                  <td class="align-middle text-center">
                    <a href="" title="Delete" aria-label="Delete" class="btn btn-sm btn-secondary rounded btn-hs-icon mx-auto">
...
{{-- Admin Staff Modal - End --}}

{{-- Assign provider Team Modal - Start --}}
<div class="modal fade" id="AssignproviderTeamModal" tabindex="-1" aria-labelledby="AssignproviderTeamLabel" aria-hidden="true">
<div class="modal-dialog modal-md modal-dialog-centered">
<div class="modal-content">
  <div class="modal-header">
    <h2 class="modal-title fs-5" id="providerModalLabel">Assigned Provider Teams</h2>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
  </div>
  <div class="modal-body">
    <div class="row justify-content-center">
      <div class="col-lg-10">
        <div class="row mb-2">
          ...
          <div class="col-lg-4 text-center py-2">
            <label class="form-label-sm fw-bold mb-0">Select Team</label>
          </div>
        </div><!-- END: Row Header -->
        <div class="row">
...
{{-- Assign provider Team Model - End --}}

{{-- Contract Provider Availibility Availiblity Model - Start --}}
<div class="modal fade" id="contractProviderAvailiblityModal" tabindex="-1" aria-labelledby="contractProviderAvailiblityLabel" aria-hidden="true">
...
{{-- Contract Provider Availibility Schdule Model - End --}}

{{-- Staff Provider Availibility Model - Start --}}
<div class="modal fade" id="staffProviderAvailiblityModal" tabindex="-1" aria-labelledby="staffProviderAvailiblityModalLabel" aria-hidden="true">
<div class="modal-dialog modal-md modal-dialog-centered modal-lg">
<div class="modal-content">
  <div class="modal-header">
    <h2 class="modal-title fs-5" id="staffProviderAvailiblityModalLabel">Staff Provider Availability Schedule</h2>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
  </div>
  <div class="modal-body">
      <div class="row mb-4">
                ...
                <div class="col-12 mb-4">
                  <div class="mb-2 ">
                    <div class="d-flex align-items-center gap-4">
                      <div>
                        <div class="form-check mb-0">
                          <input class="form-check-input" type="radio" name="payment-method" id="pay-per-hour" >
                          <label class="form-check-label" for="pay-per-hour"> Pay Per Hour</label>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="mb-4">
                    <div class="form-check mb-0">
                      <input class="form-check-input" type="radio" name="payment-method"  id="salary" checked>
...
{{-- Staff Provider Availibility Model - End --}}

{{-- Manage company business hours Model - Start --}}
<div class="modal fade" id="companybusinesshoursModel" tabindex="-1" aria-labelledby="contractProviderAvailiblityLabel" aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-centered modal-lg">
    <div class="modal-content">
      <div class="modal-header">
...
{{-- Manage company business hours Model - End --}}

{{-- View Button Modal- Start --}}
<div class="modal fade" id="viewButtonModal" tabindex="-1" aria-labelledby="viewButtonLabel" aria-hidden="true">
  <div class="modal-dialog modal-md modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h2 class="modal-title fs-5" id="viewButtonLabel">Document Title</h2>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
