                  ...
                  <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                      ...
                      <tr>
                        ...
                        if($data->roles()->first()->name == 'provider')
                        {
                          $desc2 = "To enter the portal, log into your individual Eclipse account.";
                          $desc = "You've received access to ".$company."'s Eclipse scheduling portal. Log into your account to set up and review your availability, payment information, and profile.";
                        }
                        elseif($data->roles()->first()->name == 'admin')
                        {
                          $desc2 = "To enter the portal, log into your individual Eclipse account.";
                          $desc = "You've received access to ".$company."'s Eclipse scheduling portal.";
                        }
                        else
                        {
                        ...
                        <td>
                          <table style="" width="100%" cellspacing="0" cellpadding="0" border="0">
                            ...
                            <tr>
                              <td style="color:#757575;font-family:&quot;Roboto&quot;,OpenSans,&quot;OpenSans&quot;,Arial,sans-serif;font-size:15px;font-weight:300;line-height:normal;margin:0;padding:15px 30px 25px 25px;color:#000000;">{{$desc}}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td style="color:#757575;font-family:&quot;Roboto&quot;,OpenSans,&quot;OpenSans&quot;,Arial,sans-serif;font-size:15px;font-weight:300;line-height:4px;margin:0;padding:0 30px 25px 25px;color:#000000;">
                                <a style="font-family:'-apple-system', BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';color:#fff;text-decoration:none;background-color:#0a1e46;border-bottom:8px solid #0a1e46;border-left:18px solid #0a1e46;border-right:18px solid #0a1e46;border-top:8px solid #0a1e46;" href="{{ str_replace('https://' , '' , URL::to('/reset-forgot-password/' . $data->security_token)) }}">Create New Passsword</a>
                              </td>
                            </tr>
                              <tr>
                                  <td height="10" style="color:#757575;font-family:&quot;Roboto&quot;,OpenSans,&quot;OpenSans&quot;,Arial,sans-serif;font-size:15px;font-weight:bold;line-height:4px;margin:0;padding:0 30px 25px 25px;color:#000000;">or<br></td>
                              </tr>
                              <tr>
                                  <td style="color:#757575;font-family:&quot;Roboto&quot;,OpenSans,&quot;OpenSans&quot;,Arial,sans-serif;font-size:15px;font-weight:300;margin:0;padding:0 30px 25px 25px;color:#000000;">
                                      If above button doesn't work, please click on this link.
                                  </td>
                              </tr>
                              <tr>
                                  <td style="color:#757575;font-family:&quot;Roboto&quot;,OpenSans,&quot;OpenSans&quot;,Arial,sans-serif;font-size:15px;font-weight:300;margin:0;padding:0 30px 25px 25px;color:#000000;">
                                      <a href="{{ str_replace('https://' , '' , URL::to('/reset-forgot-password/' . $data->security_token)) }}">{{ str_replace('https://' , '' , URL::to('/reset-forgot-password/' . $data->security_token)) }}</a>
                                  </td>
                              </tr>
                            <tr>
                              <td style="color:#757575;font-family:&quot;Roboto&quot;,OpenSans,&quot;OpenSans&quot;,Arial,sans-serif;font-size:15px;font-weight:300;line-height:normal;margin:0;padding:15px 30px 25px 25px;color:#000000;">**Warning: Do not share these credentials with anyone. Report any suspicious account activity to {{$company}}'s immediately.** </td>
                            </tr>
                            <tr>
                              <td style="color:#757575;font-family:&quot;Roboto&quot;,OpenSans,&quot;OpenSans&quot;,Arial,sans-serif;font-size:15px;font-weight:300;line-height:normal;margin:0;padding:15px 30px 25px 25px;color:#000000;">{{$desc2}}</td>
                            </tr>
                            <tr>
                              <td style="color:#757575;font-family:&quot;Roboto&quot;,OpenSans,&quot;OpenSans&quot;,Arial,sans-serif;font-size:15px;font-weight:300;line-height:4px;margin:0;padding:0 30px 25px 25px;color:#000000;">
                                <strong>Web Link :</strong> <a href="{!! str_replace('https://' , '' , url('')) !!}">{!! url('')  !!}</a>
                              </td>
                            </tr>
                        <tr>
                          <td height="30"><br></td>
