                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="d-lg-flex justify-content-between align-items-center mb-3">
                      <h1 class="mb-lg-0">Provider Teams</h1>
                      <a class="btn btn-primary rounded" wire:click="showForm">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                         ...
                         <span class="mx-2">Add Provider Team</span>
                      </a>
                    </div>
                  </div>
                  <div class="d-flex justify-content-between mb-4">
                    <div class="d-inline-flex align-items-center gap-4">
                      <div class="dropdown border border-outline-primary">
                  ...
                  <div class="d-flex justify-content-between mb-2">
                    ...
                    <div class="d-inline-flex align-items-center gap-4">
                      <label for="search-record" class="form-label fw-semibold">Search</label>
                      <input type="search" class="form-control" id="search-record" name="search" placeholder="Search here" autocomplete="on"/>
                    </div>
                  </div>
                        ...
                        <thead>
                            <tr role="row">
                              <th scope="col" class="text-center">
                                ...
                                <th scope="col">Accommodation(s)</th>
                          ...
                          <tbody>
                            <tr role="row" class="odd">
                              ...
                              <td>
                                <div class="d-flex actions">
                                  <a href="#" title="Edit" aria-label="" class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                  ...
                                  <div class="dropdown">
                                    <div class="dropdown ac-cstm">
                                      ...
                                      <div class="tablediv dropdown-menu fadeIn">
                                        <a href="javascript:void(0)" aria-label="View" title="View" class="dropdown-item"><i class="fa fa-eye"></i> View Providers </a>
                            ...
                            <tr role="row" class="odd">
                              ...
                              <td>
                                ...
                                <a href="#" title="View" aria-label="View" class="btn btn-sm btn-secondary rounded btn-hs-icon" wire:click="showProfile"vv>
                                  <svg aria-label="View" class="fill" width="20" height="20" viewBox="0 0 20 20"fill="none"
                                  xmlns="http://www.w3.org/2000/svg"><use xlink:href="/css/provider.svg#view"></use>
                                </svg>
                              </a>
