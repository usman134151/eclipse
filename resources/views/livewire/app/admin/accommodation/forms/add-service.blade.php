                            ...
                            <div class="col-lg-5 between-section-segment-spacing">
                                ...
                                <div class="border p-3">
                                    ...
                                    <div class="form-check mb-4">
                                        <input class="form-check-input" id="BillAfterServices" name="BillAfterServices"
                                            type="checkbox" tabindex="" />
                                    ...
                                    <div class="form-check mb-4">
                                        ...
                                        <label class="form-check-label" for="BillBeforeStartServices">Bill Before or at
                                                            ...
                                                            <div class="d-flex flex-column gap-3">
                                                                ...
                                                                <div class="d-grid grid-cols-2 gap-1">
                                                                    ...
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input" id="" name=""
                                                                            type="checkbox" tabindex="" />
                                                                        <label class="form-check-label" for=""> X by No.
                                                                            of Providers</label>
                                                                    </div>
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input" id="" name=""
                                                ...
                                                <div class="text-end">
                                                    <a href="#" class="fw-bold">
                                                        <small>
                                                            ...
                                                            {{-- Updated by Shanila to Add svg
                                                            icon--}}
                                                            <svg aria-label="Add Additional Specialization" class="me-1"
                                        ...
                                        <div class="d-flex flex-column gap-3">
                                            <div class="form-check">
                                                <input class="form-check-input"
                                                    ...
                                                    name="RequestStartTimeforServices" type="checkbox" tabindex="">
                                                <label class="form-check-label"
                                                    for="EnableAuthorizeandCloseButtonforProviders">Enable “Authorize
                                                    and Close” Button for Providers</label>
                                            </div>
                                            <div class="form-check">
                                                <label class="form-check-label"
                                                    for="EnableAuthorizeandCloseButtonforCustomers">Enable “Authorize
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label"
                                                    for="RequireAuthorizeCloseOutforProviderPayment">Require "Authorize
                                            ...
                                            <div class="form-check">
                                                ...
                                                <input class="form-check-input show-hidden-content"
                                                    id="AddCustomizedCloseOutForm" name="RequestStartTimeforServices"
                                                    type="checkbox" tabindex="">
                                                <div class="hidden-content">
                                                    <label class="form-label-sm">Select Form</label>
                                                    <select class="form-select">
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label"
                                                    for="AutoApproveTimeExtensions">Auto-Approve Time Extensions</label>
                                ...
                                <div class="w-100">
                                    <div class="inner-section-segment-spacing border p-3 pb-lg-5">
                                        ...
                                        <div class="d-flex flex-column gap-3">
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label" for="NotifyTeamProviders">Notify Team
                                                    Providers</label>
                                            ...
                                            <div class="form-check">
                                                ...
                                                <input class="form-check-input show-hidden-content"
                                                    id="AddCustomizedRunningLateForm" name="RequestStartTimeforServices"
                                                    type="checkbox" tabindex="">
                                                <div class="hidden-content">
                                                    <label class="form-label-sm">Select Form</label>
                                                    <select class="form-select">
                                ...
                                <div class="w-100">
                                    <div class="inner-section-segment-spacing border p-3 pb-lg-5">
                                        ...
                                        <div class="d-flex flex-column gap-3">
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label" for="FullServiceAddress">Full Service
                                                    Address</label>
                                        ...
                                        <div class="col-lg-7 mb-4">
                                            <div>
                                                <div class="d-flex gap-3 mb-4">
                                                    ...
                                                    <div class="form-check form-switch form-switch-column">
                                                        <input class="form-check-input js-auto-notify" type="checkbox"
                                                            role="switch" id="AutoNotifyAssign">
                                        ...
                                        <div class="col-lg-12 mb-4">
                                            <div class="d-lg-flex align-items-center gap-5">
                                                <div>
                                                    ...
                                                    <div class="input-group">
                                                        <input type="" name="" class="form-control form-control-sm w-50"
                                                            placeholder="00">
