<div x-data="{accommodationServicesAccess: false, teamsProviderAccess: false, companiesCustomers: false}">
	...
	<div class="content-body">
		<div class="card">
			<div class="card-body">
				<!-- BEGIN: Steps -->
				<div x-data="{ tab: 'system-permissions' }" id="tab_wrapper">
					<!-- Nav tabs -->
					<ul class="nav nav-tabs nav-steps" id="myTab" role="tablist">
						<li class="nav-item" role="presentation">
							<a href="#" class="nav-link" :class="{ 'active': tab === 'system-permissions' }" @click.prevent="tab = 'system-permissions'" id="system-permissions-tab" role="tab" aria-controls="system-permissions" aria-selected="false"><span class="number">1</span> 
								System Permissions
							</a>
						</li>
						<li class="nav-item" role="presentation">
							<a href="#" class="nav-link" :class="{ 'active': tab === 'user-access' }" @click.prevent="tab = 'user-access'" id="user-access-tab" role="tab" aria-controls="user-access" aria-selected="false"><span class="number">2</span> 
								User Access
							</a>
						</li>
					</ul>
