<div>
    <div class="content-wrapper container-xxl p-0">
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-5">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h1 class="content-header-title float-start mb-0">Add Company</h1>
            ...
            <div class="content-body">
              ...
              <div class="card-body">
                <!-- BEGIN: Steps -->
                <div x-data="{ tab: window.location.hash ? window.location.hash.substring(1) : 'company-info' }" id="tab_wrapper">
                      <!-- Nav tabs -->
                      <ul class="nav nav-tabs nav-steps" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                          <a href="" class="nav-link" :class="{ 'active': tab === 'company-info' }" @click.prevent="tab = 'company-info'; window.location.hash = 'company-info'" id="company-info-tab" role="tab" aria-controls="company-info" aria-selected="true"><span class="number">1</span>Company Info</a>
                        </li>
                        <li class="nav-item" role="presentation">
                      ...
                      <div class="tab-content">
                        <!-- BEGIN: Customer Info -->
                        <div class="tab-pane fade" :class="{ 'active show': tab === 'company-info' }" @click.prevent="tab = 'company-info'; window.location.hash = 'company-info'" id="company-info" role="tabpanel" aria-labelledby="company-info-tab" tabindex="0" x-show="tab === 'company-info'">
                          ...
                          <div class="row mt-2 mb-5">
                            <div class="col-12 text-center">
                              <div class="d-inline-block position-relative">
                                <img src="/tenant/images/portrait/small/testing.png" width="150" height="130" class="img-fluid rounded-circle" alt="Department Image"/>
                            ...
                            <div class="col-md-8 mb-md-2">
                                ...
                                <div class="col-md-6 col-12">
                                  <div class="mb-2">
                                    ...
                                    Company Name<span class="mandatory" aria-hidden="true">*</span>
                                    </label>
                                    <input
                                      type="text"
                                      id="company-name"
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                  <div class="mb-4">
                                    <label class="form-label" for="company-manager">Company Admin(s)</label>
                                   <input
                                      type="text"
                                      id="company-admin"
                                      class="form-control"
                                      name="company-admin"
                                      placeholder="Add Company Admin(s)"
                                      />
