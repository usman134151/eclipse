<div
    x-data="{customers: false,associateCompanies:false, associateCustomer:false, associateDepartment:false,associateservice:false}">
                ...
                <div x-data="{ tab: @entangle('component') }" id="tab_wrapper">
                    ...
                    <ul class="nav nav-tabs nav-steps" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a href="javascript:void(0)" class="nav-link {{$companyActive}}"
                                :class="{ 'active': tab === 'company-info' }" @click.prevent="tab = 'company-info'"
                                id="company-info-tab" role="tab" aria-controls="company-info" aria-selected="true"
                        ...
                        <li class="nav-item" role="presentation">
                            ...
                            <a href="javascript:void(0)" class="nav-link {{$scheduleActive}}"
                                ...
                                id="schedule-tab" role="tab" wire:click.prevent="save(0)" aria-controls="schedule"
                                aria-selected="true">
                        ...
                        <li class="nav-item" role="presentation">
                            @if($company->name)
                            <a href="#" class="nav-link {{$serviceActive}}" @click.prevent="tab = 'service-catalog'"
                                id="service-catalog-tab" role="tab" aria-controls="service-catalog"
                                aria-selected="false" wire:click.prevent="setStep(3,'serviceActive','service-catalog')">
                        ...
                        <li class="nav-item" role="presentation">
                            @if($company->name)
                            <a href="#" class="nav-link {{$driveActive}}" @click.prevent="tab = 'drive-documents'"
                                id="drive-documents-tab" role="tab" aria-controls="drive-documents"
                                aria-selected="false" wire:click.prevent="setStep(4,'driveActive','drive-documents');">
                    ...
                    <div class="tab-content">
                                            ...
                                            <div class="row between-section-segment-spacing">
                                                <div class="provider_image_panel">
                                                    <div class="provider_image">
                                                        ...
                                                        @else
                                                        <img class="user_img cropfile"
                                                            src="{{$company->company_logo == null ? '/tenant-resources/images/img-placeholder-document.jpg' : url($company->company_logo) }}">
                                                        @endif
                                                        <div class="input--file">
                                                            ...
                                                            <label for="cropfile"
                                                                class="form-label visually-hidden">Input File</label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 pe-lg-5 col-12">
                                                    ...
                                                    <input type="text" id="company-website" class="form-control"
                                                        name="company-website" placeholder="Enter Website URL" required
                                                        aria-required="false"
                                                        wire:model.defer="company.company_website" />
                                                    ...
                                                    <div class="d-flex align-items-center w-100">
                                                        <div class="position-relative flex-grow-1">
                                                            <input type="text" class="form-control js-single-date"
                                                                ...
                                                                wire:model="company.company_service_start_date">
                                                            {{-- Updated by Shanila to Add svg icon--}}
                                                    ...
                                                    <div class="d-flex align-items-center w-100">
                                                        <div class="position-relative flex-grow-1">
                                                            <input type="text" class="form-control js-single-date"
                                                                ...
                                                                wire:model="company.company_service_end_date">
                                                            {{-- Updated by Shanila to Add svg icon--}}
                                                            <svg aria-label="Date" class="icon-date" width="20"
                                                                height="21" viewBox="0 0 20 21">
                                                                <use xlink:href="/css/common-icons.svg#datefield-icon">
                                                ...
                                                <div class="col-lg-6 pe-lg-5 col-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <select data-placeholder="" multiple
                                                            ...
                                                            tabindex="" id="admins" aria-label="Select Company Admin"
                                                            wire:model.defer="admins">
                                                            {{-- <option value=""></option> --}}
                                                ...
                                                <div class="col-lg-6 pe-lg-5 col-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <select data-placeholder="" multiple
                                                            class="form-select  select2 form-select select2-hidden-accessible"
                                                            tabindex="" id="favored_providers"
                                                            aria-label="Select Preferred Providers"
                                                            wire:model.defer="fv_providers">
                                                ...
                                                <div class="col-lg-6 ps-lg-5 col-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <select data-placeholder="" multiple
                                                            class="form-select  select2 form-select select2-hidden-accessible"
                                                            tabindex="" id="unfavored_providers"
                                                            aria-label="Select Disfavored Providers"
                                                            wire:model.defer="unfv_providers">
                                                            {{-- <option value=""></option> --}}
                                                            @foreach($providers as $p)
                                                            <option value='{{$p[' id']}}'>{{$p['name']}}</option>
                                                            @endforeach
                                                ...
                                                <div class="col-lg-6 ps-lg-5 col-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <select disabled class="select2 form-select"
                                                            ...
                                                            <option>
                                                                Select Default Quote Template <small>(coming
                                                                    soon)</small>
                                                            </option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="row between-section-segment-spacing">
                                                    <div class="col-lg-12">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-5 col-md-4 mb-4 mb-md-0">
                                                                            ...
                                                                            <input type="text" id="title"
                                                                                ...
                                                                                wire:model.defer="phoneNumbers.{{$index}}.phone_title" />
                                                                        </div>
                                                                        <div class="col-lg-5 col-md-4 mb-4 mb-md-0">
                                                                            ...
                                                                            <input type="text" id="phone-number"
                                                                                ...
                                                                                wire:model.defer="phoneNumbers.{{$index}}.phone_number" />
                                                                        </div>
                                                        ...
                                                        <div class="col-lg-8 d-flex justify-content-end md-2 mt-4">
                                                            <button type="button"
                                                                onclick="newElement($('#formRow'), $('#elementRow'),{{count($phoneNumbers)}})"
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="row between-section-segment-spacing">
                                                        @include('components.default-address', ['type' => 1,
                                                        'userAddresses' => $userAddresses,'title'=>'Default'])

                                                        @include('components.default-address', ['type' => 2,
                                                        'userAddresses' => $userAddresses,'title'=>'Default'])
                        ...
                        <div class="tab-pane fade" :class="{ 'active show': tab === 'schedule' }" id="schedule"
                            ...
                            <section id="multiple-column-form">
                                ...
                                @livewire('app.common.setup.business-hours-setup', ['model_id' => $company->id,
                                'model_type' => '2'])
                                <div class="col-12 form-actions">
                                    <button type="button" class="btn btn-outline-dark rounded px-4 py-2"
                                        wire:click.prevent="setStep(1,'companyActive','company-info');">
                        ...
                        <div class="tab-pane fade" :class="{ 'active show': tab === 'service-catalog' }"
                            ...
                            <section id="multiple-column-form">
                                <a href="javascript:void(0)" style="display:none" id="departmentIco"
                                    @click="associateDepartment = true;" title="View Departments"
                                    aria-label="View Departments" class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                    <x-icon name="building" />
                                </a>
                                <a href="javascript:void(0)" style="display:none" @click="associateservice = true"
                                    id="serviceIco" title="Add Service Rates" aria-label="Add Service Rates"
                                    class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                    <x-icon name="dollar-icon" />
                                </a>
                                <a href="javascript:void(0)" style="display:none" id="CustomerIco"
                                    @click="associateCustomer = true;" title="Customers (coming soon)"
                                    aria-label="Customers (coming soon)"
                                    class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                    <svg aria-label="Customers" class="fill" width="21" height="20" viewBox="0 0 21 20"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <use xlink:href="/css/sprite.svg#user-group">
                                        </use>
                                    </svg>
                                </a>
                                ...
                                <div class="col-12 form-actions">
                                    <button type="button" class="btn btn-outline-dark rounded px-4 py-2"
                                        wire:click.prevent="setStep(2,'scheduleActive','schedule')"
                                        x-on:click=" window.scrollTo({ top: 0, behavior: 'smooth' });$wire.switch('service-catalog')">
                                        Back
                                    </button>
                                    <button type="submit" class="btn btn-primary rounded px-4 py-2"
                        ...
                        <div class="tab-pane fade" :class="{ 'active show': tab === 'drive-documents' }">
                            <div>
                                @livewire('app.common.forms.drive-uploads',['showForm'=>true,'showSearch'=>false,'record_id'=>
                                $company->id ,'record_type'=>1], key($company->id))</div>
                            <section id="multiple-column-form">
