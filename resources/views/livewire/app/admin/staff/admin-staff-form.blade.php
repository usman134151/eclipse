                                ...
                                <div class="row between-section-segment-spacing">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="mb-4">
                                            ...
                                            <div>
                                                <div class="mt-3">
                                                    <input class="form-check-input" type="checkbox" value="agency_admin"
                                                        id="agency_admin">
                                                ...
                                                <div class="mt-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        value="service_coordinator" id="service_coordinator" checked>
                                                    ...
                                                    <div class="ms-4 mt-3">
                                                        <div class="form-check mt-3">
                                                            <input class="form-check-input" type="radio"
                                                                name="accessRights" id="all_access" checked>
                                                        ...
                                                        <div class="form-check mt-3">
                                                            <input class="form-check-input" type="radio"
                                                                name="accessRights" id="restricted_access">
                                                ...
                                                <div class="mt-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        value="accounts_payable" id="accounts_payable">
                                                ...
                                                <div class="mt-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        value="accounts_billable" id="accounts_billable">
                                                    <label class="form-check-label" for="accounts_billable">
                                                        Accounts Billable
                                                    </label>
                                                </div>
                                                <div class="mt-3">
                                                    <input class="form-check-input" type="checkbox" value="recruiting"
                                                        id="recruiting">
                                            ...
                                            <div id="collapseCompaniesCustomerAccess"
                                                ...
                                                <div class="accordion-body p-0">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="align-middle">
                                                                    <div class="form-check form-switch">
                                                                        <input class="form-check-input" type="checkbox"
                                                                            role="switch" id="CustomerAccessManage"
                                                                            checked>
                                                    ...
                                                    <div
                                                        ...
                                                        <div>
                                                            <p class="fw-semibold mb-0">Showing 1 to 5 of 100 entries
                                                            </p>
                                                        </div>
