                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row mb-5">
                                        <div class="col-md-8">
                                            <p>
                                                Here you can view the companies you service and the users, assignments
                                                and invoices associated with them.
                                            </p>
                                        </div>
                                        <div class="d-flex flex-column flex-md-row justify-content-end mt-4 mb-3 gap-2">
                                            <button wire:click.prevent="downloadExportFile()" type="button"
                                                ...
                                                <svg aria-label="Download Import File" width="20" height="20"
                                                    viewBox="0 0 20 20">
                                            ...
                                            <button type="button"
                                                ...
                                                {{-- Updated by Shanila to Add svg icon --}}
                                                <svg aria-label="Import Companies" width="20" height="20"
                                                    viewBox="0 0 20 20">
                                                    <use xlink:href="/css/common-icons.svg#import-file"></use>
                                                </svg>
                                                {{-- End of update by Shanila --}}
                                            ...
                                            <a href="{{ route('tenant.company-create') }}"
                                                class="d-inline-lg-flex align-items-center btn btn-primary rounded px-3 py-2 gap-2">
                                                <svg aria-label="Add Company" width="20" height="20"
                                ...
                                <div class="d-flex actions gap-3 justify-content-md-end mb-2">
                                    <div class="d-flex gap-2 align-items-center">
                                        <a href="#" title="Edit Company" aria-label="Edit Team"
                                    ...
                                    <div class="d-flex gap-2 align-items-center">
                                        <a href="#" title="View Company" aria-label="View"
                                            class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                            <svg aria-label="View" class="fill" width="20" height="28"
                                                viewBox="0 0 20 28"fill="none" xmlns="http://www.w3.org/2000/svg">
