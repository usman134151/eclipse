                      ...
                      <div class="table-responsive">
                          ...
                          <div class="d-flex actions gap-3 justify-content-end mb-2">
                            <div class="d-flex gap-2 align-items-center">
                                <a href="#" title="Edit Invoice" aria-label="Edit Team" class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                    <x-icon name="pencil"/>
                                </a>
                                <span class="text-sm">
                                Edit Invoice
                            ...
                            <div class="d-flex gap-2 align-items-center">
                                <a href="#" title="View Invoice" aria-label="View" class="btn btn-sm btn-secondary rounded btn-hs-icon">
