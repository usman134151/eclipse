        ...
        <div class="card">
          ...
          <div class="mb-4">
            ...
            <div class="d-flex gap-5 align-items-center">
              ...
              <label for="search-provider" class="form-label-sm">Search</label>
            ...
            <div class="col-12">
              ...
              <table id="" class="table table-fs-md table-hover" aria-label="">
                ...
                <tr role="row">
                  ...
                  <th scope="col" class="text-center align-middle">No. of Bookings</th>
                ...
                <tr role="row" class="odd">
                  ...
                  <div class="d-flex gap-2 align-items-center">
                    ...
                    <div class="pt-2">
                    <div class="font-family-secondary leading-none">Example Company</div>
                    <a href="#" class="font-family-secondary"><small>examplecompany@gmail.com</small></a>
                    </div>
                  </div>
                  </td>
                  <td class="text-center align-middle">
                ...
                <tr role="row" class="even">
                  ...
                  <td class="align-middle">
                  <div class="d-flex actions justify-content-center">
                    <a href="#" title="Booking" aria-label="Booking" class="btn btn-hs-icon p-0">
                     <svg class="fill-stroke" width="12" height="15" class="" viewBox="0 0 12 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M5.875 1L10.75 7.5L5.875 14" stroke="black" stroke-width="1.625" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M1 1L5.875 7.5L1 14" stroke="black" stroke-width="1.625" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                ...
                <tr role="row" class="odd">
                  ...
                  <td class="align-middle">
                  <div class="d-flex actions justify-content-center">
                    <a href="javascript:void(0)" title="Booking" aria-label="Booking" class="btn btn-hs-icon p-0">
                     <svg class="fill-stroke" width="12" height="15" class="" viewBox="0 0 12 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M5.875 1L10.75 7.5L5.875 14" stroke="black" stroke-width="1.625" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M1 1L5.875 7.5L1 14" stroke="black" stroke-width="1.625" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
          ...
          <div class="bg-muted py-2 mb-4">
            ...
            <div class="col-lg-4">
              ...
              <div class="fw-bold text-sm mx-5">Selected Remittance Total</div>
              <div class="fw-bold text-sm text-lg-end mx-3">$675</div>
              </div>
            </div>
            </div>
          </div>
