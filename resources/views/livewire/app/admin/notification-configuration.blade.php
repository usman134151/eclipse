								...
								<div class="row">
									<div class="mb-4">
										...
										<div class="col-12 d-flex flex-column flex-md-row gap-2">
											<button wire:click="$set('selectedRoleId', 1)" type="submit" class="btn btn-primary rounded px-4 py-2 mx-1">
											...
											<button wire:click="$set('selectedRoleId', 2)" type="submit" class="btn btn-primary rounded px-4 py-2 mx-1">
												<svg aria-label="Provider"  width="25" height="24"
                                                   viewBox="0 0 25 24">
                                                  <use xlink:href="/css/common-icons.svg#admin-icon"></use>
                                                </svg>
												<span>Provider</span>
											...
											<button wire:click="$set('selectedRoleId', 3)" type="submit" class="btn btn-primary rounded px-4 py-2 mx-1">
											...
											<button wire:click="$set('selectedRoleId', 4)" type="submit" class="btn btn-primary rounded px-4 py-2 mx-1">
