                                    ...
                                    <div class="d-flex actions">
                                      ...
                                      <div class="dropdown ac-cstm">
                                        ...
                                        <div class="tablediv dropdown-menu fadeIn">
                                          ...
                                          <a title="Create Assignment" aria-label="Create Assignment" class="dropdown-item" href="javascript:void(0)"><i class="fa fa-user-plus"></i>Create Assignment</a>
                                          <a title="Message Customer" aria-label="Message Customer" class="dropdown-item" href=""><i class="fa fa-comment"></i>Message Customer</a> 
                                          <a href="javascript:void(0)" title="Delete" aria-label="Delete" class="dropdown-item"> <i class="fa fa-times"></i>Delete
                                          </a>
                                        </div>
                                      </div>
                                    </div>
