  ...
  <div class="content-header row">
      <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
          <div class="col-12">
            <h1 class="content-header-title float-start mb-0">Assignment {{ $bookingType }}</h1>
                                    ...
                                    <div class="d-flex actions">
                                      ...
                                      <div class="dropdown ac-cstm">
                                        ...
                                        <div class="tablediv dropdown-menu fadeIn">
                                          <a title="View Response" aria-label="View Response" class="dropdown-item"><i class="fa fa-envelope-open-o"></i>View Response</a>
                                          <a title="Send Invite" aria-label="Send Invite" class="dropdown-item" href="javascript:void(0)"><i class="fa fa-envelope-o"></i>Send Invite</a>
                                          <a title="Auto Assign" aria-label="Auto Assign" class="dropdown-item" href=""><i class="fa fa-user-plus"></i>Auto Assign</a> 
                                        </div>
                                      </div>
                                    </div>
                                  </td>
