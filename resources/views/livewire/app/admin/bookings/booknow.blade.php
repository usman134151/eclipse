        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="tab-content">
              <div class="tab-pane fade active show" id="requester-info" role="tabpanel" aria-labelledby="basic-service-setup-tab" tabindex="0">
                ...
                <div class="mb-4">
                  ...
                  <div class="d-flex gap-3 flex-column flex-lg-row">
                    <div class="form-check form-check-inline form-check-highlighted">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-12 mb-4">
                          ...
                          <div class="row mb-4">
                            <div class="col-lg-6 mb-4 pe-lg-5">
                              <div class="d-flex justify-content-between align-items-center">
                                <label class="form-label">Service Consumer(s) <span class="mandatory">*</span></label>
                                <a href="" class="fw-bold">
                                  <small>
                  ...
                  <div class="col-lg-12 mb-4">
                    ...
                    <div class="duplicate-block">
                      ...
                      <div class="d-lg-flex gap-5 mb-4">
                        ...
                        <div class="">
                          <label class="form-label-sm" for="set_set_date">Set Date <span class="mandatory">*</span></label>
                      ...
                      <div class="d-lg-flex align-items-center gap-5">
                        ...
                        <div>
                          <label class="form-label-sm">Days</label>
                          <input type="" class="form-control text-center" placeholder="0">
                        </div>
                        <div>
                          <label class="form-label-sm">Hours</label>
                          <input type="" class="form-control text-center" placeholder="00">
                        </div>
                        <div>
