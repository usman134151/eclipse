                        ...
                        <div class="d-flex gap-5 align-items-center">
                            <div class="mb-4 mb-lg-0">
                                ...
                                <div class="d-flex gap-2 align-items-center">
                                    <div class="position-relative">
                                        ...
                                        <svg class="icon-search position-absolute" viewBox="0 0 1024 1024" version="1.1"
                            ...
                            <div class="mb-4 mb-lg-0">
                                ...
                                <div class="mb-4 mb-lg-0 position-relative has-date-icon-left-side">
                                    <svg class="icon-date md left cursor-pointer" width="20" height="20"
                            ...
                            <div class="d-flex gap-3 align-items-center">
                                ...
                                <div class="mb-4 mb-lg-0">
                                    <button type="button" class="btn btn-xs bg-white btn-outline-dark rounded">Clear
                                        all</button>
                                </div>
                            </div>
                        </div>
