...
<div class="offcanvas offcanvas-end" :class="{ 'show': offcanvasOpen == true }" x-show="offcanvasOpen">
	<div class="offcanvas-header">
		<h5 class="offcanvas-title" id="offcanvasRightLabel">REMITTANCE DETAILS</h5>
		<button type="button" class="btn-close" x-on:click="offcanvasOpen = !offcanvasOpen" aria-label="Close"> <svg width="42" height="43" viewBox="0 0 42 43" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path d="M21 0.0234375C15.4305 0.0234375 10.089 2.24128 6.15076 6.18907C2.21249 10.1369 0 15.4912 0 21.0742C0 26.6572 2.21249 32.0116 6.15076 35.9594C10.089 39.9072 15.4305 42.125 21 42.125C26.5695 42.125 31.911 39.9072 35.8492 35.9594C39.7875 32.0116 42 26.6572 42 21.0742C42 15.4912 39.7875 10.1369 35.8492 6.18907C31.911 2.24128 26.5695 0.0234375 21 0.0234375V0.0234375ZM32.9725 28.7452L28.65 33.0782L21 25.4072L13.3475 33.0757L9.025 28.7427L16.68 21.0742L9.0275 13.4032L13.35 9.07277L21 16.7413L28.6525 9.07026L32.975 13.4032L25.32 21.0742L32.9725 28.7452Z" fill="#0A1E46"/>
		</svg></button>
</div>
	<div class="offcanvas-body">
		<div class="table-responsive">
			<table id="remittances-details" class="table table-hover" aria-label="Remittance Details">
				<thead>
					<tr role="row">
				...
				<tbody>
					...
					<td>102050</td>
					<td>Booking</td>
					<td>11/23/2022 4:18 AM 11/23/2022 4:18 AM</td>
					<td>Pearl One</td>
					<td>$100.00</td>
					<td>Issued</td>
					<td><svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
