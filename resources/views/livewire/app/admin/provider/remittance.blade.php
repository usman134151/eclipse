<div x-data="{remittanceDetails: false}">
							...
							<table id="remittances" class="table table-hover" aria-label="Remittance">
								...
								<tbody>
									<tr role="row" class="odd">
										...
										<td>
											<a @click="remittanceDetails = true">
												100995-6
											</a>
										</td>
										<td>$8,241.67</td>
						...
						<div class="d-flex justify-content-between">
							...
							<nav aria-label="Page Navigation">
								<ul class="pagination">
									...
									<li class="page-item Specific schedule added by Alex Wonderland">
	...
	@include('panels.remittance.remittance-details')
</div>