                  ...
                  <div class="bg-muted rounded p-4 mb-1">
                    <div class="d-lg-flex gap-5 align-items-center">
                      ...
                      <div class="mb-4 mb-lg-0">
							...
							<select class="select2 form-select form-select-md" id="review-status-column">
					...
					<nav aria-label="Page Navigation">
					  <ul class="pagination justify-content-start justify-content-lg-end">
                       ...
                       <div class="row mt-4 mb-4">
									...
									<div class="d-flex form-actions flex-lg-row flex-column justify-content-center gap-2">
