                       ...
                       <div class="col-12">
						...
						<div class="col-3">
							...
							<div class="d-flex align-items-center gap-2">
								<input type="search" class="form-control" id="search" name="search" placeholder="Provider Name or Email" autocomplete="on"/>
								<svg width="40" height="40" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
<circle cx="15" cy="15" r="15" transform="rotate(90 15 15)" fill="url(#paint0_linear_0_1)"/>
<circle cx="15" cy="15" r="15" transform="rotate(90 15 15)" fill="url(#paint1_linear_0_1)"/>
<path d="M22.023 19.977C21.5546 19.5284 21.0988 19.0669 20.656 18.593C20.284 18.215 20.06 17.94 20.06 17.94L17.26 16.603C18.381 15.3316 18.9997 13.695 19 12C19 8.141 15.86 5 12 5C8.14 5 5 8.141 5 12C5 15.859 8.14 19 12 19C13.763 19 15.37 18.34 16.603 17.261L17.94 20.061C17.94 20.061 18.215 20.285 18.593 20.657C18.98 21.02 19.489 21.511 19.977 22.024L21.335 23.416L21.939 24.062L24.06 21.941L23.414 21.337C23.035 20.965 22.529 20.471 22.023 19.977V19.977ZM12 17C9.243 17 7 14.757 7 12C7 9.243 9.243 7 12 7C14.757 7 17 9.243 17 12C17 14.757 14.757 17 12 17Z" fill="black"/>
<defs>
<linearGradient id="paint0_linear_0_1" x1="-9.53674e-07" y1="-0.154101" x2="-9.53674e-07" y2="30" gradientUnits="userSpaceOnUse">
<stop offset="0.0150376" stop-color="#C4C4C4"/>
<stop offset="1" stop-color="white" stop-opacity="0.01"/>
</linearGradient>
<linearGradient id="paint1_linear_0_1" x1="-9.53674e-07" y1="-0.154101" x2="-9.53674e-07" y2="30" gradientUnits="userSpaceOnUse">
        ...
        <!-- End : it will be replaced with livewire module -->
							...
							<div class="col-4">
								<div class="d-flex gap-4">
									<div>
									<label for="review-status" class="form-label fw-semibold">
										Review Status
									</label>
									...
									<div>
									<label for="payment-status" class="form-label fw-semibold">
										Payment Status
									</label>
					  ...
					  <div class="col-md-3 ms-auto text-end mb-4">
...
<td>
								<div class="row g-2">
									<div class="col-md-3">
										<img src="/tenant/images/portrait/small/avatar-s-20.jpg" class="img-fluid rounded-circle" alt="Dori Griffiths, Reimbursement Image">
									</div>
									<div class="col-md-9">
								...
								<td>
									<div class="d-flex actions">
										<a href="javascript:void(0)" title="Edit" aria-label="Edit" class="btn btn-sm btn-secondary rounded btn-hs-icon">
											<x-icon name="pencil"/>
										</a>
										<a href="javascript:void(0)" title="Check" aria-label="Check" class="btn btn-sm btn-secondary rounded btn-hs-icon">
											<x-icon name="check"/>
										</a>
										<a href="javascript:void(0)" title="cross" aria-label="cross" class="btn btn-sm btn-secondary rounded btn-hs-icon">
											<x-icon name="cross"/>
										</a>
									</div>
								</td>
