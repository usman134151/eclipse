<div x-data="{ departmentList:false, departmentProfile:false ,companyUsers:false }">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row mb-5">
                                    <div class="dropdown ">
                                        ...
                                        <button aria-label="Export Button" class="btn btn-secondary dropdown-toggle btn-outline-primary "
                                            ...
                                            <td>
                                                <div class="d-flex actions">
                                                    <a href="javascript:void(0)" title="Send Message "
                                                        ...
                                                        <svg aria-label="Send Message" class="fill" width="21" height="20" viewBox="0 0 21 20"
                                                    ...
                                                    <a href="/customer/myprofile" title="View User"
                                                        ...
                                                        class="btn btn-sm btn-secondary rounded btn-hs-icon"
                                                        wire:click="showProfile">
                                                        <svg aria-label="View User" class="fill" width="20" height="20" viewBox="0 0 20 20"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <a href="#" title="Edit User" aria-label="Edit User"
                                                        class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                                        <svg aria-label="Edit" class="fill" width="20" height="20" viewBox="0 0 20 20"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="d-flex gap-2 align-items-center">
                                    <div class="d-flex gap-2 align-items-center">
                                        <a href="#" title="Send Message" aria-label="Send Message"
                                            class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                            <svg aria-label="Send Message" class="fill" width="21" height="20" viewBox="0 0 21 20" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <use xlink:href="/css/customer.svg#company-icon"></use>
                                            </svg>
                                        </a>
                                    ...
                                    <a href="#" title="Edit Company" aria-label="Edit Company"
                                        class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                        <svg aria-label="Edit User" class="fill" width="20" height="20" viewBox="0 0 20 20"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <use xlink:href="/css/customer.svg#edit"></use>
                                    </svg>
                                    </a>
                                    ...
                                    <a href="#" title="View Company" aria-label="View"
                                        class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                        <svg aria-label="View User Details" class="fill" width="20" height="20" viewBox="0 0 20 20" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <use xlink:href="/css/customer.svg#view"></use>
                                        </svg>
                                    </a>
