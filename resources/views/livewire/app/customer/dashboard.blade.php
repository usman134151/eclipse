    ...
    <div class="row mb-5">
        <ul class="d-grid grid-cols-6 gap-4 list-unstyled mb-5" id="myTab" role="tablist">
                ...
                <a class="dashborad-block active" id="calendar-tab" data-bs-toggle="tab"
                    ...
                    <div class="text-center block-icon">
                        <svg class="fill" width="57" height="57" viewBox="0 0 57 57" fill="none"
                            xmlns="http://www.w3.org/2000/svg"><use xlink:href="/css/customer.svg#calendar-icon"></use>
                        </svg>
                    </div>
                    <div>
            ...
            <li class="" role="presentation">
                <a class="dashborad-block" id="scheduled-services-tab" data-bs-toggle="tab"
                    ...
                    <div class="text-center block-icon">
                        ...
                        xmlns="http://www.w3.org/2000/svg"><use xlink:href="/css/customer.svg#scheduled-services-icon"></use>
                    </svg>
                    </div>
                    <div>
            ...
            <li class="" role="presentation">
                <a class="dashborad-block" id="submit-service-request" data-bs-toggle="tab"
                    ...
                    <div class="text-center block-icon">
                        ...
                        xmlns="http://www.w3.org/2000/svg"><use xlink:href="/css/customer.svg#submit-service-icon"></use>
                        </svg>
                    </div>
                    <div>
                        <div class="text-center block-number">50</div>
            ...
            <li class="" role="presentation">
                <a class="dashborad-block" id="assignments-tab" data-bs-toggle="tab"
                    data-bs-target="#assignments-tab-pane" type="button" role="tab" aria-controls="assignments-tab-pane"
                    aria-selected="false">
                    <div class="text-center block-text">Notifications List</div>
                    <div class="text-center block-icon">
                        <svg class="stroke" width="54" height="61" viewBox="0 0 60 68" fill="none"
                        xmlns="http://www.w3.org/2000/svg"><use xlink:href="/css/customer.svg#notification-icon"></use>
                        </svg>
                    </div>
                    <div>
                        <div class="text-center block-number">50</div>
            ...
            <li class="" role="presentation">
                <a class="dashborad-block" id="profile-tab" data-bs-toggle="tab"
                    ...
                    <div class="text-center block-icon">
                        ...
                        xmlns="http://www.w3.org/2000/svg"><use xlink:href="/css/customer.svg#myprofile"></use>
                        </svg>
                    </div>
                    <div>
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="assignments-tab-pane" role="tabpanel" aria-labelledby="assignments-tab"
                tabindex="0">
                <h2 class="text-dark">Notification List</h2>
                <!-- Filters -->
                @livewire('app.customer.booking.notification-list')
            </div>
            <div class="tab-pane fade" id="scheduled-services-tab-pane" role="tabpanel"
                ...
                <div>
                    ...
                    @livewire('app.customer.booking.scheduled-services')
                </div>
                <!-- /Today's Assignment -->
            </div>
