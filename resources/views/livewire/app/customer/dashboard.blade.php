        ...
        <ul class="d-grid grid-cols-6 gap-4 list-unstyled mb-5" id="myTab" role="tablist">
            ...
            <li class="" role="presentation">
                <a class="dashborad-block" id="submit-service-request" data-bs-toggle="tab"
                    ...
                    <div class="text-center block-icon">
                        <svg class="fill icon-availability" viewBox="0 0 1440 809.999993" height=""
            ...
            <li class="" role="presentation">
                <a class="dashborad-block" id="assignments-tab" data-bs-toggle="tab"
                    ...
                    <div class="text-center block-icon">
                        <svg class="stroke" width="55" height="55" viewBox="0 0 60 68" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    <div class="d-flex actions">
                                                        <a href="#" title="Map View" aria-label="Map View"
