												...
												<tbody>
                                                    <tr role="row" class="odd">
														...
														<td>
															<div class="row">
																<div class="col-md-2">
																	<img src="/tenant/images/portrait/small/avatar-s-20.jpg" class="img-fluid rounded-circle" alt="Image Profile" width="80px">
																</div>
																<div class="col-md-10">
																	<p>Akmal Shah Consumer has cancelled their upcoming services</p>
																</div>
															</div>
														</td>
														<td>
                                                            <a href="#" title="View Notification" aria-label="View Notification" class="btn btn-sm btn-secondary rounded btn-hs-icon" wire:click="showProfile">
                                                                <x-icon name="view"/>
                                                            </a>
