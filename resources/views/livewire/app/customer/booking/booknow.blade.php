        ...
        <div class="card-body">
            ...
            <ul class="nav nav-tabs nav-steps" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link {{ $component == 'requester-info' ? 'active' : '' }}" id="requester-info-tab"
                        data-bs-toggle="tab" data-bs-target="#requester-info" type="button" role="tab"
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link {{ $component == 'request-details' ? 'active' : '' }}"
                        ...
                        role="tab" aria-controls="request-details" aria-selected="false"><span
                            class="number">2</span>
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link {{ $component == 'booking-summary' ? 'active' : '' }}"
                        ...
                        role="tab" aria-controls="booking-summary" aria-selected="false"><span
                            class="number">4</span>
                ...
                <div class="tab-pane fade {{ $component == 'booking-summary' ? 'active show' : '' }}"
                    ...
                    <div class="mb-5">
                        ...
                        <div class="col-12 justify-content-center form-actions d-flex gap-3">
                            ...
                            <div class="dropdown">
                                <button type="" class="btn btn-primary rounded dropdown-toggle"
