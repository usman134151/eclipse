                            ...
                            <div class="row mb-4">
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <div class="d-flex gap-3 flex-column flex-lg-row">
                                        ...
                                        <div class="form-check form-check-highlighted">
                                            <input class="form-check-input" id="pay-later" name="PermittedSchedulingFrequencies"
                                                type="radio" tabindex="" />
                                            <label class="form-check-label" for="PayLater<">Pay Later</label>
                                        </div>
                                        <div class="form-check form-check-highlighted">
                                            <input class="form-check-input" id="PayNow" name="PermittedSchedulingFrequencies"
                                                type="radio" tabindex="" />
