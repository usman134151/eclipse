                    ...
                    <table id="" class="table table-fs-md table-hover" aria-label="">
                      ...
                      <tbody>
                        ...
                        <tr role="row" @if($bookingType!='Unassigned' && $bookingType!='Invitations') class="{{$booking['class']}}" @else class="even" @endif>
                          ...
                          <td>
                            <div>
                              <div class="time-date">{{$booking['date']}}</div>
                          ...
                          <td>@if($bookingType!='Unassigned' && $bookingType!='Invitations') {{$booking['status']}} @else Unassigned @endif</td>
                          <td>
                            ...
                            @if($booking['status']=='On Time' && $bookingType!='Unassigned' && $bookingType!='Invitations')
                              <a href="javascript:void(0)" title="Running Late" aria-label="Running Late" class="btn btn-sm btn-secondary rounded btn-hs-icon" data-bs-toggle="modal" data-bs-target="#runningLateModal">
                                <svg aria-label="Running Late" width="23" height="22" viewBox="0 0 23 22" fill="none" xmlns="http://www.w3.org/2000/svg"><use xlink:href="/css/provider.svg#running-late"></use></svg>
                              </a>
                              ...
                              <a href="javascript:void(0)" @click="offcanvasOpenCheckIn = true" title="Check In" aria-label="Check In" class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                <svg aria-label="Check In" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><use xlink:href="/css/provider.svg#check-in"></use></svg>
                              </a>
                              ...
                              @elseif($booking['status']=='Active' && $bookingType!='Unassigned' && $bookingType!='Invitations')
                                ...
                                <svg aria-label="Check Out" width="23" height="21" viewBox="0 0 23 21" fill="none" xmlns="http://www.w3.org/2000/svg"><use xlink:href="/css/provider.svg#check-out"></use></svg>

                                 </a>
                              @elseif($bookingType=='Unassigned')
                              <a href="#" title="Submit Availability" aria-label="Submit Availability" class="btn btn-sm btn-secondary rounded btn-hs-icon" data-bs-toggle="modal" data-bs-target="#submitAvailability">
                                <svg aria-label="Submit Availability" width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg"><use xlink:href="/css/provider.svg#calendar"></use></svg>
                              </a>
                              @elseif($bookingType=='Invitations')
                              <a href="#" title="Confirm Invitation" aria-label="Confirm Invitation" class="btn btn-sm btn-secondary rounded btn-hs-icon" data-bs-toggle="modal" data-bs-target="#confirmInvitation">
                              <svg aria-label="Confirm Invitation" width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg"><use xlink:href="/css/provider.svg#confirm-invitation"></use></svg>
                              </a>                                
                              @endif
            ...
            <div class="d-flex actions gap-3 justify-content-end mb-3">
				<div class="d-flex gap-2 align-items-center">
				  <a href="#" title="View" aria-label="View" class="btn btn-sm btn-secondary rounded btn-hs-icon">
					<svg aria-label="In-Person" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<div class="d-flex gap-2 align-items-center">
				  <a href="#" title="Accept" aria-label="Accept" class="btn btn-sm btn-secondary rounded btn-hs-icon">
					<svg aria-label="Virtual" width="22" height="15" viewBox="0 0 22 15" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<div class="d-flex gap-2 align-items-center">
				  <a href="#" title="Objection" aria-label="Objection" class="btn btn-sm btn-secondary rounded btn-hs-icon">
					<svg aria-label="Check-In" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<div class="d-flex gap-2 align-items-center">
				  <a href="#" title="Objection" aria-label="Objection" class="btn btn-sm btn-secondary rounded btn-hs-icon">
					<svg aria-label="Check-Out" width="23" height="21" viewBox="0 0 23 21" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<div class="d-flex gap-2 align-items-center">
				  <a href="#" title="Running Late" aria-label="Running Late" class="btn btn-sm btn-secondary rounded btn-hs-icon">
					<svg aria-label="Running Late" width="23" height="22" viewBox="0 0 23 22" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<div class="d-flex gap-2 align-items-center">
				  <a href="#" title="Objection" aria-label="Objection" class="btn btn-sm btn-secondary rounded btn-hs-icon">
					<svg aria-label="View Assignment" aria-label="" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
