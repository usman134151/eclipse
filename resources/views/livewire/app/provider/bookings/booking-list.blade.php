                          ...
                          <td>
                            ...
                            @if($booking['status']=='On Time' && $bookingType!='Unassigned' && $bookingType!='Invitations')
                              <a href="javascript:void(0)" title="Running Late" aria-label="Running Late" class="btn btn-sm btn-secondary rounded btn-hs-icon" data-bs-toggle="modal" data-bs-target="#runningLateModal">
                                <svg width="23" height="22" viewBox="0 0 23 22" fill="none" xmlns="http://www.w3.org/2000/svg"><use xlink:href="/css/provider.svg#running-late"></use></svg>
                              </a>
                              ...
                              <a href="javascript:void(0)" @click="offcanvasOpenCheckIn = true" title="Check In" aria-label="Check In" class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><use xlink:href="/css/provider.svg#check-in"></use></svg>
                              </a>
                              ...
                              @elseif($booking['status']=='Active' && $bookingType!='Unassigned' && $bookingType!='Invitations')
                                ...
                                <svg width="23" height="21" viewBox="0 0 23 21" fill="none" xmlns="http://www.w3.org/2000/svg"><use xlink:href="/css/provider.svg#check-out"></use></svg>
                              ...
                              <a href="#" title="Submit Availability" aria-label="Submit Availability" class="btn btn-sm btn-secondary rounded btn-hs-icon" data-bs-toggle="modal" data-bs-target="#submitAvailability">
                                <svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg"><use xlink:href="/css/provider.svg#calendar"></use></svg>
                              </a>
                              ...
                              <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg"><use xlink:href="/css/provider.svg#confirm-invitation"></use></svg>
                              </a>                                
                              @endif
