					...
					<div class="tab-content">
						...
						<div class="tab-pane fade" :class="{ 'active show': tab === 'service-catalog' }" id="service-catalog" role="tabpanel" aria-labelledby="service-catalog-tab" tabindex="0" x-show="tab === 'service-catalog'">
							<section id="multiple-column-form">
                                 ...
                                 <div class="mb-3 fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#accomodation" aria-expanded="true" aria-controls="accomodation">
                                        Sign Language Interpreting Services
                                        <svg class="icon-arrow-bottom" width="32" height="15" viewBox="0 0 32 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  ...
                                  <div class="collapse show" id="accomodation">
                                        <div class="mb-3 fw-bold" data-bs-toggle="collapse" type="button" data-bs-target="#accomodation-category" aria-expanded="true" aria-controls="accomodation">
