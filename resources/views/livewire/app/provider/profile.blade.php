					...
					<div class="tab-content">
						...
						<div class="tab-pane fade" :class="{ 'active show': tab === 'profile' }"  id="user-profile" role="tabpanel" aria-labelledby="user-profile-tab" tabindex="0" x-show="tab === 'profile'">
                            ...
                            <div class="row mt-2 mb-5">
								...
								<div class="col-12 text-center">
                                    ...
                                    <div><h3>Referral Code: KYTALB</h3></div>
                                    <div>
						...
						<div class="tab-pane fade" :class="{ 'active show': tab === 'service-catalog' }" id="service-catalog" role="tabpanel" aria-labelledby="service-catalog-tab" tabindex="0" x-show="tab === 'service-catalog'">
							<section id="multiple-column-form">
                                 ...
                                 <div class="mb-3 fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#accomodation" aria-expanded="false" aria-controls="accomodation">
                                        Sign Language Interpreting Services
                                        <svg class="mx-4 mb-1" width="25" height="13" viewBox="0 0 25 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M24.306 0.958879C23.9556 0.665059 23.4804 0.5 22.985 0.5C22.4895 0.5 22.0144 0.665059 21.664 0.958879L12.4152 8.71692L3.16646 0.958879C2.81407 0.673386 2.3421 0.515412 1.8522 0.518983C1.3623 0.522554 0.893671 0.687384 0.547249 0.97797C0.200825 1.26856 0.00432205 1.66165 6.67572e-05 2.07259C-0.00419044 2.48352 0.184137 2.87942 0.524488 3.17501L11.0942 12.0411C11.4446 12.3349 11.9198 12.5 12.4152 12.5C12.9107 12.5 13.3858 12.3349 13.7362 12.0411L24.306 3.17501C24.6563 2.8811 24.853 2.48253 24.853 2.06695C24.853 1.65136 24.6563 1.25279 24.306 0.958879Z" fill="#575656"/>
                                        </svg>
                                            
                                  </div>
                                  <div class="row collapse show mb-3" id="accomodation">
                                      <div class="mb-2 fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#accomodation-category-one" aria-expanded="false" aria-controls="accomodation-category">
                                  ...
                                  <div class="collapse show" id="accomodation">
                                        <div class="mb-3 fw-bold" data-bs-toggle="collapse" type="button" data-bs-target="#accomodation-category" >
                                            <svg class=" mb-1" width="25" height="13" viewBox="0 0 25 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M24.306 0.958879C23.9556 0.665059 23.4804 0.5 22.985 0.5C22.4895 0.5 22.0144 0.665059 21.664 0.958879L12.4152 8.71692L3.16646 0.958879C2.81407 0.673386 2.3421 0.515412 1.8522 0.518983C1.3623 0.522554 0.893671 0.687384 0.547249 0.97797C0.200825 1.26856 0.00432205 1.66165 6.67572e-05 2.07259C-0.00419044 2.48352 0.184137 2.87942 0.524488 3.17501L11.0942 12.0411C11.4446 12.3349 11.9198 12.5 12.4152 12.5C12.9107 12.5 13.3858 12.3349 13.7362 12.0411L24.306 3.17501C24.6563 2.8811 24.853 2.48253 24.853 2.06695C24.853 1.65136 24.6563 1.25279 24.306 0.958879Z" fill="#575656"/>
                                            </svg>
                                            Film Production
                                        </div>
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-md-4">
                                                        <div class="d-inline-flex">
                                                            <div>
                                                                <x-icon name="in-person"/>                                                               
                                                            </div>
                                                            <div class="mx-3">Day Rate In-person:</div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="d-inline-flex">
                                                            ...
                                                            <div class="mx-3">Day Rate Virtual:</div>
                                                        <div class="mx-3">$101.00</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col-md-4">
                                                        <div class="d-inline-flex">
                                                            ...
                                                            <div class="mx-3">Day Rate Phone:</div>
                                                        <div class="mx-3">$101.00</div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                            ...
                                            <div class="d-inline-flex">
                                                <div class="d-inline-flex col-3">
                                                    ...
                                                    <div class="mx-2 d-inline-flex">
                                                        ...
                                                        <div class="mx-2 "><x-icon name="fill-question"/></div>
                                                    </div>
                                                </div>
                                                <div class="d-inline-flex col-3">
                                                        ...
                                                        <div class="mx-3 mt-1"><span>Hours Notice: </span><span class="mx-1">5</span></div>
                                                </div>
                                                <div class="mx-2 d-inline-flex">
                                                    <div class="d-inline-flex">
                                                          <span>Rate: </span><span class="mx-1">$100.00</span>                                                       
                                                        </div>
                                                </div>
                                                <div class="mx-4">
                                    ...
                                    <div class="d-inline-flex">
                                        <div class="d-inline-flex col-3">
                                            ...
                                            <div class="mx-2 d-inline-flex">
                                                ...
                                                <div class="mx-2 "><x-icon aria-label="Virtual" name="fill-question"/></div>
                                            </div>
                                        </div>
                                        <div class="d-inline-flex col-3">
                                                <div class="bg-muted rounded">
                                   ...
                                   {{-- Teleconference Expedited Service End --}}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="bg-muted p-1 col-1 mx-3">Medical</div>
                                            <div class="d-inline-flex">
                                                <div class="mx-2">
                                                    <div class="d-inline-flex">
                                                        <div>
                                                ...
                                                <div class="mx-3">
                                                    <div class="d-inline-flex">
                                                        ...
                                                        <div class="mx-1 mt-1"><span>In-Person: </span><span class="mx-1">$100.00</span></div>
                                                    </div>
                                                </div>
                                                <div class="mx-3">
                                                    <div class="d-inline-flex">
                                                        ...
                                                        <div class="mx-1 mt-1"><span>Virtual:</span><span class="mx-1">$100.00</span></div>
                                                    </div>
                                                </div>
                                                <div class="mx-3">
                                                    <div class="d-inline-flex">
                                                        ...
                                                        <div class="mx-1 mt-1"><span>Phone:</span><span class="mx-1">$100.00</span></div>
                                                    </div>
                                                </div>
                                                <div class="mx-3">
                                                    <div class="d-inline-flex">
                                                        ...
                                                        <div class="mx-1 mt-1"><span>Teleconferencing:</span><span class="mx-1">$100.00</span></div>
                                                    </div> 
                                                </div>
                                            </div>
                                            <div class="row mt-4 mb-3">
                                                <div class="col-3 mb-2 mx-1"> 
                                                    <span class="bg-muted p-1"> Projector & Screen Rental</span>
                                                </div>
                                                <div class="d-inline-flex">
                                                    <div class="mx-2">
                                                        <div class="d-inline-flex">
                                  ...
                                  <div class="row">
                                       <div class="mb-3 mt-4 fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#accomodation-four" aria-expanded="false" aria-controls="accomodation-four">
                                           Spoken Language Interpreting Services
                                           <svg class="mx-4 mb-0" width="32" height="16" viewBox="0 0 32 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                               <path d="M0.897074 15.2467C1.33505 15.614 1.929 15.8203 2.54831 15.8203C3.16761 15.8203 3.76156 15.614 4.19954 15.2467L15.7605 5.54916L27.3215 15.2467C27.762 15.6036 28.3519 15.801 28.9643 15.7966C29.5767 15.7921 30.1625 15.5861 30.5955 15.2228C31.0285 14.8596 31.2741 14.3682 31.2795 13.8546C31.2848 13.3409 31.0494 12.846 30.6239 12.4765L17.4117 1.39391C16.9738 1.02663 16.3798 0.820312 15.7605 0.820312C15.1412 0.820312 14.5473 1.02663 14.1093 1.39391L0.897074 12.4765C0.459226 12.8439 0.213257 13.3421 0.213257 13.8616C0.213257 14.3811 0.459226 14.8793 0.897074 15.2467Z" fill="#575656"/>
                                           </svg>
                                     </div>
                                     <div class="collapse" id="accomodation-four">
                                       {{-- accommodation-two body here --}}
                                     </div>
                                </div>
                                  {{-- Accommodation two -End --}}
                                  <div class="row">
                                    <div class="mb-3 mt-4 fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#accomodation-three" aria-expanded="false" aria-controls="accomodation-three">
                                        Real Time Captioning Services
                                        <svg class="mx-4 mb-0" width="32" height="16" viewBox="0 0 32 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M0.897074 15.2467C1.33505 15.614 1.929 15.8203 2.54831 15.8203C3.16761 15.8203 3.76156 15.614 4.19954 15.2467L15.7605 5.54916L27.3215 15.2467C27.762 15.6036 28.3519 15.801 28.9643 15.7966C29.5767 15.7921 30.1625 15.5861 30.5955 15.2228C31.0285 14.8596 31.2741 14.3682 31.2795 13.8546C31.2848 13.3409 31.0494 12.846 30.6239 12.4765L17.4117 1.39391C16.9738 1.02663 16.3798 0.820312 15.7605 0.820312C15.1412 0.820312 14.5473 1.02663 14.1093 1.39391L0.897074 12.4765C0.459226 12.8439 0.213257 13.3421 0.213257 13.8616C0.213257 14.3811 0.459226 14.8793 0.897074 15.2467Z" fill="#575656"/>
                                        </svg>
                                  </div>
                                  <div class="collapse" id="accomodation-three">
                                    {{-- accommodation-two body here --}}
                                  </div>
                             </div>
                             <div class="col-12 justify-content-center form-actions d-flex gap-3">
