        ...
        <div class="card-body">
                ...
                <table id="remittances" class="table table-hover" aria-label="Remittances">
                    ...
                    <tbody>
                            ...
                            <td>
                                <div class="d-flex actions">
                                    ...
                                    <a href="javascript:void(0)" title="Download PDF" aria-label="Download PDF"
                                        class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                        <svg aria-label="Download File" width="16" height="20"
                        ...
                        <tr role="row" class="even">
                            ...
                            <td>Direct Deposit</td>
                            <td>
                                <svg aria-label="Pending" class="fill-warning" width="12" height="12"
            ...
            <div class="d-flex actions gap-3 justify-content-end mb-2">
                ...
                <div class="d-flex gap-2 align-items-center">
                    <a href="javascript:void(0)" title="Download PDF" aria-label="Download PDF"
                        class="btn btn-sm btn-secondary rounded btn-hs-icon">
                        <svg aria-label="Download File" width="16" height="20" viewBox="0 0 16 20"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <use xlink:href="/css/provider.svg#download-file"></use>
                        </svg>
                    </a>
