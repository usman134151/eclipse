                  ...
                  <div class="card-body">
                      <div class="row">
                        ...
                        <div class="table-responsive">
                          <table id="industries" class="table table-hover" aria-label="Specializations">
                            <thead>
                              <tr role="row">
                                      ...
                                      <div class="dropdown"> 
                                        <div class="dropdown ac-cstm">
                                          ...
                                          <div class="tablediv dropdown-menu fadeIn">
                                            <a href="javascript:void(0)" aria-label="action" aria-label="Edit" title="Edit" class="dropdown-item"><i class="fa fa-pencil-square-o"></i>Edit</a>
