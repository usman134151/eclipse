                                        ...
                                        <div class="d-flex flex-column flex-md-row justify-content-end mt-4 mb-3 gap-2">
                                            <button wire:click.prevent="downloadExportFile()" type="button"
                                                ...
                                                <svg aria-label="Download Import File" width="20" height="20"
                                                    viewBox="0 0 20 20">
                                                    <use xlink:href="/css/common-icons.svg#import-file">
                                                    </use>
                                                </svg>
                                                {{-- End of update by Shanila --}}
                                            ...
                                            <button type="button"
                                                class="d-inline-flex align-items-center btn btn-primary rounded px-3 py-2 gap-2">
                                                {{-- Updated by Shanila to Add svg icon--}}
                                                <svg aria-label="Import Customer" width="20" height="20"
                                                    viewBox="0 0 20 20">
                                                    <use xlink:href="/css/common-icons.svg#import-file">
                                                    </use>
                                                </svg>
                                            ...
                                            <button type="button"
                                                ...
                                                wire:click="showForm">
                                                {{-- Updated by Shanila to Add svg icon--}}
                                                <svg aria-label="Add Customer" width="20" height="20"
                                                    viewBox="0 0 20 20">
                                                        ...
                                                        <td>
                                                            <div class="d-flex actions">
                                                                <a href="#" title="Edit Customer" aria-label="Edit Team"
                                                                    ...
                                                                    {{-- Updated by Shanila to Add svg icon--}}
                                                                    <svg title="Edit Customer" width="20" height="20"
                                                                        viewBox="0 0 20 20">
                                                                ...
                                                                <a href="#" title="View Customer"
                                                                    ...
                                                                    {{-- Updated by Shanila to Add svg icon--}}
                                                                    <svg aria-label="View Customer" width="20"
                                                                ...
                                                                <div class="d-flex actions">
                                                                    <div class="dropdown ac-cstm">
                                                                        ...
                                                                        <div class="tablediv dropdown-menu">
                                                                            <a title="View customer's Invoice"
                                                                                aria-label="View customer's Invoice"
                                                                                href="#" class="dropdown-item"><i
                                                                                    class="fa fa-eye"></i>View
                                                                                customer’s invoices</a>
                                                        ...
                                                        <td>
                                                            <div class="d-flex actions">
                                                                <a href="#" title="Edit Customer" aria-label="Edit Team"
                                                                    class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                                                    {{-- Updated by Shanila to Add svg icon--}}
                                                                    <svg title="Edit Edit Customer" width="20"
                                                                        height="20" viewBox="0 0 20 20">
                                                                        <use xlink:href="/css/common-icons.svg#pencil">
                                                                        </use>
                                                                    </svg>
                                                                ...
                                                                <a href="#" title="View Customer" aria-label="Edit Team"
                                                                    class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                                                    {{-- Updated by Shanila to Add svg icon--}}
                                                                    <svg aria-label="View Customer" width="20"
                                                                        height="20" viewBox="0 0 20 20">
