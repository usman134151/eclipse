												...
												<tbody>
													...
													<tr role="row" class="{{ ($i % 2 == 0) ? 'odd' : 'even' }}">
														...
														<td>
															<div class="row g-2">
																<div class="col-md-2">
																	<img src="/tenant/images/portrait/small/avatar-s-20.jpg" class="img-fluid rounded-circle" alt="Customer Profile Image">
																</div>
																<div class="col-md-10">
														...
														<td>
															<div class="d-flex actions">
																...
																<a href="#" title="View Customer" aria-label="View Customer" class="btn btn-sm btn-secondary rounded btn-hs-icon" wire:click="showProfile">
																	{{-- Updated by Shanila to Add svg icon--}}
