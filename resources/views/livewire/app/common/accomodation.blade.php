<div>
    <div>
        ...
        <span class="visually-hidden">Loading...</span> 
          ...
          @if($showForm) 
          @livewire('app.common.forms.accomodationform') <!--show add/edit form (update name of file accordingly-->
         @else
                  ...
                  <div class="card-body">
                        <div class="page-title">
                          ...
                          <div class="col-md-3 ms-auto text-end">
                            <a href="accommodation/create" wire:click="showForm" class="btn btn-primary">Add Accommodation</a>
                          </div>
                          </div>
                          <div class="row">
                            <div class="col-md-12">
                              ...
                              <tbody>
                                <tr role="row" class="odd"> 
                                  <td>
                                      <div class="row g-2">
                                        <div class="col-md-2">
                                          <img src="{{asset('tenant/images/portrait/small/avatar-s-1.jpg')}}" class="img-fluid rounded-circle" alt="Provider Image">
                                        </div>
                                      </div> 
                                  </td>
                                ...
                                <tr role="row" class="even"> 
                                  <td>
                                    <div class="row g-2">
                                      <div class="col-md-2">
                                        <img src="images/portrait/small/avatar-s-8.jpg" class="img-fluid rounded-circle" alt="Provider Image">
                                      </div>
                                    </div> 
                                </td>
                                  <td>Blog Writing</td>
