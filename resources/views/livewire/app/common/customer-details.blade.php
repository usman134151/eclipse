                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="customer-feedback-tab" data-bs-toggle="tab"
                                        data-bs-target="#customer-feedback-tab-pane" type="button" role="tab"
                                        aria-controls="customer-feedback-tab-pane" aria-selected="false">
                                        {{-- Updated by Shanila to Add svg icon--}}
                                ...
                                <div class="tab-pane fade show active" id="dashboard-tab-pane" role="tabpanel"
                                    ...
                                    <div class="col-md-12 mb-md-2 mt-5">
                                        <div class="row mt-2 mb-5">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-md-4">
                                                        ...
                                                        <div style="margin-left: -1rem;"
                                                            ...
                                                            <svg aria-label="Sydney, Australia" width="156" height="32"
                                            ...
                                            <div
                                                class="col-md-12 d-flex form-actions flex-lg-row flex-column justify-content-center gap-2">
                                                <button type="button"
                                                        ...
                                                        <td>
                                                            <div class="row mt-4">
                                                                <div class="col-md-12 d-flex">
                                                                    {{-- Updated by Shanila to Add svg icon--}}
                                                                    <svg aria-label="Stars" width="18" height="16"
                                                                        viewBox="0 0 18 16">
                                                                        <use
                                                                            xlink:href="/css/common-icons.svg#filled-star">
                                                                        </use>
                                                                    ...
                                                                    <svg aria-label="Stars" width="17" height="16"
                                                                        viewBox="0 0 17 16">
                                                                        <use xlink:href="/css/common-icons.svg#star">
                                                                        </use>
                                                                    </svg>
                                                        ...
                                                        <td>
                                                            <div class="d-flex actions">
                                                                <a href="javascript:void(0)" title="Hide"
                                                                    aria-label="Hide Cutomer"
                                                                    class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                                                    {{-- Updated by Shanila to Add svg icon--}}
                                                                    <svg aria-label="Hide Customer" width="24"
                                                                ...
                                                                <a href="#" title="Edit Customer" aria-label="Edit"
                                                                    class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                                                    {{-- Updated by Shanila to Add svg icon--}}
                                                                    <svg aria-label="Edit Customer" width="20"
                                                                        height="20" viewBox="0 0 20 20">
