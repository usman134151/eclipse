        ...
        <tbody>
            ...
            <tr role="row" class="{{ ($i % 2 == 0) ? 'even' : 'odd' }}">
                ...
                <td>
                    <div class="row g-2">
                        <div class="col-md-3">
                            <img width=50 height=50 src="{{$user->profile_pic !=null ? $user->profile_pic : '/tenant-resources/images/portrait/small/image4.png'}}" class=" rounded-circle" alt="Image of user Profile">
                        </div>
                        <div class="col-md-9"
                         >
