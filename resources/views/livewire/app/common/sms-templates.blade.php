          ...
          <div class="card-body">
            <div class="form">
              ...
              <div class="mb-4">
                <div class="row w-100">
                  <div class="col-md-6 mb-md-2">
                    <label class="form-label" for="company-column">Select Trigger</label>
              ...
              <div class="col-md-12 col-12">
                <label class="form-label" for="company-column">Select Role</label>
              </div>
              <div class="col-md-12 col-12">
                
                <button type="submit"
                    class="btn btn-primary rounded px-4 py-2 mx-1"><svg width="23" height="26" viewBox="0 0 23 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button type="submit"
                    class="btn btn-primary rounded px-4 py-2 mx-1"><svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button type="button"
                    class="btn btn-outline-dark rounded px-4 py-2 mx-1"><svg width="22" height="26" viewBox="0 0 22 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button type="submit"
                    class="btn btn-primary rounded px-4 py-2 mx-1"><svg width="36" height="26" viewBox="0 0 36 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button type="submit"
                    class="btn btn-primary rounded px-4 py-2 mx-1">
