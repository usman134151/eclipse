    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h1 class="content-header-title float-start mb-0">Import Specializations</h1>
                ...
                <div class="card">
                    <div class="card-body">
                        <div>
                            ...
                            @endif
                            @if ($specializations)
                                <h2 class="mt-5">Preview Specialization</h2>
                                                        ...
                                                        <div class="row g-2">
                                                            <div class="col-md-10">
                                                                <div>
                                                                    ...
                                                                    <input type="text"
                                                                        wire:model.defer="specializations.{{ $loop->index }}.name"
                                                                        class="form-control" />
                                                                    @error('specializations.{{ $loop->index }}.name')
                                                                        <span
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <input type="text"
                                                                        wire:model.defer="specializations.{{ $loop->index }}.description"
                                                                        class="form-control" />
                                                                    @error('specializations.{{ $loop->index }}.description')
                                                                        <span
                                                                            class="d-inline-block invalid-feedback mt-2">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
