        ...
        <div class="row mb-4">
            <div class="col-lg-12">
                <div class="col-lg-12">
                    ...
                    <p>Your set hours determine when "Business hours" and "After-hours" rates are in effect for customer
                        billing and Provider payroll and prevents services from being scheduled during your "closed"
                        hours.You can also set the times which you are closed and not providing services; this will
                        restrict customers from scheduling.</p>
                </div>
                ...
                <div class="col-lg-12">
                        ...
                        <div class="d-flex flex-column justify-content-between">
                            ...
                            <div class="d-flex gap-2">
                                <div class="input-group">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="time_format12"
                                            id="time_format12" value="1" wire:model="schedule.time_format">
                            ...
                            <div class="d-flex gap-2 mt-11">
                                <div class="time d-flex align-items-center gap-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="time_format24"
                                            id="time_format24" value="2" wire:model="schedule.time_format">
                                ...
                                <div class="input-group  ">
                                    <div class="input-group-text">
                                        <input class="form-check-input  mt-0" type="radio" value="1"
                                            name="timeslot_type" aria-label="Time slot for business hours"
                                            wire:model.defer="timeslot.timeslot_type">
                                    </div>

                                    <input disabled placeholder="Business Hours" type="text" class="form-control"
                                        aria-label="Text input with radio button" name="timeslot.timeslot_type">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="mt-2">
                                <div class="input-group">
                                    <div class="input-group-text">
                                        <input class="form-check-input mt-0" type="radio" value="2" name="timeslot_type"
                                            aria-label="Time slot for after business hours"
                                            name="timeslot.timeslot_type" wire:model.defer="timeslot.timeslot_type">
                                    </div>
                                    <input disabled placeholder="After Business Hours" type="text" class="form-control"
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-12">
                            ...
                            <div class="d-inline-block invalid-feedback mt-2 "> {{ $errors->first('timeValidation') }}
                            </div>
                            <div class="d-lg-flex gap-3 align-items-center mb-3">
                                <select name="timeslot_day" aria-labelledby="select-day" id="select-day"
                                    wire:model.defer="timeslot.timeslot_day" class="form-control w-25">
                                    @foreach ($days as $day)
                                ...
                                <div class="d-flex">
                                    <div class="d-flex flex-column justify-content-between">
                                        ...
                                        <div class="d-flex gap-2">
                                            <div class="time d-flex align-items-center gap-2">
                                                <div><input class="form-control form-control-sm text-center hours"
                                                        aria-label="start Time Hours" id="start-hour" name="start_hour"
                                                        placeholder="" type="" tabindex="" wire:key="duration-0"
                                                        wire:model.defer="timeslot.timeslot_start_hour" maxlength="2">
                                                </div>
                                                ...
                                                <div><input class="form-control form-control-sm text-center  mins"
                                                        aria-label="start time Minutes" id="start-min"
                                                        name="DisplayToProviders" placeholder="" type="" tabindex=""
                                                        wire:key="duration-0"
                                                        wire:model.defer="timeslot.timeslot_start_min" maxlength="2">
                                                </div>
                                            </div>
                                            @if($schedule->time_format==1)
                                            <div>
                                                <select class="form-control form-control-sm text-center hours"
                                                    aria-labelledby="Time-format" id="Time-format"
                                                    wire:model.defer="timeslot_start_type"
                                                    style="padding: 0.4rem 2.2rem">
                                ...
                                <div class="d-flex">
                                    <div class="d-flex flex-column justify-content-between">
                                        ...
                                        <div class="d-flex gap-2">
                                            <div class="time d-flex align-items-center gap-2">
                                                <div><input class="form-control form-control-sm text-center  hours"
                                                        aria-label="Ending Tome Hours" id="Ending-hours"
                                                        name="DisplayToProviders" placeholder="" type="" tabindex=""
                                                        wire:key="duration-0"
                                                        wire:model.defer="timeslot.timeslot_end_hour" maxlength="2">
                                                </div>
                                                <svg width="5" height="19" viewBox="0 0 5 19" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                ...
                                                <div><input class="form-control form-control-sm text-center  mins"
                                                        aria-label="Ending Time Minutes" id="Ending-min"
                                                        name="DisplayToProviders" placeholder="" type="" tabindex=""
                                                        wire:key="duration-0"
                                                        wire:model.defer="timeslot.timeslot_end_min" maxlength="2">
                                                </div>
                                            </div>
                                            @if($schedule->time_format==1)
                                            <div>
                                                <select class="form-control form-control-sm text-center hours"
                                                    wire:model.defer="timeslot_end_type" style="padding: 0.4rem 2.2rem">
                                                    <option value="am">AM</option>
                                                    <option value="pm">PM</option>
                                                </select>
                                            </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="d-lg-flex  justify-content-between mb-4">
                                ...
                                <div class="time d-flex align-items-center gap-2">
                                    <div class="form-check">
                                        <input class="form-check-input bg-success" type="radio" name="radio"
                                            id="Business Hours" value="" disabled>
                                        <label class="form-check-label" for="Business Hours">
                                            Business Hours
                                        </label>
                                    </div>
                                    <div class="form-check ">
                                        <input class="form-check-input bg-warning" type="radio" name="radio"
                                            id="After Business Hours" value="option1" disabled>
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            ...
                                            <div class="form-check form-switch">
                                                ...
                                                <input wire:model="schedule.working_days.{{ $day }}"
                                                    class="form-check-input"
                                                    aria-label="Toggle Business Schedule Status" type="checkbox"
                                                    role="switch" id="{{ strtolower($day) }}">
                                            </div>
                                        </th>
                                        @endforeach
                                    </tr>
                                            ...
                                            <div class="time-slot mb-3 bg-success text-white position-relative">
                                                ...
                                                <div class="time-slot mb-3 bg-secondary text-white position-relative">
                                                    ...
                                                    <a href="#" title="Delete" aria-label="Delete"
                                                        wire:click.prevent="deleteSlot({{ $timeslot['id'] }})"
                                                        class="btn btn-sm btn-secondary rounded btn-hs-icon position-absolute top-0 end-0"
                                                        style="right: 5px;" name="deleteIcon">
                                                        <svg aria-label="Delete" class="delete-icon" width="20"
                    ...
                    <div>
                        ...
                        <div class="position-relative">
                            <input type="" id="select-days" wire:model="holidayDate"
                                class="form-control w-auto js-single-date " placeholder="MM/DD/YYYY"
                                name="selectHolidays">
                            <svg class="icon-date cursor-pointer" width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" id="yearly" name="yearly" type="checkbox" tabindex=""
                                wire:model.defer="repeatYearly" value="1" />
