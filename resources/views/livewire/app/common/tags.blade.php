...
<div>
    ...
    @if($showForm)
    @livewire('app.common.forms.tags-form')
    <!--show add/edit form-->
    @elseif($importFile)
    @livewire('app.common.import.tags-import')
    @else
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="d-flex flex-column flex-md-row justify-content-end mt-4 mb-3 gap-2">
                                        ...
                                        <button type="button"
                                            ...
                                            <svg aria-label="Import Specialization" width="20" height="20"
                                                viewBox="0 0 20 20">
                                                <use xlink:href="/css/common-icons.svg#import-file"></use>
                                            </svg>
                                            <span>Import Tags</span>
                                        </button>
                                        <a href="#" wire:click="showForm"
                                            class="d-inline-flex align-items-center btn btn-primary rounded px-3 py-2 gap-2">Add
                                            Tag</a>
                                    </div>
                                    <p>{{$listDescription}}</p>
                                </div>
                        ...
                        @livewire('app.common.lists.tags',key(Str::random(10)))
    </section>
