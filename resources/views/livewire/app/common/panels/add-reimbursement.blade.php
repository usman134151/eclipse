    ...
    <form class="form" wire:submit.prevent="save">
        ...
        <div class="row">
            <div class="col-md-10 mb-4">
                ...
                <select wire:model="selectedValue" data-placeholder="Select Assignment No." class="select2 form-select"
                            ...
                            <div class="btn btn-outline-primary d-block px-2 pb-0">
                                <label for="file">
                                    <svg class="mb-2" width="35" height="35" viewBox="0 0 35 35" fill="none"
                                        ...
                                        <defs>
                                            <linearGradient id="paint0_linear_2957_105064" x1="17.5" y1="0" x2="31.5419"
                                ...
                                <input style=" opacity: 0; z-index: -1; position: absolute;" id="file" class=""
        ...
        <div class="form-check mb-4">
            <input wire:model.defer="reimbursement.charge_to_customer" class="form-check-input" type="checkbox" value=""
                id="charge-To-customer" checked>
        ...
        <div class="col-12 justify-content-center form-actions d-flex gap-3">
            {{-- <button class="btn btn-outline-primary rounded" x-on:click="addReimbursement = !addReimbursement"> --}}
                ...
                {{-- <button type="submit" class="btn btn-primary rounded"
                    ...
                    <button x-on:click="addReimbursement = !addReimbursement" wire:click.prevent="save" type="submit" class="btn btn-primary rounded">
                        ADD
                    </button>
        </div>
...
<script>
    ...
    $('#booking_id').on('change', function () {
            ...
            // Call the Livewire component function getProviderAssignments
            Livewire.emit('updateSelectedValue', $(this).val());
        });
</script>
@endpush