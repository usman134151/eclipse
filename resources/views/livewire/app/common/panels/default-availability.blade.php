<div class="row ">
                      ...
                      <div class="d-flex flex-column justify-content-between">
                        ...
                        <div class="d-flex gap-2">
                          <div class="time d-flex align-items-center gap-2">
                            ...
                            <svg aria-label=" " width="5" height="19" viewBox="0 0 5 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="d-lg-flex gap-3 mb-3">
                    <div>
                        ...
                        <div class="position-relative">
                            ...
                            <svg aria-label="Date" class="icon-date cursor-pointer" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <tr class="odd">
                            ...
                            <td>
                                <a href="#" aria-label="delete" class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                    <svg aria-label="Delete" width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="col-12 justify-content-center form-actions d-flex gap-3">
        ...
        <button type="submit" class="btn btn-primary rounded" x-on:click="defaultAvailability = !defaultAvailability">
            Save
        </button>
    </div>
</div>