         ...
         <div class="accordion-item">
             <h2 class="accordion-header" id="headingDetails{{ $index }}">
                 <button class="btn btn-sm btn-secondary rounded btn-hs-icon custom-dropdown-btn collapsed" type="button" data-bs-toggle="collapse"
                     data-bs-target="#collapseDetails{{ $index }}" aria-expanded="false" aria-controls="collapseDetails{{ $index }}">
                        ...
                        <tr>
                            ...
                            @if(!$providersPayment[$index]['service_payment_details']['day_rate'] && !$providersPayment[$index]['service_payment_details']['fixed_rate'])   
                                         ...
                                         <div class="row">
                                             <div class="  mt-1">
                                                 <div class="col col-12">
                                                     <div class="col-12">
                                                         <label class="form-label-sm" style="margin: 20px 0;"><strong> After
                                                                 Hours</strong></label>
                                                     </div>
                                                     <div class="row">
                                                         <div class="col-3 mt-1">
                                         ...
                                         <div class="row">
                                             <div class="  mt-1">
                                                 <div class="col col-12">
                                                     <div class="col-12">
                                                         <label class="form-label-sm" style="margin: 20px 0;"><strong> Expedition
                                         ...
                                         @if (count($booking_specializations))
                                            ...
                                            <div class="row">
                                                <div class="  mt-1">
                                                    ...
                                                    <div class="col col-12">
                                                        <label class="form-label-sm" style="margin: 20px 0;"><strong>
                            ...
                            <div class="d-inline-flex">
                                        <div class="col-md-2"></div>
                                         <div class="col-md-6">
                                             <div class="mb-2">
                                                 <label class="form-label-md" for="total-service-payment">Total Service Payment</label>
                                                 <input type="number" name=""
                                                     class="form-control form-control-sm "
