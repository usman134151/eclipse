        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex align-items-center w-100 mb-2">
                <div class="position-relative flex-grow-1">
                    <input type="text" id="due-date" class="form-control js-single-date" placeholder="Select Due Date" aria-describedby="">
                    <svg aria-label="date" class="icon-date" width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
