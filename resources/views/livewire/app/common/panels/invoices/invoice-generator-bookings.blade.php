          ...
          <div class="table-responsive border mb-4">
            ...
            <thead>
              ...
              <th scope="col" class="text-center">
                <input class="form-check-input" type="checkbox" value="" aria-label="Select All Booking">
              </th>
            ...
            <tbody>
              ...
              <td class="position-relative">
                            ...
                            <div class="d-flex flex-column gap-1">
                              ...
                              <div class="d-flex gap-2 align-items-center">
                                ...
                                <div class="col-2">
                                  <input type="" name="" class="form-control form-control-xs text-center" aria-label="Food" value="15">
                                </div>
                                <div>
                                  <svg aria-label="Delete" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M6.4 3.2H9.6C9.6 2.77565 9.43143 2.36869 9.13137 2.06863C8.83131 1.76857 8.42435 1.6 8 1.6C7.57565 1.6 7.16869 1.76857 6.86863 2.06863C6.56857 2.36869 6.4 2.77565 6.4 3.2ZM4.8 3.2C4.8 2.35131 5.13714 1.53737 5.73726 0.937258C6.33737 0.337142 7.15131 0 8 0C8.84869 0 9.66263 0.337142 10.2627 0.937258C10.8629 1.53737 11.2 2.35131 11.2 3.2H15.2C15.4122 3.2 15.6157 3.28429 15.7657 3.43431C15.9157 3.58434 16 3.78783 16 4C16 4.21217 15.9157 4.41566 15.7657 4.56569C15.6157 4.71571 15.4122 4.8 15.2 4.8H14.4944L13.7856 13.072C13.7175 13.8708 13.352 14.6149 12.7615 15.1571C12.171 15.6993 11.3985 16.0001 10.5968 16H5.4032C4.60153 16.0001 3.82902 15.6993 3.23852 15.1571C2.64802 14.6149 2.28254 13.8708 2.2144 13.072L1.5056 4.8H0.8C0.587827 4.8 0.384344 4.71571 0.234315 4.56569C0.0842854 4.41566 0 4.21217 0 4C0 3.78783 0.0842854 3.58434 0.234315 3.43431C0.384344 3.28429 0.587827 3.2 0.8 3.2H4.8ZM10.4 8C10.4 7.78783 10.3157 7.58434 10.1657 7.43432C10.0157 7.28429 9.81217 7.2 9.6 7.2C9.38783 7.2 9.18434 7.28429 9.03432 7.43432C8.88429 7.58434 8.8 7.78783 8.8 8V11.2C8.8 11.4122 8.88429 11.6157 9.03432 11.7657C9.18434 11.9157 9.38783 12 9.6 12C9.81217 12 10.0157 11.9157 10.1657 11.7657C10.3157 11.6157 10.4 11.4122 10.4 11.2V8ZM6.4 7.2C6.61217 7.2 6.81566 7.28429 6.96569 7.43432C7.11571 7.58434 7.2 7.78783 7.2 8V11.2C7.2 11.4122 7.11571 11.6157 6.96569 11.7657C6.81566 11.9157 6.61217 12 6.4 12C6.18783 12 5.98434 11.9157 5.83432 11.7657C5.68429 11.6157 5.6 11.4122 5.6 11.2V8C5.6 7.78783 5.68429 7.58434 5.83432 7.43432C5.98434 7.28429 6.18783 7.2 6.4 7.2ZM3.808 12.936C3.84208 13.3355 4.02493 13.7077 4.32035 13.9788C4.61577 14.2499 5.00223 14.4002 5.4032 14.4H10.5968C10.9975 14.3998 11.3836 14.2494 11.6786 13.9783C11.9737 13.7072 12.1563 13.3352 12.1904 12.936L12.888 4.8H3.112L3.8096 12.936H3.808Z" fill="#888575"/>
                                ...
                                <div>
                                  <div class="form-check mb-0">
                                    <input class="form-check-input" type="checkbox" aria-label="Food checkbox" value="" id="">
                                  </div>
                                </div>
                              </div>
                              <div>
                                <a href="#" class="btn btn-primary btn-xxs rounded btn-has-icon">
                                  <svg aria-label="Add New" width="14" height="14" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <td class="position-relative">
                            <div class="d-flex align-items-center gap-2 mb-2">
                              ...
                              <input type="" name="" class="form-control form-control-xs form-control-max-w-xs text-center" value="5" aria-label="Duration in hour"> h
                              <input type="" name="" class="form-control form-control-xs form-control-max-w-xs text-center" value="5" aria-label="Duration in minute"> m
                              <a href="#" title="Save" aria-label="Save" class="btn btn-sm btn-secondary rounded btn-hs-icon icon-save">
                                <svg aria-label="save" width="12" height="12" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M16.6026 3.85262L13.1474 0.397375C12.988 0.238 12.7925 0.121125 12.58 0.0573749V0H0.68C0.303875 0 0 0.303875 0 0.68V16.32C0 16.6961 0.303875 17 0.68 17H16.32C16.6961 17 17 16.6961 17 16.32V4.81313C17 4.45188 16.8576 4.10763 16.6026 3.85262ZM5.78 1.53H11.22V3.74H5.78V1.53ZM15.47 15.47H1.53V1.53H4.42V4.42C4.42 4.79612 4.72388 5.1 5.1 5.1H11.9C12.2761 5.1 12.58 4.79612 12.58 4.42V1.99325L15.47 4.88325V15.47ZM8.5 7.0125C6.81063 7.0125 5.44 8.38313 5.44 10.0725C5.44 11.7619 6.81063 13.1325 8.5 13.1325C10.1894 13.1325 11.56 11.7619 11.56 10.0725C11.56 8.38313 10.1894 7.0125 8.5 7.0125ZM8.5 11.7725C7.56075 11.7725 6.8 11.0118 6.8 10.0725C6.8 9.13325 7.56075 8.3725 8.5 8.3725C9.43925 8.3725 10.2 9.13325 10.2 10.0725C10.2 11.0118 9.43925 11.7725 8.5 11.7725Z" fill="black"/>
                                </svg>
                              </a>
                            </div>
                            <div class="row g-0 mb-2">
                              ...
                              <div class="col-8 d-flex align-items-center gap-2"><input aria-label="Average Rate" type="" name="" class="form-control form-control-xs form-control-max-w-xs text-center" value="5"> $</div>
                            </div>
                            <div class="row g-0 mb-2">
                              <div class="col-4"><label class="form-label-sm mb-0">Total Rate:</label></div>
                              <div class="col-8 d-flex align-items-center gap-2"><input aria-label="Total Rate" type="" name="" class="form-control form-control-xs form-control-max-w-xs text-center" value="5"> $</div>
                            </div>
                            <div class="text-sm text-primary mb-1">Discount:</div>
                          <div class="d-inline-flex align-items-center mb-1">
                            <div class="col-lg-6">
                              <div class="input-group">
                                  <input type="text" class="form-control form-control-xs text-center form-control-max-w-xs" aria-label="Discount Amount" placeholder="20" aria-label="" aria-describedby="">
                                  <select class="form-select form-select-sm" aria-label="discount type" id="">
                                      <option>$</option>
                                      <option>%</option>
                                    </select>
                              </div>
              ...
              <td>
                ...
                <div class="dropdown ac-cstm">
                                <a href="javascript:void(0)" class="btn btn-sm btn-secondary rounded btn-hs-icon dropdown-toggle" aria-label="Action Dropdown" data-bs-toggle="dropdown" data-bs-auto-close="outside" data-bs-popper-config="{&quot;strategy&quot;:&quot;fixed&quot;}">
                                  <svg aria-label="More Options" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <td class="position-relative">
                            ...
                            <div class="d-flex flex-column gap-1">
                              <div class="d-flex gap-2 align-items-center">
                                ...
                                <div class="col-lg-2">
                                  <input type="" name="" class="form-control form-control-xs text-center" value="20" aria-label="Fuel charges">
                                </div>
                                <div>
                                  <svg aria-label="Delete" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M6.4 3.2H9.6C9.6 2.77565 9.43143 2.36869 9.13137 2.06863C8.83131 1.76857 8.42435 1.6 8 1.6C7.57565 1.6 7.16869 1.76857 6.86863 2.06863C6.56857 2.36869 6.4 2.77565 6.4 3.2ZM4.8 3.2C4.8 2.35131 5.13714 1.53737 5.73726 0.937258C6.33737 0.337142 7.15131 0 8 0C8.84869 0 9.66263 0.337142 10.2627 0.937258C10.8629 1.53737 11.2 2.35131 11.2 3.2H15.2C15.4122 3.2 15.6157 3.28429 15.7657 3.43431C15.9157 3.58434 16 3.78783 16 4C16 4.21217 15.9157 4.41566 15.7657 4.56569C15.6157 4.71571 15.4122 4.8 15.2 4.8H14.4944L13.7856 13.072C13.7175 13.8708 13.352 14.6149 12.7615 15.1571C12.171 15.6993 11.3985 16.0001 10.5968 16H5.4032C4.60153 16.0001 3.82902 15.6993 3.23852 15.1571C2.64802 14.6149 2.28254 13.8708 2.2144 13.072L1.5056 4.8H0.8C0.587827 4.8 0.384344 4.71571 0.234315 4.56569C0.0842854 4.41566 0 4.21217 0 4C0 3.78783 0.0842854 3.58434 0.234315 3.43431C0.384344 3.28429 0.587827 3.2 0.8 3.2H4.8ZM10.4 8C10.4 7.78783 10.3157 7.58434 10.1657 7.43432C10.0157 7.28429 9.81217 7.2 9.6 7.2C9.38783 7.2 9.18434 7.28429 9.03432 7.43432C8.88429 7.58434 8.8 7.78783 8.8 8V11.2C8.8 11.4122 8.88429 11.6157 9.03432 11.7657C9.18434 11.9157 9.38783 12 9.6 12C9.81217 12 10.0157 11.9157 10.1657 11.7657C10.3157 11.6157 10.4 11.4122 10.4 11.2V8ZM6.4 7.2C6.61217 7.2 6.81566 7.28429 6.96569 7.43432C7.11571 7.58434 7.2 7.78783 7.2 8V11.2C7.2 11.4122 7.11571 11.6157 6.96569 11.7657C6.81566 11.9157 6.61217 12 6.4 12C6.18783 12 5.98434 11.9157 5.83432 11.7657C5.68429 11.6157 5.6 11.4122 5.6 11.2V8C5.6 7.78783 5.68429 7.58434 5.83432 7.43432C5.98434 7.28429 6.18783 7.2 6.4 7.2ZM3.808 12.936C3.84208 13.3355 4.02493 13.7077 4.32035 13.9788C4.61577 14.2499 5.00223 14.4002 5.4032 14.4H10.5968C10.9975 14.3998 11.3836 14.2494 11.6786 13.9783C11.9737 13.7072 12.1563 13.3352 12.1904 12.936L12.888 4.8H3.112L3.8096 12.936H3.808Z" fill="#888575"/>
                                ...
                                <div>
                                  <div class="form-check mb-0">
                                    <input class="form-check-input" type="checkbox" value="" id="" checked aria-label="Fuel charges chechkbox">
                                  </div>
                                </div>
                              </div>
                              <div class="d-flex gap-2 align-items-center">
                                ...
                                <div class="col-lg-2">
                                  <input aria-label="Food" type="" name="" class="form-control form-control-xs text-center" value="15" >
                                </div>
                                <div>
                                  <svg aria-label="Delete" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M6.4 3.2H9.6C9.6 2.77565 9.43143 2.36869 9.13137 2.06863C8.83131 1.76857 8.42435 1.6 8 1.6C7.57565 1.6 7.16869 1.76857 6.86863 2.06863C6.56857 2.36869 6.4 2.77565 6.4 3.2ZM4.8 3.2C4.8 2.35131 5.13714 1.53737 5.73726 0.937258C6.33737 0.337142 7.15131 0 8 0C8.84869 0 9.66263 0.337142 10.2627 0.937258C10.8629 1.53737 11.2 2.35131 11.2 3.2H15.2C15.4122 3.2 15.6157 3.28429 15.7657 3.43431C15.9157 3.58434 16 3.78783 16 4C16 4.21217 15.9157 4.41566 15.7657 4.56569C15.6157 4.71571 15.4122 4.8 15.2 4.8H14.4944L13.7856 13.072C13.7175 13.8708 13.352 14.6149 12.7615 15.1571C12.171 15.6993 11.3985 16.0001 10.5968 16H5.4032C4.60153 16.0001 3.82902 15.6993 3.23852 15.1571C2.64802 14.6149 2.28254 13.8708 2.2144 13.072L1.5056 4.8H0.8C0.587827 4.8 0.384344 4.71571 0.234315 4.56569C0.0842854 4.41566 0 4.21217 0 4C0 3.78783 0.0842854 3.58434 0.234315 3.43431C0.384344 3.28429 0.587827 3.2 0.8 3.2H4.8ZM10.4 8C10.4 7.78783 10.3157 7.58434 10.1657 7.43432C10.0157 7.28429 9.81217 7.2 9.6 7.2C9.38783 7.2 9.18434 7.28429 9.03432 7.43432C8.88429 7.58434 8.8 7.78783 8.8 8V11.2C8.8 11.4122 8.88429 11.6157 9.03432 11.7657C9.18434 11.9157 9.38783 12 9.6 12C9.81217 12 10.0157 11.9157 10.1657 11.7657C10.3157 11.6157 10.4 11.4122 10.4 11.2V8ZM6.4 7.2C6.61217 7.2 6.81566 7.28429 6.96569 7.43432C7.11571 7.58434 7.2 7.78783 7.2 8V11.2C7.2 11.4122 7.11571 11.6157 6.96569 11.7657C6.81566 11.9157 6.61217 12 6.4 12C6.18783 12 5.98434 11.9157 5.83432 11.7657C5.68429 11.6157 5.6 11.4122 5.6 11.2V8C5.6 7.78783 5.68429 7.58434 5.83432 7.43432C5.98434 7.28429 6.18783 7.2 6.4 7.2ZM3.808 12.936C3.84208 13.3355 4.02493 13.7077 4.32035 13.9788C4.61577 14.2499 5.00223 14.4002 5.4032 14.4H10.5968C10.9975 14.3998 11.3836 14.2494 11.6786 13.9783C11.9737 13.7072 12.1563 13.3352 12.1904 12.936L12.888 4.8H3.112L3.8096 12.936H3.808Z" fill="#888575"/>
                                ...
                                <div>
                                  <div class="form-check mb-0">
                                    <input class="form-check-input" type="checkbox" value="" id="" aria-label="Food charges checkbox">
                                  </div>
                                </div>
                              </div>
                              <div>
              ...
              <td class="position-relative">
                            <div class="d-flex align-items-center gap-2 mb-2">
                              ...
                              <div>5h,</div>
                              <div>10m</div>
                              <a href="#" title="Edit" aria-label="Edit" class="btn btn-sm btn-secondary rounded btn-hs-icon icon-edit position-absolute">
                              <svg aria-label="Edit" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <td>
                <div class="d-flex actions justify-content-center">
                <a href="#" title="Cancel" aria-label="Cancel" class="btn btn-sm btn-secondary rounded btn-hs-icon">
                  <svg aria-label="Cancel" class="fill-stroke" width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M8.3125 16.8125H1.4375V1.1875H14.5625V9.3125M15.8125 12.4375L11.4375 16.8125M5.1875 8.6875H10.8125M5.1875 12.4375H7.0625M5.1875 4.9375H10.8125M11.4375 12.4375L15.8125 16.8125" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                </a>
                <a href="#" title="Record Payment" aria-label="Record Payment" class="btn btn-sm btn-secondary rounded btn-hs-icon">
                  <svg aria-label="Record Payment" width="19" height="20" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <td class="position-relative">
                ...
                <div>Fuel Charges: $20 <i class="fa fa-check-circle" data-bs-toggle="tooltip" data-bs-placement="top" title=""></i></div>
                <div>Food: $15</div>
              </td>
              <td class="position-relative">
                            <div class="d-flex align-items-center gap-2 mb-2">
              ...
              <td>
                <div class="d-flex actions justify-content-center">
                <a href="#" title="Cancel Assignment" aria-label="Cancel Assignment" class="btn btn-sm btn-secondary rounded btn-hs-icon">
                  <svg aria-label="Cancel Assignment" class="fill-stroke" width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M8.3125 16.8125H1.4375V1.1875H14.5625V9.3125M15.8125 12.4375L11.4375 16.8125M5.1875 8.6875H10.8125M5.1875 12.4375H7.0625M5.1875 4.9375H10.8125M11.4375 12.4375L15.8125 16.8125" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                </a>
                <a href="#" title="Record Payment" aria-label="Record Payment" class="btn btn-sm btn-secondary rounded btn-hs-icon">
