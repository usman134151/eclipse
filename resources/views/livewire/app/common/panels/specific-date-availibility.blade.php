        ...
        <div class="col-lg-12 mb-4">
            <div class="d-lg-flex gap-3 align-items-center mb-3">
                <div class="col-md-12 col-12">
                    ...
                    @foreach ($timeslots as $index => $timeslot)
                        <div class="col-md-12 col-12 items-center">
                            <div>
                                <div class="d-flex justify-content-start mt-4">
                                    ...
                                    <div class="align-items-center px-3 gap-2">
                                        <a wire:click.prevent="removeSlot({{ $index }})" href="#"
                                            ...
                                            <div class="time d-flex align-items-center gap-2">
                                                <div>
                                                    <input class="form-control form-control-sm text-center hours"
                                                        id="{{ $index }}.from_time_hour" aria-label="Start Time"
                                                        name="start_hour" placeholder="" type="" tabindex=""
                                                        wire:key="{{ $index }}.from_time_hour"
                                                        wire:model.defer="timeslots.{{ $index }}.from_time_hour"
                                                        maxlength="2">
                                                </div>
                                                ...
                                                <div>
                                                    <input class="form-control form-control-sm text-center  mins"
                                                        ...
                                                        id="{{ $index }}.from_time_min" name="DisplayToProviders"
                                                        placeholder="" type="" tabindex=""
                                                        wire:key="{{ $index }}.from_time_min"
                                                        wire:model.defer="timeslots.{{ $index }}.from_time_min"
                                                        maxlength="2">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex flex-column justify-content-between">
                                        ...
                                        <div class="d-flex gap-2">
                                            <div class="time d-flex align-items-center gap-2">
                                                <div>
                                                    <input class="form-control form-control-sm text-center hours"
                                                        id="{{ $index }}.to_time_hour" aria-label="End Time"
                                                        name="end_hour" placeholder="" type="" tabindex=""
                                                        wire:key="{{ $index }}.to_time_hour"
                                                        wire:model.defer="timeslots.{{ $index }}.to_time_hour"
                                                        maxlength="2">
                                                </div>
                                                <svg width="5" height="19" viewBox="0 0 5 19" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <div>
                                                    <input class="form-control form-control-sm text-center  mins"
                                                        aria-label="End Minutes" id="{{ $index }}.to_time_min"
                                                        name="{{ $index }}.to_time_min" placeholder=""
                                                        type="" tabindex=""
                                                        wire:key="{{ $index }}.to_time_min"
                                                        wire:model.defer="timeslots.{{ $index }}.to_time_min"
                                                        maxlength="2">
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="col-12 justify-content-center form-actions d-flex gap-3">
                <button type="button" class="btn btn-outline-dark rounded"
                    x-on:click="specificDateAvailability = !specificDateAvailability">
                    Cancel
                </button>
                {{--  --}}
                <button type="submit" class="btn btn-primary rounded" wire:click.prevent="$emit('saveSpecificSlot')"
                    x-on:close-specific-panel.window="specificDateAvailability = !specificDateAvailability">
                    Save
                </button>
            </div>
        </div>
