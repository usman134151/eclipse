...
<div class="row mb-lg-4 mb-4">
    <div class="col-lg-4 mb-4 mb-lg-0">
      <div class="row">
        <div class="col-lg-4 mb-4 mb-lg-0">
          <img src="/tenant-resources/images/portrait/small/avatar-s-9.jpg" class="img-fluid rounded-circle" alt="Provider Image">
        </div>
              ...
              <tr role="row" class="odd ivp">
                ...
                <td class="align-middle">
                  <div class="d-flex actions justify-content-center">
                    ...
                    <a href="#" title="Accept" aria-label="Accept" class="btn btn-sm btn-secondary rounded btn-hs-icon" data-bs-toggle="modal" data-bs-target="#acceptModal">
                      <svg width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M4.07178 9.34781C4.09446 9.08389 4.20428 8.85022 4.36594 8.63743C4.93482 7.88744 6.20976 7.54359 7.10197 8.09699C7.62729 8.42284 8.04855 8.84229 8.39924 9.33845C8.69052 9.7507 8.95371 10.1835 9.23708 10.6188C9.43474 10.3372 9.63421 10.0477 9.83872 9.76187C11.5961 7.30704 13.5253 5.00235 15.763 2.97094C17.1359 1.7248 18.7111 0.799105 20.4059 0.0671207C20.6986 -0.0596174 20.9431 -0.0102903 21.1944 0.244266C21.0792 0.351921 20.9647 0.458497 20.8513 0.566152C19.3711 1.96855 17.923 3.40336 16.6084 4.96346C15.8559 5.85603 15.1585 6.79504 14.4409 7.71677C12.9957 9.57248 11.9141 11.6604 10.6859 13.6547C10.2117 14.4249 9.74223 15.1979 9.26732 15.9674C9.07865 16.2734 8.83022 16.2691 8.64083 15.9566C8.02658 14.9419 7.54231 13.8639 7.08469 12.7715C6.70231 11.8599 6.27313 10.9702 5.72765 10.1417C5.45798 9.73198 5.14005 9.39461 4.61762 9.34997C4.44155 9.33521 4.26188 9.34781 4.07178 9.34781Z" fill="black"/>
                        <path d="M17.3628 6.17614L15.9229 7.62067C16.3388 8.54168 16.5696 9.56459 16.5696 10.6415C16.5696 14.6975 13.2931 17.9851 9.2508 17.9851C5.2085 17.9851 1.93204 14.6975 1.93204 10.6415C1.93204 6.58552 5.2085 3.29789 9.2508 3.29789C10.2615 3.29789 11.2235 3.50384 12.0984 3.87505L13.5487 2.41973C12.2648 1.74247 10.8019 1.35938 9.2508 1.35938C4.14167 1.35938 0 5.51509 0 10.6415C0 15.7679 4.14167 19.9233 9.2508 19.9233C14.3599 19.9233 18.5016 15.7676 18.5016 10.6411C18.5016 9.02307 18.0886 7.50077 17.3628 6.17614Z" fill="black"/>
                      </svg>
                    </a>
                    <a href="javascript:void(0)" title="Objection" aria-label="Objection" class="btn btn-sm btn-secondary rounded btn-hs-icon" data-bs-toggle="modal" data-bs-target="#objectionModal">
  ...
  <div class="d-flex actions gap-3 justify-content-end mb-2">
    ...
    <div class="d-flex gap-2 align-items-center">
      <a href="#" title="Objection" aria-label="Objection" class="btn btn-sm btn-secondary rounded btn-hs-icon" data-bs-toggle="modal" data-bs-target="#objectionModal">
        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M11.0201 1.12891C5.52343 1.12891 1.07983 5.58648 1.07983 11.1003C1.07983 16.6135 5.52343 21.0711 11.0201 21.0711C16.5168 21.0711 20.9611 16.6135 20.9611 11.1003C20.9611 5.58648 16.5168 1.12891 11.0201 1.12891ZM11.0201 19.898C6.19607 19.898 2.24917 15.939 2.24917 11.1003C2.24917 9.25264 2.83352 7.52245 3.79897 6.1143L17.5109 16.9946C15.9033 18.7839 13.5932 19.898 11.0201 19.898ZM18.2419 16.0857L4.5294 5.20538C6.13763 3.41676 8.44772 2.30205 11.0201 2.30205C15.8442 2.30205 19.7917 6.26102 19.7917 11.1003C19.7917 12.948 19.2067 14.6782 18.2419 16.0857Z" fill="black" stroke="black"/>
        </g>
        </svg>
      </a>
      <span class="text-sm">
