    ...
    <div class="flex-grow-1">
      <div class="row mb-lg-4">
        ...
        <div class="col-lg-4 mb-4 mb-lg-0 align-self-center d-flex gap-5">
            <div class="mb-2">
              <div class="form-label-sm">Total Paid:</div>
              <div class="form-label-sm">Total Pending:</div>
              <div class="form-label-sm">Total Overdue:</div>
            </div>
            <div>
                <div class="">$3000</div>
                <div class="">$1500</div>
            ...
            <thead>
              <tr role="row">
                <th scope="col" class="text-center align-middle">
                  <input class="form-check-input" type="checkbox" value="" aria-label="Select Remittances">
                </th>
            ...
            <tbody>
                <tr role="row" class="odd">
                    <td class="text-center align-middle">
                      <input class="form-check-input" type="checkbox" value="" aria-label="Select Remittance">
                    </td>
              ...
              <tr role="row" class="odd">
                ...
                <td class="text-center align-middle">
                    ...
                    Paid
                     <?php else: ?>
                     <svg aria-label="Issued" width="10" height="10" viewBox="0 0 10 10" fill="none"
