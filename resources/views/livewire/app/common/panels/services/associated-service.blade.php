        ...
        <div class="tab-content">
          <div class="tab-pane fade active show" id="basic-service-setup" role="tabpanel" aria-labelledby="basic-service-setup-tab" tabindex="0">
           <div class="d-lg-flex justify-content-between align-items-center mb-4">
             ...
             <div class="d-lg-flex justify-content-between align-items-center mb-4">
               <div class="col-lg-4">
               <h4 class="mb-lg-0">Associated With:Thomas Charles</h4></div>
               <div class="col-lg-8">
           ...
           <div><p class="mb-lg-0">English to French Translation </p></div></div>
               <div class="col-lg-8">
                   ...
                   <div><p class="mb-lg-0">Web Development </p></div></div>
             </div>
             ...
             <div class="row">
                     ...
                     <div class="border p-3">
                       <div class="row">
                         ...
                         <div class="col-lg-6 ps-lg-5">
                           <div class="d-flex gap-2">
                           <h4 class="mb-lg-0">Virtual Rates </h4><input class="form-check-input" type="checkbox" value="" aria-label="Select Team">Multiply by No. of Providers
                       </div>
                           <div class="d-flex flex-column gap-3">
                               <div class="input-group">
                                 <span class="input-group-text gap-2 bg-secondary col-lg-5" id="">
               ...
               <div class="col-lg-12 mb-5" x-data="{ open: false }">
                 <div class="d-lg-flex align-items-center mb-4 gap-3">
                   <div class="form-check form-switch form-switch-column mb-lg-0">
                      <input class="form-check-input" type="checkbox" role="switch" id="AdditionalServiceCharges" @click="open = !open" x-text="open==true  ? 'hide' : 'show'">
               ...
               <div class="col-lg-12 mb-5" x-data="{ open: false }">
                 <div class="d-lg-flex align-items-center mb-4 gap-3">
                   <div class="form-check form-switch form-switch-column mb-lg-0">
                     <input class="form-check-input" type="checkbox" role="switch" id="ExpeditedServices" @click="open = !open" x-text="open==true  ? 'hide' : 'show'">
               ...
               <div class="col-lg-12 mb-5" x-data="{ open: false }">
                 <div class="d-lg-flex align-items-center mb-4 gap-3">
                   <div class="form-check form-switch form-switch-column mb-lg-0">
                     <input class="form-check-input" type="checkbox" role="switch" id="CancellationsModifications&Rescheduling" @click="open = !open" x-text="open==true  ? 'hide' : 'show'">
