                        ...
                        <div class="py-4">
                            <div class="mb-4">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="Print&SignDigitalSignature"
                                        id="Print&SignDigitalSignature2" checked aria-label="Requester">
                                    <label class="form-check-label" for="flexRadioDefault2">
                                        <small>
                                            Requester
                                        </small>
                ...
                <div>
                    <div class="form-check form-switch mb-0">
                        <input class="form-check-input" type="checkbox" role="switch" id="checkin" checked
                            aria-label="Check-out Permission Toggle">
                        ...
                        <div class="col-lg-12">
                            <div class="form-check mb-0">
                                ...
                                <label class="form-check-label" for="PendingServiceAddressLink">
                                    I agree that the information I have provided is complete, accurate, and truthful. I
                                    understand that I am responsible for ensuring the information I provide is correct.
                                </label>
                            </div>
                        </div>
                    </div>
