<div class="row mb-4 mt-3">
    <div class="col-md-5">
      ...
      <div class="mx-2"><input type="text" id="provider-inovice-id" class="form-control form-control-sm w-50 rounded-0" name="" placeholder=""/></div>
      </div>
      
    </div>
    <div class="col-md-4">
        <div><span class="fw-semibold"> Submission Date:</span> 22/02/2023</div>
        <div class="ms-5"><span class="fw-semibold ms-3">Due Date:</span><span class="mx-1">22/03/2023</span></div>
    </div>
    <div class="col-md-3">
