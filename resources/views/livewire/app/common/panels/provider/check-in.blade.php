      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="AssignmentNo">
          <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseAssignmentNo" aria-expanded="true" aria-controls="collapseAssignmentNo">
            Assignment No: <span class="text-sm">736764</span>
          </button>
        </h2>
        <div id="collapseAssignmentNo" class="accordion-collapse collapse show" aria-labelledby="AssignmentNo" data-bs-parent="#accordionAssignment">
          <div class="accordion-body">
            <div class="row">
              ...
              <div class="col-lg-7 py-2 text-sm">
                Alex Jones, Microsoft
              </div>
              <div class="col-lg-3 py-2 fw-semibold text-sm">
                Service:
              </div>
              <div class="col-lg-7 py-2 text-sm">
                English to British Sign Language Interpreting
              </div>
              <div class="col-lg-3 py-2 fw-semibold text-sm">
                Time & Date:
              </div>
    ...
    <div class="between-section-segment-spacing">
      <div class="d-flex justify-content-between gap-3 align-items-center mb-3">
        <div>
          ...
          <div class="text-sm">22/11/2022   02:00PM</div>
        </div>
        <div>
    ...
    <div class="mb-4">
      ...
      <div class="between-section-segment-spacing">
        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <defs>
            <linearGradient id="paint0_linear_9222_203708" x1="15" y1="0" x2="27.0359" y2="0" gradientUnits="userSpaceOnUse">
