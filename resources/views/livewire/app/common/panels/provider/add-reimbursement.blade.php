    ...
    <div class="row">
        <div class=" col-md-10 mb-4">
          ...
          <div class="form-check">
            ...
            <input class="form-check-input show-hidden-content" type="radio" name="reason-for-reimbursement" id="mileage" >
          ...
          <div class="form-check">
            ...
            <input class="form-check-input show-hidden-content" type="radio" name="reason-for-reimbursement" id="compensated-travel-time" checked>
            <div class="hidden-content col-lg-4">
              ...
              <div class="input-group">
                <input type="text" class="form-control form-control-md text-center" placeholder="00" aria-label="00" aria-describedby="">
                <input type="text" class="form-control form-control-md text-center" placeholder="00" aria-label="00" aria-describedby="">
              </div>
            </div>
          </div>
          <div class="form-check">
            ...
            <input class="form-check-input show-hidden-content" type="radio" name="reason-for-reimbursement" id="reason-for-reimbursement" >
            <div class="hidden-content">
