                ...
                <div class="col-auto ms-2">
                    <div class="d-flex flex-column flex-md-row gap-2">
                        ...
                        <button type="button"
                            ...
                            <svg aria-label="Return Assignment" width="30" height="30" viewBox="0 0 30 30"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="d-lg-flex align-items-center gap-5 mb-5">
                        ...
                        <button type="button" class="btn btn-primary rounded d-inline-flex align-items-center gap-1"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-lg-auto">
                                            <img src="/tenant-resources/images/img-placeholder-document.jpg"
                                                alt="img-placeholder-document" class="">
                                            <p class="font-family-secondary">
                                                <small>File Name</small>
                                            </p>
                                        </div>
                        ...
                        <a href="#" class="btn btn-has-icon border-2 btn-outline-primary text-primary rounded">
                            <svg aria-label="Team Chat" width="20" height="20" viewBox="0 0 20 20"
                                ...
                                <path
                                    ...
                                    fill="url(#paint0_linear_10513_5925)"></path>
                                <path
                                    d="M18 0H6C4.897 0 4 0.897 4 2H16C17.103 2 18 2.897 18 4V12C19.103 12 20 11.103 20 10V2C20 0.897 19.103 0 18 0Z"
                                    fill="url(#paint1_linear_10513_5925)"></path>
                                <defs>
                                    <linearGradient id="paint0_linear_10513_5925" x1="8" y1="4"
                                        x2="14.4192" y2="4" gradientUnits="userSpaceOnUse">
                                        <stop stop-color="#213969"></stop>
                                        <stop offset="0.994792" stop-color="#013191"></stop>
                                    </linearGradient>
                                    <linearGradient id="paint1_linear_10513_5925" x1="12" y1="0"
                                        x2="18.4192" y2="0" gradientUnits="userSpaceOnUse">
                                        <stop stop-color="#213969"></stop>
                                        <stop offset="0.994792" stop-color="#013191"></stop>
                                    </linearGradient>
                                </defs>
                                                    ...
                                                    <div class="d-flex gap-2 align-items-center">
                                                        <div>
                                                            <img width="50" height="50"
                                                                ...
                                                                class="rounded-circle" alt="Provider Image">
                                                        </div>
                                                        <div class="pt-2">
                                                ...
                                                <td class="align-middle">
                                                    <div class="d-flex actions justify-content-center">
                                                        <a href="#" title="Chat" aria-label="Chat"
                                                            class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                                            <svg aria-label="Chat" width="20" height="20"
                                                                viewBox="0 0 20 20">
                                                                <use xlink:href="/css/common-icons.svg#chat">
                                                                </use>
                                                            </svg>
                                                        </a>
                                                    </div>
