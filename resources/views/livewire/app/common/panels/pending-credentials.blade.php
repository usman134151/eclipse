  ...
  @if($document)
      ...
      @if($document['document_type']!='acknowledge_document')
          <div class="col-lg-6 mb-4">
              ...
              <input class="form-control mb-1" wire:model.defer="file" type="file" id="formFile">
            </div>
              ...
              @if($document['expiration_type']=='user_set_expiry')
                ...
                <div class="d-flex align-items-center w-100">
                  <div class="position-relative flex-grow-1">
                    <input type="text" class="form-control js-single-date" placeholder="Jan 1, 2023" aria-label="Expiry Date" aria-describedby="Expiry Date" id="expiration-date">
          ...
          <div class="col-12 justify-content-center form-actions d-flex gap-3">
              ...
              <button type="submit" class="btn btn-primary rounded" x-on:click="pendingCredentials = !pendingCredentials">
                  Upload
              </button>
          </div>
      @endif
