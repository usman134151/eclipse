              ...
              @if($document['expiration_type']=='user_set_expiry')
                ...
                <div class="d-flex align-items-center w-100">
                  <div class="position-relative flex-grow-1">
                    <input type="text" wire:model.defer="field.expiry_date" class="form-control js-single-date" name="expiry_date" aria-label="Expiry Date" aria-describedby="Expiry Date" id="expiry_date">
