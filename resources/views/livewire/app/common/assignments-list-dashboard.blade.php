<div>
        <div class="content-body">
            <div class="page-title">
                <div class="row mt-3">
                <div class="col-md-4">
                  <h1>Unassigned Assignment</h1>
                </div>
                <div class="col-md-3 ms-auto text-end">
                  <a href="javascript:void(0)" wire:click="showForm" class="btn btn-primary rounded">Create Assignment</a>
                </div>
                </div>
                <div class="row mb-4 mt-4">
                    <div class="col-lg-12">
                        <div class="d-lg-flex gap-3 align-items-center mb-3">
                            <div>
                                <button class="btn btn-primary rounded">View Provider Availability</button>
                            </div>
                            <div>
                                <button class="btn btn-primary rounded  ">View Nearby Providers</button>
                            </div>
                        </div>   
                    </div>
                </div>
                ...
                <div class="d-inline-flex align-items-center gap-4">
                  ...
                  <div>
                    <div class="form-check form-switch mb-lg-0">
                      ...
                      <label class="form-check-label" for="ManagePermissions">View & Manage Permission</label>
                    </div>
                  </div>
                </div>
                <div class="d-inline-flex align-items-center gap-4">
