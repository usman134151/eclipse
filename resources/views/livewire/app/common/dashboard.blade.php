	...
	<ul class="d-grid 2xl:grid-cols-6 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4 list-unstyled mb-5" id="myTab" role="tablist">
	  <li class="" role="presentation">
		<a class="dashborad-block active" id="calendar-tab" data-bs-toggle="tab" data-bs-target="#calendar-tab-pane" type="button" role="tab" aria-controls="calendar-tab-pane" aria-selected="true">
		  ...
		  <div class="text-center block-icon">
			<svg aria-label="Calendar" class="fill" width="57" height="57" viewBox="0 0 57 57" fill="none" xmlns="http://www.w3.org/2000/svg">
	  ...
	  <li class="" role="presentation">
		<a class="dashborad-block" id="assignments-tab" data-bs-toggle="tab" data-bs-target="#assignments-tab-pane" type="button" role="tab" aria-controls="assignments-tab-pane" aria-selected="false">
		  ...
		  <div class="text-center block-icon">
			<svg aria-label="Assignments" class="fill" width="54" height="61" viewBox="0 0 54 61" fill="none" xmlns="http://www.w3.org/2000/svg">
	  ...
	  <li class="" role="presentation">
		<a class="dashborad-block" id="map-tab" data-bs-toggle="tab" data-bs-target="#map-tab-pane" type="button" role="tab" aria-controls="map-tab-pane" aria-selected="false">
		  ...
		  <div class="text-center block-icon">
			<svg aria-label="Map" class="stroke" width="55" height="55" viewBox="0 0 60 68" fill="none" xmlns="http://www.w3.org/2000/svg">
	  ...
	  <li class="" role="presentation">
		<a class="dashborad-block" id="notifications-tab" data-bs-toggle="tab" data-bs-target="#notifications-tab-pane" type="button" role="tab" aria-controls="notifications-tab-pane" aria-selected="false">
		  ...
		  <div class="text-center block-icon">
			<svg aria-label="Notifications" class="fill" width="55" height="55" viewBox="0 0 55 55" fill="none" xmlns="http://www.w3.org/2000/svg">
	  ...
	  <li class="" role="presentation">
		<a class="dashborad-block" id="navigator-tab" data-bs-toggle="tab" data-bs-target="#navigator-tab-pane" type="button" role="tab" aria-controls="navigator-tab-pane" aria-selected="false">
		  ...
		  <div class="text-center block-icon">
			<svg aria-label="Navigator" class="stroke" width="55" height="55" viewBox="0 0 59 59" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <div class="col-lg-5 ps-lg-3 mb-5">
              ...
              <select data-placeholder="Select Service Type" multiple class="form-select chosen-select" tabindex="" id="serviceType">
                <option value=""></option>
            ...
            <div class="col-lg-5 pe-lg-3 mb-5">
              ...
              <select data-placeholder="Select Company" multiple class="form-select chosen-select" tabindex="" id="OrgDeptUser">
                <option value=""></option>
            ...
            <div class="col-lg-5 ps-lg-3 mb-5">
              ...
              <select data-placeholder="Select Provider" multiple class="form-select chosen-select" tabindex="" id="provider">
                <option value=""></option>
            ...
            <div class="col-lg-5 ps-lg-3 mb-5">
              ...
              <select data-placeholder="Select Booking Status" multiple class="form-select chosen-select" tabindex="" id="bookingStatus">
                <option value=""></option>
