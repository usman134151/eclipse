<div>
	...
	<div class="tab-content" id="myTabContent">
	  ...
	  <div class="tab-pane fade" id="assignments-tab-pane" role="tabpanel" aria-labelledby="assignments-tab" tabindex="0">
		<!-- Filters -->
		<div class="d-flex flex-lg-row flex-column justify-content-start gap-4 mb-4">
          <div class="row g-0">
            <div class="position-relative col-12 col-lg-auto px-lg-1 mb-2 mb-lg-0">
              <!-- Begin : it will be replaced with livewire module-->
              <svg class="icon-date sm cursor-pointer" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="row g-0">
            <div class="mb-2 mb-lg-0 col-lg-auto col-12 px-1">
              <button type="button" class="btn btn-xs w-100 btn-primary rounded">Today</button>
            </div>
            ...
            <div class="mb-2 mb-lg-0 col-lg-auto col-6 px-1">
              <button type="button" class="btn btn-xs w-100 btn-inactive rounded">Unassigned</button>
            </div>
            <div class="mb-2 mb-lg-0 col-lg-auto col-6 px-1">
		...
		<!-- /Filters -->
		{{-- Today's Assignments List - Start --}}
		<div>
			...
			<div class="d-flex flex-column flex-lg-row justify-content-between mb-2">
				<div class="d-inline-flex align-items-center gap-4 mb-2 mb-lg-0">
									...
									<tr role="row" class="{{ ($i % 2 == 0) ? 'even' : 'odd' }} {{ $statusCode[array_rand($status)] }}">
										...
										<td>
											<div class="d-flex actions">
												...
												<a href="#" title="" aria-label="" class="btn btn-sm btn-secondary rounded btn-hs-icon">
			...
			<div class="d-flex flex-column flex-lg-row justify-content-between">
				...
				<nav aria-label="Page Navigation">
					<ul class="pagination justify-content-start justify-content-end">
						<li class="page-item">
            ...
            <tbody>
              <tr class="odd">
                ...
                <td>
                  <div class="row">
                    <div class="col-lg-1">
                      <img src="images/portrait/small/avatar-s-1.jpg" alt="Image" class="w-100 rounded-circle">
                    </div>
