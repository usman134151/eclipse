<div x-data="{ addDocuments: false, assignProvider: false }">
    @if (@$cantRequest)
        <div class="content-body">
            <div class="card">
                <div class="card-body">
                    <h3 class="text-align-center">Sorry you do not have rights to request service, please contact your
                        company admin.</h3>
                </div>
            ...
            <div class="card">
                    ...
                    <ul class="nav nav-tabs nav-steps" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {{ $component == 'requester-info' ? 'active' : '' }}"
                                wire:click="switch('requester-info')" id="requester-info-tab" data-bs-toggle="tab"
                                data-bs-target="#requester-info" type="button" role="tab"
                                aria-controls="requester-info" aria-selected="true"><span class="number">1</span>
                                Requester Info</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {{ $component == 'request-details' ? 'active' : '' }}"
                                wire:click="switch('request-details')" id="request-details-tab" data-bs-toggle="tab"
                                data-bs-target="#request-details" type="button" role="tab"
                                aria-controls="request-details" aria-selected="false"><span class="number">2</span>
                                Request Details</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {{ $component == 'payment-info' ? 'active' : '' }}"
                                wire:click="switch('payment-info')" id="payment-info-tab" data-bs-toggle="tab"
                                data-bs-target="#payment-info" type="button" role="tab"
                                aria-controls="payment-info" aria-selected="false"><span class="number">3</span>
                                Payment Info</button>
                        </li>
                        <!-- <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content">
                        @if ($component == 'requester-info')
                                ...
                                <div>
                                    @error('slot')
                                        <div class="alert alert-danger p-2">
                                            {{ $message }} @if (!$isCustomer && is_null($schedule))
                                                <a href="/admin/business-setup">Click here to setup business slots before
                                ...
                                <div class="mb-4">
                                        ...
                                        @foreach ($frequencies as $frequency)
                                            <div class="form-check form-check-highlighted">
                                                <input class="form-check-input" type="radio"
                                                    wire:model="booking.frequency_id"
                                                    id="frequency_id-{{ $frequency['id'] }}" name="frequency_id"
                                                    value="{{ $loop->index + 1 }}">
                                                <label class="form-check-label"
                                                    for="frequency_id-{{ $frequency['id'] }}">{{ $frequency['setup_value_label'] }}</label>
                                            </div>
                                        @endforeach
                                    ...
                                    @if ($booking['frequency_id'] == '1')
                                        ...
                                        @else
                                            <div class="mt-4 w-25">
                                    @endif
                                    <label class="form-label-sm" for="set_start_date">Frequency end at <span
                                            class="mandatory">*</span></label>
                                    <input type="text" class="form-control form-control-md js-single-date"
                                        placeholder="Frequency End Date" aria-label="" aria-describedby=""
                                        wire:model.defer="booking.recurring_end_at" name="recurring_end_at"
                                        id="recurring_end_at">
                                </div>
                            ...
                            <div class="row between-section-segment-spacing">
                                ...
                                <div class="col-lg-6 mb-4 pe-lg-5">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <label class="form-label" for="requestor">Requester <span
                                                class="mandatory">*</span></label>
                                        <div class="form-check "
                                            @if (!$allowAddUser) style="display:none" @endif>
                                                ...
                                                <div class="">
                                                    <div class="form-check-inline">
                                                        <button type="button"
                                                            ...
                                                            data-bs-toggle="modal" data-bs-target="#addNewCustomer"
                                    ...
                                    <select class="form-select select2 mb-2" id="customer_id" name="customer_id"
                                        wire:model.defer="booking.customer_id"
                                        @if (!$selectRequestor) disabled @endif>
                                    ...
                                    <div class="form-check form-check-inline mt-1">
                                        <input class="form-check-input" id="hide_request_from_providers"
                                            wire:model="booking.requester_information"
                                            name="hide_request_from_providers" type="checkbox" tabindex=""
                                            value="1" />
                                        <label class="form-check-label" for="HideRequesterInfofromProviders"
                                            value="1"><small>Hide
                                ...
                                @if ($booking['requester_information'] == 1)
                                    <div class="col-lg-6 mb-4 pe-lg-5">
                                        ...
                                        <input type="" class="form-control" placeholder="Enter Name"
                                            id="point-of-contact" name="point_of_contact"
                                            wire:model.defer="booking.contact_point">
                                    </div>
                                    <div class="col-lg-6 mb-4 ps-lg-5">
                                        <label class="form-label" for="ph-number">Phone Number</label>
                                        <input type="" class="form-control" placeholder="Enter Phone Number"
                                            id="ph-number" name="phone_number" wire:model.defer="booking.poc_phone">
                                    </div>
                                @endif
                            </div>
                            <div class="row between-section-segment-spacing">
                                ...
                                <div class="d-md-flex align-items-center mb-4 gap-3 gap-md-0">
                                    <div class="form-check form-switch form-switch-column mb-lg-0">
                                        <input class="form-check-input" type="checkbox" role="switch"
                                            id="assignedSupervisor" name="assignedSupervisor"
                                            {{ $assignedSupervisor }} wire:model="assignedSupervisor"
                                            wire:click="refreshSelects()" value="checked">
                                    </div>
                                ...
                                <div class="col-lg-6 mb-4 pe-lg-5">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <label class="form-label" for="requestor">Supervisor <span
                                                class="mandatory">*</span></label>
                                        <div class="form-check "
                                            @if (!$allowAddUser) style="display:none" @endif>
                                    ...
                                    <select class="form-select select2" id="supervisor" name="supervisor"
                                        wire:model.defer='booking.supervisor'>
                                        <option value="0">Select User</option>
                                ...
                                <div class="col-lg-6 mb-4 ps-lg-5">
                                    ...
                                    <select class="form-select select2" id="billing_manager_id"
                                        name="billing_manager_id" wire:model.defer="booking.billing_manager_id">
                                        <option value="0">Select User</option>
                ...
                <div class="row between-section-segment-spacing">
                    ...
                    <div class="col-lg-12 mb-4">
                        ...
                        <div class="row">
                            <div class="col-lg-6 pe-lg-5 mb-4">
                                ...
                                <input type="text" class="form-control" placeholder="Enter Booking Title"
                                    id="booking-title" wire:model.defer="booking.booking_title">
                            </div>
                        </div>
                            ...
                            <div class="duplicate-block mb-3">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="align-items-center gap-4">
                                        @if ($index >= 1 || $isEdit)
                                            <a wire:click.prevent="removeServices({{ $index }})"
                                ...
                                <div class="row mb-5">
                                    <div class="col-lg-6 mb-4 pe-lg-5">
                                        @if ($isEdit && key_exists('id', $service))
                                            <input type="hidden" value="{{ $services[$index]['id'] }}"
                                                wire:model="services.{{ $index }}.id">
                                        @endif
                                        <label class="form-label">Accommodation <span
                                                class="mandatory">*</span></label>
                                        <select class="form-select select2 mb-2"
                                            id="accommodation_id_{{ $index }}"
                                            name="accommodation_id_{{ $index }}"
                                            wire:model="services.{{ $index }}.accommodation_id">
                                    ...
                                    <div class="col-lg-6 mb-4 ps-lg-5">
                                        <label class="form-label" for="service">Service <span
                                            ...
                                            <i class="fa fa-question-circle text-muted" aria-hidden="true"
                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                title=""></i></label>
                                        <select class="form-select select2 mb-2" id="services_{{ $index }}"
                                            name="services_{{ $index }}"
                                            wire:model="services.{{ $index }}.services">
                                                ...
                                                @foreach ($accommodations as $accommodation)
                                                    @if ($services[$index]['accommodation_id'] == $accommodation['id'])
                                                        ...
                                                        @foreach ($accommodation['services'] as $service_id)
                                                            <option value="{{ $service_id['id'] }}">
                                                                {{ $service_id['name'] }}</option>
                                                        @endforeach
                                                    @endif
                                                @endforeach
                                            @endif
                                        ...
                                        <div class="col-lg-6 mb-4 pe-lg-5">
                                            ...
                                            <div class="d-grid grid-cols-3">
                                                ...
                                                @php
                                                    ...
                                                    $foundService = $accommodationsCollection->flatMap(fn($item) => $item['services'])->firstWhere('id', $serviceIdToFind);
                                                ...
                                                @foreach ($serviceTypes as $key => $serviceType)
                                                    @if (!is_null($foundService) && in_array($key, $foundService['service_type']))
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                name="serviceType-{{ $serviceType['title'] }}-{{ $index }}"
                                                                id="serviceType-{{ $serviceType['title'] }}-{{ $index }}"
                                                                wire:model="services.{{ $index }}.service_types"
                                                                value="{{ $key }}"
                                                                wire:click="updateServiceDefaults({{ $index }},{{ $key }})">
                                                            <label class="form-check-label"
                                                                for="serviceType-{{ $serviceType['title'] }}-{{ $index }}">
                                                                {{ $serviceType['title'] }}
                                                            </label>
                                                        </div>
                                                    @endif
                                                ...
                                                @if (!is_null($foundService))
                                                    @foreach ($foundService['specializations'] as $specialization)
                                                        <div class="form-check"><input class="form-check-input"
                                                                type="checkbox"
                                                                id="service_specializations-{{ $index }}-{{ $specialization['id'] }}"
                                                                name="service_specializations"
                                                                value="{{ $specialization['id'] }}" tabindex="1"
                                                                wire:model.defer="services.{{ $index }}.specialization"><label
                                                                class="form-check-label"
                                                                for="service_specializations-{{ $index }}-{{ $specialization['id'] }}">{{ $specialization['name'] }}</label>
                                                        </div>
                                                    @endforeach
                                                @endif
                                            </div>
                                    ...
                                    <div class="col-lg-6 mb-4 pe-lg-5">
                                        ...
                                        <input type="" class="form-control"
                                            ...
                                            wire:model.defer="services.{{ $index }}.provider_count">
                                    ...
                                    <div
                                        class="col-lg-6 mb-4 ps-lg-5 @if ($isCustomer) hidden @endif">
                                        <div class="row mt-5">
                                                ...
                                                <div class="d-flex gap-3 ">
                                                    ...
                                                    <div class="form-check form-switch form-switch-column ">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            aria-label="Auto-notify Broadcast" value="1"
                                                            wire:model.defer="services.{{ $index }}.auto_notify">
                                                        <label class="form-check-label"
                                                ...
                                                <div class="d-flex gap-3">
                                                    ...
                                                    <div class="form-check form-switch form-switch-column">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            wire:model.defer="services.{{ $index }}.auto_assign">
                                                        <label class="form-check-label"
                                                        ...
                                                        <div class="js-wrapper-manual-entry">
                                                            ...
                                                            @if ($services[$index]['is_manual_consumer'])
                                                                <div class="hidden">
                                                                    <select id="service_consumer_{{ $index }}"
                                                                        ...
                                                                        wire:model="services.{{ $index }}.service_consumer"
                                                                        multiple>
                                                            ...
                                                            <div class="form-check mt-2">
                                                                ...
                                                                <input
                                                                    ...
                                                                    wire:key="manual-{{ $index }}"
                                                                    wire:model="services.{{ $index }}.is_manual_consumer">
                                                                <label class="form-check-label"
                                                        ...
                                                        <div class="js-wrapper-manual-entry">
                                                            @if ($services[$index]['is_manual_attendees'])
                                                                <div class="hidden">
                                                                    <select
                                                                        class="form-select select2 select2-container js-form-select-manual-entry"
                                                                        multiple id="attendees_{{ $index }}"
                                                                        name="attendees_{{ $index }}"
                                                                        aria-label="Select Participant(s)"
                                                                        wire:model.defer="services.{{ $index }}.attendees">
                                                                ...
                                                                <input type="" name=""
                                                                    ...
                                                                    wire:model.defer="services.{{ $index }}.attendees_manual">
                                                            @else
                                                                <select
                                                                    class="form-select select2 select2-container js-form-select-manual-entry"
                                                                    multiple id="attendees_{{ $index }}"
                                                            ...
                                                            <div class="form-check mt-2">
                                                                <input
                                                                    ...
                                                                    type="checkbox" tabindex=""
                                                                    wire:key="manual-{{ $index }}"
                                                                    wire:model="services.{{ $index }}.is_manual_attendees">
                                                                <label class="form-check-label"
                                        ...
                                        @if ($services[$index]['service_types'] > 1)
                                            ...
                                            @foreach ($services[$index]['meetings'] as $meetingIndex => $meeting)
                                                <div class="border-dashed rounded p-3 mb-3">
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <div class="align-items-center gap-4">
                                                            <h3 class="text-primary">Meeting Link
                                                                {{ $loop->index + 1 }}</h3>
                                                        </div>
                                                        <div class="align-items-center gap-4">
                                                            <a wire:click.prevent="removeMeeting({{ $meetingIndex }},{{ $index }})"
                                                                href="#" title="Delete" aria-label="Delete"
                                                                class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                                                <svg class="delete-icon" width="20"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <input type="" class="form-control"
                                                                ...
                                                                wire:key="name-{{ $index }}-{{ $meetingIndex }}"
                                                                wire:model.lazy="services.{{ $index }}.meetings.{{ $meetingIndex }}.meeting_name">
                                                        </div>
                                                        <div class="col-lg-4 mb-3">
                                                            <label class="form-label" for="phone-number">Phone Number
                                                                / Meeting Link</label>
                                                            <input type="" class="form-control"
                                                                placeholder="Enter Phone Number" id="phone-number"
                                                                wire:key="phone-{{ $index }}-{{ $meetingIndex }}"
                                                                wire:model.lazy="services.{{ $index }}.meetings.{{ $meetingIndex }}.phone_number">
                                                        </div>
                                                        <div class="col-lg-4 mb-3">
                                                            <label class="form-label" for="access-code">Access
                                                                Code</label>
                                                            <input type="" class="form-control"
                                                                placeholder="Enter Access Code" id="access-code"
                                                                wire:key="access-{{ $index }}-{{ $meetingIndex }}"
                                                                wire:model.lazy="services.{{ $index }}.meetings.{{ $meetingIndex }}.access_code">
                                                        </div>
                                                    </div>
                                                </div>
                                            @endforeach
                                            ...
                                            <div class="row justify-content-end">
                                                <div class="col-md-6 col-lg-3">
                                                    <a href="#"
                                                        wire:click.prevent="addMeeting({{ $index }})"
                        ...
                        <div class="row justify-content-end">
                            <div class="col-md-6 col-lg-3">
                                <a wire:click.prevent="addService" href="#"
                                    class=" float-end btn btn-secondary btn-custom rounded btn-has-icon w-55">
                            ...
                            <div class="duplicate-block mb-4">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="align-items-center gap-2">
                                        @if ($index >= 1 || ($isEdit && $booking->type == 2))
                                            <a wire:click.prevent="removeDate({{ $index }})" href="#"
                                ...
                                <div class="d-md-flex gap-1 justify-content-between flex-md-wrap flex-lg-nowrap">
                                    ...
                                    <div class="col-lg-3 col-md-6 pe-md-2 pe-lg-0 mb-4">
                                        <label class="form-label-sm" for="set_time_zone">Set Time Zone <span
                                                class="mandatory">*</span></label>
                                        <select {{ $this->isEdit && $this->booking->type == 1 ? 'disabled' : '' }}
                                            class="form-select select2 mb-2 "
                                            wire:model.defer='dates.{{ $index }}.time_zone'
                                            id="timezone_{{ $index }}" name="timezone_{{ $index }}">
                                    ...
                                    <div class="col-lg-auto col-md-6 ps-md-2 ps-lg-0 mb-4">
                                        <label class="form-label-sm" for="start_date_{{ $index }}">Start Date
                                            <span class="mandatory">*</span></label>
                                        <div class="position-relative">
                                            <input type="" name=""
                                                {{ $this->isEdit && $this->booking->type == 1 ? 'disabled' : '' }}
                                                class="form-control js-single-date" placeholder="MM/DD/YYYY"
                                                id="start_date_{{ $index }}"
                                                value="{{ $dates[0]['start_date'] }}" aria-label="Set Start Date"
                                                wire:model="dates.{{ $index }}.start_date"
                                                style="width:200px">

                                            <svg aria-label="Date" class="icon-date lg pb-1" width="20"
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="d-md-flex d-lg-inline">
                                                <div class="time d-flex align-items-center gap-1"
                                                    ...
                                                    <select
                                                        {{ $this->isEdit && $this->booking->type == 1 ? 'disabled' : '' }}
                                                        class="form-select form-select-sm custom-padding"
                                                        wire:model.defer="dates.{{ $index }}.start_hour"
                                                        wire:change="updateDurations({{ $index }})">
                                                        @for ($i = 0; $i < 24; $i++)
                                                    ...
                                                    <select
                                                        {{ $this->isEdit && $this->booking->type == 1 ? 'disabled' : '' }}
                                                        class="form-select form-select-sm custom-padding"
                                                        wire:model.defer="dates.{{ $index }}.start_min"
                                                        wire:change="updateDurations({{ $index }})">
                                                        @for ($i = 0; $i <= 59; $i++)
                                                            <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}">
                                                                {{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                                    ...
                                    <div class="col-lg-auto mb-4">
                                        <label class="form-label-sm" for="end_date_{{ $index }}">End
                                            Date<span class="mandatory">*</span></label>
                                        <div class="position-relative">
                                            <input type="" name=""
                                                {{ $this->isEdit && $this->booking->type == 1 ? 'disabled' : '' }}
                                                class="form-control js-single-date" placeholder="MM/DD/YYYY"
                                                id="end_date_{{ $index }}" aria-label="Set End Date"
                                                wire:key="endtime-{{ $index }}"
                                                wire:model="dates.{{ $index }}.end_date" style="width:200px">
                                            ...
                                            <div class="d-flex">
                                                <div class="time d-flex align-items-center gap-1">
                                                    <select
                                                        {{ $this->isEdit && $this->booking->type == 1 ? 'disabled' : '' }}
                                                        class="form-select form-select-sm custom-padding"
                                                        wire:model.defer="dates.{{ $index }}.end_hour"
                                                        wire:change="updateDurations({{ $index }})">
                                                        @for ($i = 0; $i < 24; $i++)
                                                            <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}">
                                                                {{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                                                    ...
                                                    <select
                                                        {{ $this->isEdit && $this->booking->type == 1 ? 'disabled' : '' }}
                                                        class="form-select form-select-sm custom-padding"
                                                        wire:model.defer="dates.{{ $index }}.end_min"
                                                        wire:change="updateDurations({{ $index }})">
                                                        @for ($i = 0; $i <= 59; $i++)
                                                            <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}">
                                                                {{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                                ...
                                <div class="d-md-flex align-items-end mb-4 gap-4">
                                    ...
                                    <input type="" class="form-control form-control-md text-center"
                                        ...
                                        {{ $this->isEdit && $this->booking->type == 1 ? 'disabled' : '' }}
                                        id="dates.{{ $index }}.duration_day"
                                        wire:key="total-{{ $index }}"
                                        wire:model="dates.{{ $index }}.duration_day" style="width:100px">
                                </div>
                                <div>
                                    <label class="form-label-sm">Hours</label>
                                    <input type=""
                                        {{ $this->isEdit && $this->booking->type == 1 ? 'disabled' : '' }}
                                        class="form-control form-control-sm text-center" aria-label="Hours"
                                        placeholder="00" id="dates.{{ $index }}.duration_hour"
                                        wire:key="total-{{ $index }}"
                                        wire:model="dates.{{ $index }}.duration_hour" style="width:100px">
                                </div>
                                <div>
                                    ...
                                    <input type="" class="form-control form-control-sm text-center"
                                        ...
                                        {{ $this->isEdit && $this->booking->type == 1 ? 'disabled' : '' }}
                                        id="dates.{{ $index }}.duration_minute"
                                        wire:key="total-{{ $index }}"
                                        wire:model="dates.{{ $index }}.duration_minute" style="width:100px">
                                </div>
                            </div>
                    </div>
    @endforeach
...
<div class="row between-section-segment-spacing">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            <a href="#" class="btn btn-primary rounded w-100 btn-has-icon">
                                ...
                                <svg aria-label="Add Manually" width="24" height="19" viewBox="0 0 24 19"
                                    fill="none">
                                    <use xlink:href="/css/common-icons.svg#check-add">
                                    </use>
                                </svg>
                        ...
                        <div class="col-md-6 mb-4">
                            <a href="#" class="btn btn-primary rounded w-100" data-bs-toggle="modal"
                                data-bs-target="#RequestfromUserModal" disabled>
                                Request from User
                            </a> (Coming Soon)
                        </div>
                    </div>
    ...
    <div class="justify-content-center form-actions d-flex flex-column flex-md-row gap-2">
        ...
        <button type="button" class="btn btn-primary rounded" wire:click="save(1,1)"
        ...
        <button type="button" class="btn btn-primary rounded" wire:click="save(0,1)"
            x-on:click=" window.scrollTo({ top: 0, behavior: 'smooth' });">Proceed to Request Details</button>
    </div>
</div>
...
<div class="tab-pane fade {{ $component == 'request-details' ? 'active show' : '' }}" id="request-details"
    role="tabpanel" aria-labelledby="request-details-tab" tabindex="0">
    @if (!is_null($formIds))
...
<div class="tab-pane fade {{ $component == 'payment-info' ? 'active show' : '' }}" id="payment-info"
        ...
        @foreach ($services as $index => $service)
            <div class="row border-bottom pb-4 mt-3">
                ...
                <div class="col-lg-6 pe-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 align-self-center">
                            <div class="font-family-tertiary">
                                @if ($service['service_data']['rate_status'] == 2)
                                    {{ $service['total_duration']['days'] }} day(s)
                                @endif {{ $service['total_duration']['hours'] }} hours
                                {{ $service['total_duration']['mins'] }} minutes
                            </div>
                        </div>
                    </div>
                    @if ($service['service_data']['rate_status'] == 4)
                        <div class="mt-3">
                            <h3 style="color:#023DB0">Fixed Rate </h3>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-8 align-self-center">
                                <div class="font-family-tertiary">{{ formatPayment($service['service_charges']) }}
                                </div>
                            </div>
                        </div>
                    @elseif($service['service_data']['rate_status'] == 2)
                        <div class="mt-3">
                            <h3 style="color:#023DB0">Day Rate </h3>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                    ...
                    @else
                        <div class="mt-3">
                            <h3 style="color:#023DB0">Standard Hourly Rate </h3>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-8 align-self-center">
                                <div class="font-family-tertiary">
                                    {{ formatPayment($service['business_hour_charges']) }} for
                                    {{ $service['business_hours'] }} hours {{ $service['business_minutes'] }}
                                    minutes</div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-8 align-self-center">
                                <div class="font-family-tertiary">
                                    {{ formatPayment($service['after_business_hour_charges']) }} for
                                    {{ $service['after_business_hours'] }} hours
                                    {{ $service['after_business_minutes'] }} minutes</div>
                            </div>
                        </div>
                        <div class="row border-top">
                            ...
                            <div class="col-lg-8 align-self-center">
                                <div class="font-family-tertiary">
                                    {{ formatPayment($service['business_hour_charges'] + $service['after_business_hour_charges']) }}
                                </div>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="mt-3">
                        <h3 style="color:#023DB0">Additional Charges </h3>
                    </div>
                    ...
                    <div class="row border-top">
                        ...
                        <div class="col-lg-8 align-self-center">
                            <div class="font-family-tertiary">
                                {{ formatPayment($service['additional_charges_total']) }}</div>
                        </div>
                    </div>
                    @if (!$isCustomer)
                        <div class="mt-3">
                            <h3 style="color:#023DB0">Additional Payment </h3>
                        </div>
                        ...
                        <div class="row border-top">
                            ...
                            <div class="col-lg-8 align-self-center">
                                <div class="font-family-tertiary">
                                    {{ formatPayment($service['service_payment_total']) }}</div>
                            </div>
                        </div>
                    @endif
                ...
                <div class="col-lg-6">
                    <div class="mt-3">
                        <h3 style="color:#023DB0">Specializations </h3>
                    </div>
                    ...
                    <div class="row border-top">
                        ...
                        <div class="col-lg-8 align-self-center">
                            <div class="font-family-tertiary">{{ formatPayment($service['specialization_total']) }}
                            </div>
                        </div>
                    </div>
                    @if (count($service['expedited_charges']) && $service['expedited_charges']['charges'] > 0)
                        <div class="mt-3">
                            <h3 style="color:#023DB0">Expedited Services Charges </h3>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                                <label class="col-form-label">{{ $service['expedited_charges']['hour'] }}
                                    Hour:</label>
                            </div>
                            <div class="col-lg-8 align-self-center">
                                <div class="font-family-tertiary">
                                    {{ formatPayment($service['expedited_charges']['charges']) }}</div>
                            </div>
                        </div>
                    @endif
                    <div class="mt-5 ps-3 border border-dark rounded bg-lighter mt-1">
                        <div class="mt-3">
                            <h3 style="color:#023DB0">Total Service Charges </h3>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-8 align-self-center">
                                <div class="font-family-tertiary">{{ formatPayment($service['total_charges']) }}
                                </div>
                            </div>
                        </div>
                        <div class="row mb-5" @if ($isCustomer) style="visibility:hidden" @endif>
                            <label class="form-label mb-lg-0 col-lg-4 align-self-center"
                                for="enter-override-amount">Override</label>
                            <div class="col-md-3 mb-3 mb-md-0">
                                <input type="" name="" class="form-control form-control-md text-center"
                                    placeholder="$00.00" id="enter-override-amount"
                                    wire:model="services.{{ $index }}.billed_total">
                            </div>
                            <div class="col-md-3 align-self-center">
                                <a href="#" class="btn btn-primary btn-sm rounded w-100"
                                    wire:click="updateTotals">Apply</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="row ">
        ...
        <div class="col-lg-7 pe-5">
            ...
            <div class="mt-2" @if ($isCustomer) style="display:none" @endif>
                ...
                <div class="d-flex gap-3 flex-column flex-md-row mb-4">
                    ...
                    <div class="form-check mb-0">
                        <input class="form-check-input" id="$Amount" name="discounts" type="radio"
                            tabindex="" wire:model="payment.coupon_type" value="2"
                            wire:click="updateTotals">
                        <label class="form-check-label" for="$Amount">$ Amount</label>
                    </div>
                    <div class="form-check mb-0">
                        <input class="form-check-input" id="%Amount" name="discounts" type="radio"
                            tabindex="" wire:model="payment.coupon_type" value="3"
                            wire:click="updateTotals">
                        <label class="form-check-label" for="%Amount">% Amount</label>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <label class="form-label mb-md-0 col-lg-3 col-md-3 align-self-center" for="coupon-code">Enter
                        Value</label>
                    <div class="col-lg-4 col-md-3 mb-3 mb-md-0">
                        <input type="" name="" class="form-control form-control-md"
                            placeholder="Enter Value" id="coupon-code"
                            wire:model.defer="payment.coupon_discount_amount">
                    </div>
                    <div class="col-md-3 align-self-center">
                        <a href="#" class="btn btn-primary btn-sm rounded w-100"
                            wire:click="updateTotals">Apply</a>
            ...
            <div class="mt-5" @if ($isCustomer) style="display:none" @endif>
                ...
                <div class="input-group">
                    <input type="" name="" class="form-control form-control-md"
                        ...
                        wire:model.defer="payment.additional_label">
                    <input type="" name="" class="form-control form-control-md text-center"
                        placeholder="$00.00" aria-label="Additional Customer Charges in dollars"
                        wire:model.defer="payment.additional_charge" wire:blur="updateTotals">
                </div>
            ...
            <div class="mt-5" @if ($isCustomer) style="display:none" @endif>
                ...
                <div class="input-group mb-2">
                    <input type="" name="" class="form-control form-control-md"
                        placeholder="Enter Charge Label" aria-label="Enter Charge Label"
                        wire:model.defer="payment.additional_label_provider">
                    <input type="" name="" class="form-control form-control-md text-center"
                        placeholder="$00.00" aria-label="Additional Provider Payment"
                        wire:model.defer="payment.additional_charge_provider" wire:blur="updateTotals">
                </div>
                ...
                <div class="col-lg-12">
                    <div class="row mt-2" @if ($isCustomer) style="display:none" @endif>
                        <div class="col-lg-12">
                            <div class="d-flex gap-3 p-2">
                                ...
                                <div class="align-self-center text-black">{{ formatPayment($discountedAmount) }}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-2" @if ($isCustomer) style="display:none" @endif>
                        <div class="col-lg-12 ">
                            <div class="row p-2">
                                <label class="form-label mb-lg-0 col-lg-4 align-self-center"
                                    for="enter-override-amount"> Override
                                    Amount:</label>
                                <div class="col-md-3 mb-3 mb-md-0">
                                    <input type="" name=""
                                        class="form-control form-control-md text-center" placeholder="$00.00"
                                        id="enter-override-amount" wire:model.defer="payment.override_amount">
                                </div>
                                <div class="col-md-3 align-self-center">
                                    <a href="#" class="btn btn-primary btn-sm rounded w-100"
                                        wire:click="updateTotals">Apply</a>
                        ...
                        <div class="mb-4">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" id="PayLater" name="PaymentPreference"
                                    type="radio" tabindex="" wire.model.defer="payment.payment_method"
                                    value="2" checked />
        ...
        <div class="col-lg-5 mt-2 ps-3 border border-dark rounded bg-lighter mt-1"
            @if ($isCustomer) style="height:300px" @endif>
            <h2 class="mt-3">Booking Notes </h2>
            <!-- Billing Notes -->
            <div class="mb-lg-5 mb-4 col-lg-12 col-md-6 pe-md-3 pe-lg-2"
                @if ($isCustomer) style="display:none" @endif>
                <label class="form-label" for="billing-notes">
                    Billing Notes
                </label>
                <textarea class="form-control" rows="3" cols="5" id="billing-notes"
            ...
            <div class="mb-lg-5 mb-4 col-lg-12 col-md-6 ps-md-3 ps-lg-0"
                ...
                <textarea class="form-control" rows="3" cols="3" id="payment-notes"
            ...
            <div class="my-lg-5" @if ($isCustomer) style="display:none" @endif>
                ...
                <textarea class="form-control" rows="3" cols="4" id="provider_notes"
                    wire:model.defer="booking.provider_notes"></textarea>
            </div>
            <div class="my-lg-5">
                <label class="form-label" for="customer-notes">
                    Customer Notes
                </label>
                <textarea class="form-control" rows="3" cols="4" id="customer-notes"
                    wire:model.defer="booking.customer_notes"></textarea>
            </div>
            <div class="my-lg-5" @if ($isCustomer) style="display:none" @endif>
                <label class="form-label" for="private-notes">
                    Private Notes
                </label>
                <textarea class="form-control" rows="3" cols="4" id="private-notes"
                    wire:model.defer="booking.private_notes"></textarea>
            </div>
            <div class="my-lg-5" @if ($isCustomer) style="display:none" @endif>
                <div class="mb-3">
                    ...
                    <select multiple class="form-select  select2 form-select select2-hidden-accessible"
                ...
                <div @if ($isCustomer) style="display:none" @endif>
                    ...
                    <div class="form-check form-check-inline">
                        <input wire:model="Requester" wire:change="updateBookingTags" class="form-check-input"
                            id="Requester" name="" type="checkbox" tabindex="" />
                        <label class="form-check-label" for="Requester">Requester</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input wire:model="Consumer" wire:change="updateBookingTags" class="form-check-input"
                            id="ServiceConsumers" name="" type="checkbox" tabindex="" />
                        <label class="form-check-label" for="ServiceConsumers">Service
                            Consumer(s)</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input wire:model="Participant" wire:change="updateBookingTags" class="form-check-input"
                            id="Participants" name="" type="checkbox" tabindex="" />
    ...
    <div class="col-12 justify-content-center form-actions d-flex flex-column flex-md-row gap-2">
        ...
        <button type="button" class="btn btn-primary rounded" wire:click.prevent="save(1,1,3)"
            x-on:click=" window.scrollTo({ top: 0, behavior: 'smooth' });">
            @if ($isEdit)
                Save Changes
            @else
        ...
        @if (!$isCustomer)
            <div class="dropdown">
                <button type="" class="btn btn-primary rounded dropdown-toggle w-100 h-100" type="button"
                    data-bs-toggle="dropdown" aria-expanded="false">Confirm Booking</button>
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="#" wire:click.prevent="save(1,1,3)">Confirm Only</a>
                    </li>
                    <li><a class="dropdown-item" href="#"
                            wire:click.prevent="$emit('openAssignProvidersPanel',2)"
                            @click="assignProvider = true">Confirm + Invite</a></li>
                    <li><a class="dropdown-item" href="#"
                            wire:click.prevent="$emit('openAssignProvidersPanel')"
...
@else
    <button type="button" class="btn btn-primary rounded" wire:click.prevent="save(1,1,3)">Confirm
        Booking</button>
    @endif
...
<div class="tab-pane fade {{ $component == 'booking-summary' ? 'active show' : '' }}" id="booking-summary"
    role="tabpanel" aria-labelledby="booking-summary-tab" tabindex="0">
    ...
    <div class="mb-5">
                                ...
                                <th class="align-middle">
                                    <div class="form-check">
                                        <input class="form-check-input" id="" name=""
                                            type="checkbox" tabindex=""
                                            aria-label="Select All Admin Staff Team" />
                                    </div>
                                </th>
                                <th class="align-middle">
                                    ADMIN-STAFF TEAM
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <div class="form-check form-switch">
                                        ...
                                        <input class="form-check-input" type="checkbox" role="switch"
                                            id="Visible" aria-label="Permission Toggle">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="align-middle">
                                    <div class="form-check form-switch">
                                        ...
                                        <input checked class="form-check-input" type="checkbox" role="switch"
                                            id="Manage" aria-label="Permission Toggle">
                                    </div>
                                </td>
                            </tr>
                        </tbody>
        ...
        <div class="d-grid lg:grid-cols-3 sm:grid-cols-2 gap-2 my-5 col-lg-10">
            ...
            <div class="form-check">
                <input class="form-check-input" id="ExcludeProviderNotifications" name="" type="checkbox"
                    tabindex="">
                <label class="form-check-label form-check-label-sm fw-semibold"
            ...
            <div class="form-check">
                <input class="form-check-input" id="ExcludeAdminNotifications" name="" type="checkbox"
                    tabindex="">
                <label class="form-check-label form-check-label-sm fw-semibold"
        ...
        <div class="col-12 justify-content-center form-actions d-flex flex-column flex-md-row gap-2">
            <button type="button" class="btn btn-outline-dark rounded"
                x-on:click=" window.scrollTo({ top: 0, behavior: 'smooth' });$wire.switch('payment-info')">Back</button>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="mb-4">
                            <div class="mb-2">
                                ...
                                <div>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input js-form-check-input-notify-later"
                                            type="checkbox" id="WhenShouldTheyFirstBeNotifiedLater"
                                            value="optionLater">
                            ...
                            <div>
                                <div class="form-check form-switch">
                                    ...
                                    <label class="form-check-label" for="RepeatNotification">Repeat
                                        Notification</label>
                                    <label class="form-check-label" for="RepeatNotification">Repeat
                                        Notification</label>
                                </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio"
                                        name="HowOftenShouldTheyBeNotified" id="Time" value="option1">
                                    <label class="form-check-label" for="Time">Time(s)</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio"
                                        name="HowOftenShouldTheyBeNotified" id="EveryDays" value="option2">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                setTimeout(() => {
                    ...
                    Livewire.emit('setBookingDepartments', @json($selectedDepartments),
                        {{ $booking->company_id }});
