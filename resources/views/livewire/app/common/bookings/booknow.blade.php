              ...
              <div class="col-lg-12">
                ...
                <div class="mb-4">
                  <div class="mb-2">
                    ...
                    <div>
                      ...
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="WhenShouldTheyFirstBeNotifiedLater" value="optionLater">
                  ...
                  <div class="mb-2">
                    ...
                    <div class="d-flex align-items-center">
                      <input type="" name="" class="form-control form-control-md text-center w-auto" value="2">
                      <div class="ms-3">Day(s)</div>
                    </div>
                    <div class="text-sm mt-1">before the service start-time</div>
                  </div>
                  <div>
                    <div class="form-check form-switch">
                ...
                <div class="mb-4">
                  ...
                  <div>
                    ...
                    <div class="mt-2">
                      <input type="" name="" class="form-control form-control-md text-center w-auto" value="10">
                    </div>
                  </div>
                </div>
                <div class="col-lg-6">
