                                    ...
                                    <div class="d-flex actions">
                                      ...
                                      <div class="dropdown ac-cstm">
                                        ...
                                        <div class="tablediv dropdown-menu fadeIn">
                                          ...
                                          <a title="Invite Providers" aria-label="Invite Providers" class="dropdown-item" href="javascript:void(0)"><i class="fa fa-envelope-o"></i>Invite Providers</a>
                                          <a title="View Response" aria-label="View Response" class="dropdown-item" href="javascript:void(0)"><i class="fa fa-envelope-open-o"></i>View Response</a>
                                          <a title="View Available Providers" aria-label="View Available Providers" class="dropdown-item"><i class="fa fa-thumbs-up"></i>View Available Providers</a>
                                          <a title="Manual/Auto Assign" aria-label="Manual/Auto Assign" class="dropdown-item" href="javascript:void(0)"><i class="fa fa-user"></i>Auto Assign</a>
                                          <a title="Manual Notify" aria-label="Manual/Auto Notify" class="dropdown-item" href="javascript:void(0)"><i class="fa fa-bell" ></i>Manual Notify</a>
