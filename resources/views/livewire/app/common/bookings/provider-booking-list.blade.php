                                                    ...
                                                    <div class="d-flex actions">
                                                        @if ($booking['status'] == 'On Time' && $bookingType != 'Unassigned' && $bookingType != 'Invitations')
                                                            <a href="javascript:void(0)" title="Running Late"
                                                                ...
                                                                <svg aria-label="Running Late" width="23"
                                                                    ...
                                                                    <use xlink:href="/css/provider.svg#running-late">
                                                                    </use>
                                                                </svg>
                                                            </a>

                                                            <a href="javascript:void(0)"
                                                                @click="offcanvasOpenCheckIn = true" title="Check In"
                                                                aria-label="Check In"
                                                                class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                                                <svg aria-label="Check In" width="22" height="22"
                                                                    viewBox="0 0 22 22" fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <use xlink:href="/css/provider.svg#check-in"></use>
                                                                </svg>
                                                            </a>
                                                        @elseif($booking['status'] == 'Active' && $bookingType != 'Unassigned' && $bookingType != 'Invitations')
                                                            <a href="#" @click="offcanvasOpenCheckOut = true"
                                                                ...
                                                                <svg aria-label="Check Out" width="23"
                                                                    ...
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <use xlink:href="/css/provider.svg#check-out"></use>
                                                                </svg>
                                                        ...
                                                        @elseif($bookingType == 'Unassigned')
                                                            <a href="#" title="Submit Availability"
                                                                ...
                                                                <svg aria-label="Submit Availability" width="18"
                                                                    height="20" viewBox="0 0 18 20" fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <use xlink:href="/css/provider.svg#calendar"></use>
                                                                </svg>
                                                            </a>
                                                        @elseif($bookingType == 'Invitations')
                                                            <a href="#" title="Confirm Invitation"
                                                                ...
                                                                <svg aria-label="Confirm Invitation" width="19"
                                                        ...
                                                        <div class="dropdown ac-cstm">
                                                            <a aria-label="Action Dropdown" href="javascript:void(0)"
                                                                class="btn btn-sm btn-secondary rounded btn-hs-icon dropdown-toggle"
                                                                data-bs-toggle="dropdown" data-bs-auto-close="outside"
                                                                data-bs-popper-config="{&quot;strategy&quot;:&quot;fixed&quot;}">
                                                                <svg aria-label="Action Dropdown" width="20"
