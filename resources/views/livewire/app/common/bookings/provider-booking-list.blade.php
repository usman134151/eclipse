                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($booking_assignments as $i => $booking)
                                                    <tr role="row"
                                                        ...
                                                        <td @click="assignmentDetails = true" wire:click="setAssignmentDetails({{$booking['id']}},{{$booking['booking_number']}})">
                                                            <a
                            ...
                            <div class="d-flex actions gap-3 justify-content-end mb-3">
                                <div class="d-flex gap-2 align-items-center">
                                    <a href="#" title="View" aria-label="View"
                                        class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                        <svg aria-label="In-Person" width="16" height="20"
                                ...
                                <div class="d-flex gap-2 align-items-center">
                                    <a href="#" title="Objection" aria-label="Objection"
                                        class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                        <svg aria-label="Check-Out" width="23" height="21"
                                ...
                                <div class="d-flex gap-2 align-items-center">
                                    <a href="#" title="Running Late" aria-label="Running Late"
                                        class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                        <svg aria-label="Running Late" width="23" height="22"
                                ...
                                <div class="d-flex gap-2 align-items-center">
                                    <a href="#" title="Objection" aria-label="Objection"
                                        class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                        <svg aria-label="View Assignment" aria-label="" width="20"
