                        ...
                        <div class="row" id="table-hover-row">
                                                ...
                                                @foreach ($booking_assignments as $i => $booking) <tr role="row"
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-1">
                                                            {{-- Updated by Shanila to Add svg icon--}}
                                                            <svg aria-label="Unassigned" class="fill-warning" width="12"
                                                        ...
                                                        <div class="d-flex actions">
                                                            ...
                                                            <a href="#" title="Assign Provider"
                                                                ...
                                                                <svg aria-label="Assign Provider" width="20" height="20"
                                                                    ...
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <use xlink:href="/css/sprite.svg#assign-provider">
                                                                    </use>
                                                                </svg>
                                                            </a>
                                                            @endif
                            ...
                            <div class="d-flex actions gap-3 justify-content-md-end mb-2">
                                <div class="d-flex gap-2 align-items-center">
                                    <a href="#" title="Edit" aria-label="Edit Booking"
                                        class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                        <svg aria-label="Assign Provider" class="fill" width="20" height="28"
                                ...
                                <div class="d-flex gap-2 align-items-center">
                                    <a href="#" title="Assign Provider" aria-label="Assign Provider"
                                        class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                        <svg aria-label="Assign Provider" width="20" height="20" viewBox="0 0 20 20"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
