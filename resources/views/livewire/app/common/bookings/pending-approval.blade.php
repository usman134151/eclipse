                                    ...
                                    <div class="d-flex actions">
                                      ...
                                      <div class="dropdown ac-cstm">
                                        ...
                                        <div class="tablediv dropdown-menu fadeIn">
                                          <a href="javascript:void(0)" aria-label="Accept" title="Accept" class="dropdown-item"><i class="fa fa-check-circle"></i>Accept</a>
                                          <a href="javascript:void(0)" aria-label="Decline" title="Decline" class="dropdown-item"><i class="fa fa-times-circle"></i>Decline</a>
                                        </div>
                                      </div>
                                    </div>
                                  </td>
                                  ...
                                  <td>
                                    <div class="d-flex actions">
                                      ...
                                      <div class="dropdown ac-cstm">
                                        ...
                                        <div class="tablediv dropdown-menu fadeIn">
                                          <a href="javascript:void(0)" aria-label="view" title="view" class="dropdown-item"><i class="fa fa-eye"></i>View</a>
                                        </div>
                                      </div>
                                    </div>
                                  </td>
