<div x-data="{ pendingCredentials: false, defaultAvailability: false, specificDateAvailability: false, timeOffSlots: false }">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="invoices-remittances-tab" data-bs-toggle="tab"
                                            data-bs-target="#invoices-remittances-tab-pane" type="button"
                                            role="tab" aria-controls="invoices-remittances-tab-pane"
                                            aria-selected="false">
                                            <svg aria-label="Invoices & Remittances" width="29" height="31"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="payments-preferences-tab" data-bs-toggle="tab"
                                            data-bs-target="#payments-preferences-tab-pane" type="button"
                                            role="tab" aria-controls="payments-preferences-tab-pane"
                                            aria-selected="false">
                                            <svg aria-label="Payments & Preferences" width="27" height="31"
                                                viewBox="0 0 29 31" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="log-tab" data-bs-toggle="tab"
                                            ...
                                            <svg aria-label="Log" width="27" height="27" viewBox="0 0 27 27"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="row mb-4">
        <div class="col-md-12 mt-4">
            <div class="">
                <a href="{{ route('tenant.provider-edit', ['providerID' => $userid]) }}" title="Edit" aria-label="Edit"
            ...
            <div class="row mb-1 mx-2">
                <div class="col-md-12 d-flex">
                    <div class="col-md-4 "><label class="col-form-label" for="first-address">Address line 1:</label>
                    </div>
                    <div class="col-md-12 align-self-center">
                        <div class="font-family-secondary">
                            {{ $user['userdetail']['address_line1'] ? $user['userdetail']['address_line1'] : 'N/A' }}</div>
                    </div>
                </div>
            </div>
            <div class="row mb-1 mx-2">
                <div class="col-md-12 d-flex">
                    <div class="col-md-4 "><label class="col-form-label" for="second-address">Address line 2:</label>
                    </div>
                    <div class="col-md-12 align-self-center">
                        <div class="font-family-secondary">
                            {{ $user['userdetail']['address_line2'] ? $user['userdetail']['address_line2'] : 'N/A' }}</div>
                    </div>
                </div>
            </div>
            <div class="row mb-1 mx-2">
                <div class="col-md-12 d-flex">
                    ...
                    <div class="col-md-8 align-self-center">
                        <div class="font-family-secondary">
                            {{ $user['userdetail']['city'] ? $user['userdetail']['city'] : 'N/A' }}</div>
                    </div>
                </div>
            </div>
            <div class="row mb-1 mx-2">
                <div class="col-md-12 d-flex">
                    ...
                    <div class="col-md-8 align-self-center">
                        <div class="font-family-secondary">
                            {{ $user['userdetail']['zip'] ? $user['userdetail']['zip'] : 'N/A' }}</div>
                    </div>
                </div>
            </div>
            <div class="row mb-1 mx-2">
                <div class="col-md-12 d-flex">
                    ...
                    <div class="col-md-8 align-self-center">
                        <div class="font-family-secondary">
                            {{ $user['userdetail']['country'] ? $user['userdetail']['country'] : 'N/A' }}</div>
                    </div>
                </div>
            </div>
            <div class="row mb-1 mx-2">
                <div class="col-md-12 d-flex">
                    ...
                    <div class="col-md-8 align-self-center">
                        <div class="font-family-secondary">
                            {{ $user['userdetail']['education'] ? $user['userdetail']['education'] : 'N/A' }}</div>
                    </div>
                </div>
            </div>
            <div class="row mb-1 mx-2">
            ...
            <div class="row mb-1 mx-2">
                <div class="col-md-12 d-flex">
                    ...
                    <div class="col-md-8 align-self-center">
                        <div class="font-family-secondary">17/01/2023</div>
                    </div>
                </div>
            </div>
            <div class="row mb-1 mx-2">
        ...
        <div class="row mb-4 mt-3">
            <div class="col-md-6">
                <div class="row mb-1">
                    ...
                    <div class="col-md-12 d-flex">
                        <div class="col-md-8"><label class="col-form-label" for="total-hours-worked:">Total Hours
                                Worked:</label></div>
                ...
                <div class="row mb-1">
                    <div class="col-md-12 d-flex">
                        <div class="col-md-8"><label class="col-form-label" for="total-hours-returned">Total Hours
                                Returned:</label></div>
                        <div class="col-md-5 align-self-center">
                ...
                <div class="row mb-1">
                    <div class="col-md-12 d-flex">
                        <div class="col-md-8"><label class="col-form-label" for="total-incidents-running-late">Total
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="align-middle">
                                                    <a href="#"
                                                        ...
                                                        <svg aria-label="Message" class="fill" width="20"
                                                            height="28" viewBox="0 0 20 28" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <use xlink:href="/css/sprite.svg#message"></use>
                                                        </svg>
                                                    </a>
                                                </td>
                                            </tr>
    ...
    <div class="tab-pane fade" id="invoices-remittances-tab-pane" role="tabpanel"
        ...
        <div class="d-flex justify-content-between mb-2">
            ...
            <div class="d-inline-flex align-items-center gap-4">
                ...
                <input type="search" class="form-control" id="search-record" name="search-record"
            ...
            <table id="remittances" class="table table-hover" aria-label="Remittance">
                        ...
                        <th scope="col">
                            <div class="form-check">
                                <input class="form-check-input" id="" name="" type="checkbox"
                                    tabindex="" aria-label="Select All Remittances">
                            </div>
                        </th>
                ...
                <tbody>
                    <tr role="row" class="odd">
                        <td>
                            <div class="form-check">
                                <input class="form-check-input" aria-label="Select Remittance" id=""
                            ...
                            <div class="d-flex actions">
                                <a href="#" title="view" aria-label="view"
                                    ...
                                    <svg aria-label="View "width="24" height="17" viewBox="0 0 24 17"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <use xlink:href="/css/sprite.svg#eye-icon"></use>
                                    </svg>
                                </a>
                                <a href="#" title="Send" aria-label="Send"
                                    ...
                                    <svg aria-label="Send" width="20" height="21" viewBox="0 0 20 21"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <use xlink:href="/css/sprite.svg#mapview"></use>
                                    </svg>
                                </a>
                                <a href="#" title="Revert Remittance" aria-label="Revert Remittance"
                                    class="btn btn-sm btn-secondary rounded btn-hs-icon" data-bs-toggle="modal"
                                    data-bs-target="#revertBackModal">
                                    <svg aria-label="Revert Remittance" width="22" height="20"
                                        viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <use xlink:href="/css/sprite.svg#round-arrow"></use>
                                    </svg>
                                </a>
                                <a href="#" title="Mark As Paid" aria-label="Mark As Paid"
                                    class="btn btn-sm btn-secondary rounded btn-hs-icon" data-bs-toggle="modal"
                                    data-bs-target="#markAsPaidModal">
                                    <svg aria-label="Mark As Paid" width="22" height="20" viewBox="0 0 22 20"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <use xlink:href="/css/sprite.svg#dollar-icon"></use>
                                    </svg>
                                </a>
                            </div>
                        </td>
        ...
        <div class="d-flex actions gap-3 justify-content-end mb-2">
            ...
            <div class="d-flex gap-2 align-items-center">
                <a href="#" title="" aria-label="Resend Remittance"
                    class="btn btn-sm btn-secondary rounded btn-hs-icon">
            ...
            <div class="d-flex gap-2 align-items-center">
                <a href="#" title="Revert Remittance" aria-label="Revert Remittance"
                    class="btn btn-sm btn-secondary rounded btn-hs-icon">
                    <svg aria-label="Revert Remittance" width="22" height="20" viewBox="0 0 22 20"
                        fill="none" xmlns="http://www.w3.org/2000/svg">
                        <use xlink:href="/css/sprite.svg#round-arrow"></use>
                    </svg>
                </a>
        ...
        <div class="mb-5">
            ...
            <div>
                <img src="/tenant-resources/images/portrait/small/image-placeholder-assignment-graph.png" height="200"
                    width="800" class="img-fluid" alt="Assignments Report">
            </div>
        </div>
        <div class="mb-4">
            <div class="d-flex justify-content-between">
