    ...
    <div class="modal-content">
        <div class="modal-header justify-center">
            <h2 class="modal-title fs-5 text-center" id="addDocumentLabel">Add Document</h2>
        ...
        <div class="modal-body">
            <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="mb-4">
                            ...
                            <input type="text" id="first-name-column" class="form-control"
                                placeholder="Document Title" name="document-column" />
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
                        <div class="mb-4">
                            <label class="form-label" for="first-name-column">Notes</label>
                            <textarea class="form-control" name="" id="" cols="35" rows="3"></textarea>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-3 d-flex text-center">
                            <a href="#" class="btn btn-outline-primary d-block px-2 pb-0">
                                <svg class="mb-2" width="40" height="36" viewBox="0 0 40 36" fill="none"
                                    ...
                                    <defs>
                                        <linearGradient id="paint0_linear_2957_105057" x1="20" y1="0" x2="36.0479"
                ...
                <div class="col-lg-8 gap-2 d-flex">
                ...
                <div class="col-lg-12 ">
                    ...
                    <div class="col-lg-8 gap-2 d-flex px-4">
                        <input class="form-check-input" type="checkbox" value="">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-5 d-flex gap-1 mb-5 ">
