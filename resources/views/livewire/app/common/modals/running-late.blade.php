        ...
        <div class="row justify-content-center ">
          <div class="col-lg-5">
            ...
            <div class="input-group">
              <input type="number" wire:model.defer="hours" class="form-control form-control-md text-center" value="00" aria-label="Hours">
              <input type="number" wire:model.defer="mins"  class="form-control form-control-md text-center" value="00" aria-label="Hours">
            </div>
          </div>
        </div>
      </div>
