              ...
              <thead>
                <tr role="row">
                  <th scope="col" class="text-center align-middle">
                    <input class="form-check-input" type="checkbox" wire:model.defer="selectAll" wire:click="updateSelectAll" aria-label="Select All Admin">
                  </th>
                ...
                <tr role="row" class="odd">
                  ...
                  <td class="align-middle">
                    <div class="d-flex gap-2 align-items-center">
                      <div>
                        <img width="50" height="50" src="{{$admin->profile_pic!=null? $admin->profile_pic : '/tenant-resources/images/portrait/small/avatar-s-20.jpg'}}" class="rounded-circle" alt="Image">
                      </div>
                      <div class="pt-2">
