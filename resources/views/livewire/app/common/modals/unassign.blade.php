<div class="modal-content">
    ...
    <div class="modal-body">
        <div class="mb-4">
            <label class="form-label">Reason for Unassign {{$booking_id}}</label>
            <textarea class="form-control" rows="5" cols="5" wire:model.defer="data.reason_unassign"></textarea>
        </div>
        <div class="row mb-4">
            <div class="col-lg-6 mb-4">
                ...
                <div class="position-relative">
                    <input wire:model="data.reason_date" type="text" class="form-control js-single-date" placeholder="MM/DD/YYYY" id="reason_date">
                                ...
                                <div class="time d-flex align-items-center gap-2">
                                    <div>
                                        <input class="form-control form-control-sm text-center hours" id="hour"
                                            ...
                                            tabindex="" wire:model.defer="data.hour" maxlength="2">
                                    </div>
                                    ...
                                    <div>
                                        <input class="form-control form-control-sm text-center  mins"
                                            ...
                                            placeholder="00" type="" tabindex="" wire:model.defer="data.min"
                                            maxlength="2">
                                    </div>
                                </div>
                            </div>
