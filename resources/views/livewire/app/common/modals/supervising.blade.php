                ...
                <tr role="row" class="odd">
                  ...
                  <td class="align-middle">
                    <div class="d-flex gap-2 align-items-center">
                      <div>
                        <img width="50" height="50" src="{{$customer->profile_pic!=null? $customer->profile_pic : '/tenant-resources/images/portrait/small/avatar-s-20.jpg'}}" class="rounded-circle" alt="Image">
                      </div>
                      <div class="pt-2">
                        <div class="font-family-secondary leading-none">{{$customer->name}}</div>
                        <a href="" class="font-family-secondary"><small>{{$customer->email}}</small></a>
                      </div>
                    </div>
                  </td>
