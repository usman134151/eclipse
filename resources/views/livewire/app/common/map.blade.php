<div x-data="{ bookingDetails: false, providerSavedForms: false, assignmentDetails: false, addReimbursement: false, step: 1 }">
    ...
    <div class="row mb-1">
        ...
        <div class="col-lg-3 mb-4 mb-lg-1 ">
            ...
            <div class="position-relative align-self-end">
                ...
                <svg aria-label="Date" class="icon-date lg cursor-pointer" width="20" height="20" viewBox="0 0 20 20"
                    fill="none" xmlns="http://www.w3.org/2000/svg">
                    <use xlink:href="/css/provider.svg#date-field" style="padding:0.6rem"></use>
                </svg>
                <input type="" style="padding:0.6rem 0.75rem;min-height:3.125rem"
                    class="form-control form-control-md form-control-date js-single-date" placeholder=""
                    name="selectDate" aria-label="Select Date" id="selectdate" wire:model="selectDate">
        ...
        <div class="col-lg mb-4 mb-lg-0">
            ...
            <input type="text" class="form-control" id="address" name="address" wire:model="selectedAddress"
        ...
        <div class="col-lg mb-4 mb-lg-0">
            ...
            <input type="text" class="form-control" id="BookingID" name="BookingID" wire:model="bookingFilter"
    ...
    <div class="col-sm mb-4">
        ...
        <a href="#" class="btn btn-xs btn-outline-dark rounded" wire:click.prevent="applyFilters">Apply
            Filters</a>
    </div>
    <!-- /Filters -->
