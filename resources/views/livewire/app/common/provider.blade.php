                        ...
                        <div class="card">
                            <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 ms-auto text-end mb-3">
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        wire:click="showForm">
                                                        {{-- Updated by Shanila to Add svg icon--}}
                                                        <svg aria-label="add provider" width="20" height="20"
                                                            viewBox="0 0 20 20">
                                                    ...
                                                    <button type="button" wire:click.prevent="downloadExportFile()"
                                                        class="d-inline-flex align-items-center btn btn-primary rounded px-3 py-2 gap-2">
                                                        {{-- Updated by Shanila to Add svg icon--}}
                                                        ...
                                                        <tbody>
                                                            <tr role="row" class="odd">
                                                                <td class="text-center">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        value="" aria-label="Select Provider">
                                                                </td>
                                                                <td>
                                                                    <div class="row g-2">
                                                                        <div class="col-md-2">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex actions">
                                                                        ...
                                                                        <a href="#" aria-label="View Provider"
                                                                            class="btn btn-sm btn-secondary rounded btn-hs-icon"
                                                                            wire:click="showProfile">
                                                                            {{-- Updated by Shanila to Add svg icon--}}
                                                                            <svg aria-label="View Provider" width="20"
                                                                                height="20" viewBox="0 0 20 20">
                                                                                <use
                                ...
                                <div class="d-flex actions gap-3 justify-content-end mb-2">
                                    ...
                                    <div class="d-flex gap-2 align-items-center">
                                        <a href="#" title="View Provider" aria-label="view Provider"
                                            class="btn btn-sm btn-secondary rounded btn-hs-icon">
