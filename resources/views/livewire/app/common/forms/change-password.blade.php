                ...
                <form class="form">
                  <div class="row">
                    <div class="col-md-12 mb-md-2">
                      <p>For the safety of your account and your information, do not share your account credentials with anyone. To change your account password, enter your old password followed by a new, strong password. 
                        Passwords must contain an upper- and lowercase letter, a number, and a special character.</p>
                      <div class="row">
                        <div class="col-md-4">
                          <div class="mb-4">
