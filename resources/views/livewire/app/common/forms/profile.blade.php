          ...
          <div class="card-body">
            ...
            <div x-data="{ tab: window.location.hash ? window.location.hash.substring(1) : 'profile' }"
              ...
              <div class="tab-content">
                ...
                <!-- BEGIN: User Access -->
                <div class="tab-pane fade" :class="{ 'active show': tab === 'user-access' }"
                  @click.prevent="tab = 'user-access'; window.location.hash = 'user-access'" id="user-access"
                  role="tabpanel" aria-labelledby="user-access-tab" tabindex="0" x-show="tab === 'user-access'">
                  <div class="row mb-4">
                    <div class="col-lg-12">
                      ...
                      <div class="accordion" id="accordionManageUserAccess">
                        <div class="accordion-item">
                          <div id="headingCompaniesCustomerAccess">
                            <div class="accordion-button justify-content-between" data-bs-toggle="collapse"
                          ...
                          <div id="collapseCompaniesCustomerAccess" class="accordion-collapse collapse show"
                                    ...
                                    <td class="text-center">
                                      <a href="" class="btn btn-sm btn-secondary rounded btn-hs-icon d-inline-flex">
                                        <svg width="19" height="20" viewBox="0 0 19 20" fill="none"
                                          ...
                                          <path d="M17.3332 15.8332L13.1665 11.6665M17.3332 11.6665L13.1665 15.8332"
                                            stroke="black" stroke-width="2" stroke-linecap="round" />
                                        </svg>
                                      </a>
                                    </td>
                        ...
                        <div class="accordion-item">
                          <div id="headingTeamsProvidersAccess">
                            <div class="accordion-button justify-content-between" data-bs-toggle="collapse"
                              data-bs-target="#collapseTeamsProvidersAccess" aria-expanded="true"
                        ...
                        <div class="accordion-item">
                          <div id="headingAccommodationServiceAccess">
                            <div class="accordion-button justify-content-between" data-bs-toggle="collapse"
                              data-bs-target="#collapseAccommodationServiceAccess" aria-expanded="true"
                          ...
                          <div id="collapseAccommodationServiceAccess" class="accordion-collapse collapse show"
                            aria-labelledby="headingOne" data-bs-parent="#accordionManageUserAccess">
                            <div class="accordion-body p-0">
                              <div class="d-flex justify-content-between my-2">
                                <div class="d-inline-flex align-items-center gap-4">
