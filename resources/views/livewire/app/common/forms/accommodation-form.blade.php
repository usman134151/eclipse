				...
				<form class="form">
				  <div class="row">
					  ...
					  <div class="row mt-2 mb-5">
						<div class="col-12 text-center">
						  <div class="d-inline-block position-relative">
							...
							<img src="/tenant/images/portrait/small/avatar-s-1.jpg" class="img-fluid rounded-circle" alt="User Image"/>
							<!-- <div>
					...
					<div class="col-12 justify-content-center form-actions d-flex">
					  ...
					  <button type="submit" class="btn btn-outline-dark rounded mx-2" wire:click.prevent="showList">Back</button>
					</div>
				  </div>
				</form>
			  </div>
