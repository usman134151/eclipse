                ...
                <form class="form">
                  <div class="row">
                    <div class="col-md-12 mb-md-2">
                      ...
                      <p>Create a unique name and upload a picture (optional) to set up a new category by which to group your more specific services.</p>
                      
                      <div class="row mt-2 mb-5">
                        <div class="col-12 text-center">
                          <div class="d-inline-block position-relative">
                            
                            <img src="http://elipsedevelopment.localhost:8000/assets/tenant/images/portrait/small/avatar-s-1.jpg" class="img-fluid rounded-circle" alt="User Image"/>
                            <!-- <div>
                            ...
                            <div class="position-absolute end-0 bottom-0 p-0 d-flex justify-content-center align-items-center">
                              <svg width="57" height="57" viewBox="0 0 57 57" fill="none" xmlns="" aria-label="Upload image">
                    ...
                    <div class="col-12 justify-content-center form-actions d-flex">
                      ...
                      <button type="submit" class="btn btn-outline-dark rounded mx-2" >Back</button>
                    </div>
                  </div>
                </form>
              </div>
