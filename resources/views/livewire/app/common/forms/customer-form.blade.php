                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center w-100">
                                                                ...
                                                                <button type="button" class="btn px-2">
                                                                    <svg aria-label="View" width="24"
                                                                        height="17" viewBox="0 0 24 17"
                                                                        fill="none"
                                                                        xmlns="http://www.w3.org/2000/svg">
                                                                        <path
                                            ...
                                            {{-- <form class="form">
                                                    ...
                                                    <div>
                                                        <div class="d-flex gap-5">
                                                            <button type="button"
                                                                ...
                                                                {{-- Updated by Shanila to Add svg icon --}}
                                                                <svg aria-label="Assigned Supervisor(s)"
                                                                    width="25" height="18"
                                                                    viewBox="0 0 25 18">
                                                                    <use
                                                                        xlink:href="/css/common-icons.svg#right-color-arrow">
                                                        ...
                                                        <div class="form-check mb-lg-0">
                                                            <input disabled class="form-check-input" type="checkbox"
                                                                ...
                                                                wire:click="selectSameSupervisor"
                                                                id="AssignSame_User">
                                                ...
                                                <div class="col-lg-12 d-md-flex gap-5 align-items-center mb-4">
                                                    <div class="form-check mb-md-0">
                                                        <input class="form-check-input" type="checkbox"
                                                            value="Yes" wire:model.defer="rolesArr.5"
                                                ...
                                                <div class="col-lg-12 d-md-flex gap-5 mb-4">
                                                    <div class="form-check mb-md-0">
                                                        <input class="form-check-input" type="checkbox"
                                                            value="Yes" wire:model.defer="rolesArr.6"
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="form-check mb-lg-0">
                                                            <input disabled class="form-check-input" type="checkbox"
                                                                wire:model.defer="same_bm"
                                                                wire:click="selectSameBManager" id="Assign-Same-User">
                                                ...
                                                <div class="col-lg-12 mb-4">
                                                    <div class="form-check mb-0">
                                                        <input class="form-check-input" type="checkbox"
                                                            value="Yes" id="Service-Consumer"
                                                            wire:click="$toggle(serviceConsumer)"
                                                ...
                                                <div class="row"
                                                    @if (!$serviceConsumer) style="display:none" @endif>
                                                ...
                                                <div class="col-lg-12 mb-4">
                                                    <div class="form-check mb-0">
                                                        <input class="form-check-input" type="checkbox"
                                                            value="Yes" wire:model.defer="rolesArr.8"
                                                            id="participant">
                                                ...
                                                <div
                                                    ...
                                                    <div class="form-check mb-0">
                                                        <input class="form-check-input" type="checkbox"
                                                            value="Yes" wire:model.defer="rolesArr.9"
                                                    ...
                                                    <div class="d-flex gap-5">
                                                        <button type="button"
                                                            class="btn btn-has-icon px-0 btn-multiselect-popup"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#billManagingModal">
                                                            {{-- Updated by Shanila to Add svg icon --}}
                                                ...
                                                <div class="row between-section-segment-spacing">
                                                    <div class="col-lg-6 mb-4 pe-lg-5">
                                                        ...
                                                        <select name="favored_providers" id="favored_providers"
                                                            ...
                                                            wire:model.defer="favored_providers" tabindex="1"
                                                            multiple aria-label="Select Providers">
                                                    ...
                                                    <div class="col-lg-6 mb-4 ps-lg-5">
                                                        ...
                                                        <select name="unfavored_providers" id="unfavored_providers"
                                                            class=" select2 form-select "
                                                            wire:model.defer="unfavored_providers" tabindex="2"
                                                            multiple aria-label="Select Providers">
                                                            @foreach ($providers as $p)
                                                                <option value="{{ $p->id }}">
                                                                    {{ $p->name }}</option>
