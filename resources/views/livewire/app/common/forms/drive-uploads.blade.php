                                        ...
                                        <div class="col-md-12 d-lg-flex col-12 gap-4">
                                            ...
                                            <div class="col-md-3  col-12">
                                                ...
                                                <div class="position-relative">
                                                    <input type="" wire:model.lazy="dateRange" name="dateRange" id="dateRange" class="form-control js-single-date"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            @if(!$showForm)
                                                ...
                                                <button wire:click="$set('uploadDoc',true)"
                                                        class="btn btn-primary rounded  " type="button">Add New File</button> 
                                            @endif
                                                    ...
                                                    <div class=" row mt-3">
                                                        ...
                                                        <div class="col-lg-6 pe-lg-5 ">
                                                            ...
                                                            <div class="form-check mb-lg-0 mt-1">
                                                                <input class="form-check-input" type="checkbox" wire:click="setExpDate"
                                                                    id="set_exp_date" wire:model.defer="noExp" >
                                                        ...
                                                        <div class="row mt-3">
                                                            ...
                                                            <div class=" ">
                                                                ...
                                                                <button wire:click.prevent="upload"  wire:loading.attr="disabled" wire:target="drive_file" class="btn btn-primary rounded  " type="submit">Upload File</button> 
                                                            </div>
                                                        </div>
                                         ...
                                         @foreach($existingDocuments as $index=> $doc)
                                            ...
                                            <div class="d-lg-inline-flex">
                                                <div class="mx-2" style="max-width:190px">
                                                    ...
                                                    <p>Expiration : {{ date_format(date_create($doc->expiration_date), "m/d/Y")}}</p>@endif
                                                    <p>{{$doc->note}}</p>
