            ...
            <div class="card-body">
              <!-- BEGIN: Steps -->
                ...
                <div class="tab-content">
                  <div class="tab-pane fade show active" id="configuration-setting" role="tabpanel" aria-labelledby="configuration-setting-tab" tabindex="0">
                    <div class="row">
                      <div class="col-lg-12">
                  ...
                  <div class="tab-pane fade" id="business-hours" role="tabpanel" aria-labelledby="business-hours-tab" tabindex="0">
                    <div class="row mb-4" >
                        <div class="col-lg-12">
