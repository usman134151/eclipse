                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="form-check form-switch mb-0">
                                                                <input class="form-check-input"
                                                                    ...
                                                                    role="switch" id="providerPayroll" checked="">
                                                                <input class="form-check-input"
                                                                    aria-label="Toggle Provider Payroll" type="checkbox"
                                                                    role="switch">
                                                            </div>
                                                            ...
                                                            <div class="between-section-segment-spacing">
                                                                <div class="col-lg-12 mb-4">
                                                                    ...
                                                                    <input class="form-control" type=""
                                                                        id="reimburseProviders" placeholder="$00:00">
                                                                </div>
                                                                <div class="col-lg-12 mb-4">
                                                                    <div class="d-lg-flex ">
                                                                        <label class="form-label"
                                                            ...
                                                            <div class="col-lg-12 mb-4">
                                                                <div class="form-check form-switch">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        ...
                                                                        id="customerBilling">
                                                                    <label class="form-check-label">Customer
                                                                        Billing</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12 mb-4">
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="mx-4 mb-4">
                                                                    ...
                                                                    <div class="mx-4">
                                                                        <div class="mb-2">
                                                                            ...
                                                                            <select id="invoice-submission-day1"
                                                                                class="form-select">
                                                                ...
                                                                <div class="mx-4 mb-4">
                                                                    ...
                                                                    <div class="mx-4">
                                                                        <div class="mb-2">
                                                                            ...
                                                                            <select id="invoice-submission-day2"
                                                                                class="form-select">
                                                                                <option>Friday</option>
                                                                            </select>
                                                                        </div>
                                                                ...
                                                                <div class="mx-4 mb-4">
                                                                    <div class="mb-2">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="radio"
                                                                                name="Hrs" id="EveryMonthStarting"
                                                                                checked>
                                                                            <label class="form-check-label"
                                                                    ...
                                                                    <div class="mx-4">
                                                                        <div class="mb-2">
                                                                            ...
                                                                            <select id="invoice-submission-day3"
                                                                                class="form-select">
                                                                                <option>4th</option>
                                                                            </select>
                                                                        </div>
                                                                ...
                                                                <div class="mx-4">
                                                                    <div class="mb-2">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="radio"
                                                                                name="Hrs" id="on-select-days-of-month"
                                                                                checked>
                                                                            <label class="form-check-label"
                                                                    ...
                                                                    <div class="mx-4">
                                                                        <div class="mb-2">
                                                                            ...
                                                                            <select id="invoice-submission-day4"
                                                                                class="form-select">
                                                                                <option>4th</option>
                                                                            </select>
                                                                        </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-check">
                                                                <input class="form-check-input" id="attachSendQuotes"
                                                                    name="attachSendQuotes" type="checkbox"
                                                                    tabindex="" />
                                                                <label class="form-check-label"
                                                ...
                                                <div class="between-section-segment-spacing">
                                                    ...
                                                    <div class="row mb-4">
                                                        <div class="col-lg-12">
                                                            <div class="form-check">
                                                                <input class="form-check-input"
                                                                    id="add-to-customer-drive" name="customerDrive"
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input" id="provider-Drive"
                                                        ...
                                                        <div class="col-lg-12 mb-4">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="form-check">
                                                                        <input class="form-check-input"
                                                                            id="Requesteraboutprovider" name=""
                                                                            type="checkbox" tabindex="" />
                                                                        <label class="form-check-label"
