            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs nav-steps" id="myTab" role="tablist">
                    ...
                    @if($configuration['portal_url']!="")
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {{ $component == 'business-hours' ? 'active' : '' }}" @click.prevent="$wire.switch('business-hours')" wire:click.prevent="getBusinessSchedule()"
                                        ...
                                        <div class="row inner-section-segment-spacing">
                                            ...
                                            <div class="col-md-3 col-lg-6 mb-4 align-self-end ps-lg-5">
                                                @if ($company_logo!=null)
                                                    <img class="user_img w-50"    src="{{ '/tenant'.tenant('id').'/app/livewire-tmp/'.$company_logo->getFilename() }}">
                                                @else
                                                    <img class="user_img w-50"  src="{{$configuration->company_logo == null ? '' : url($configuration->company_logo) }}">
                                                @endif
                                        ...
                                        <div class="row inner-section-segment-spacing">
                                            ...
                                            <div class="col-md-3 col-lg-6 mb-4 align-self-end ps-lg-5 ">
                                                @if ($login_screen!=null)
                                                    <img class="user_img w-50"  src="{{ '/tenant'.tenant('id').'/app/livewire-tmp/'.$login_screen->getFilename() }}">
                                                @else
                                                    <img class="user_img w-50"  src="{{$configuration->login_screen == null ? '' : url($configuration->login_screen) }}">
                                                @endif
                        ...
                        @livewire('app.common.setup.business-hours-setup', ['model_id' => 1, 'model_type' => '1'])
                                ...
                                <div class="col-12 justify-content-center form-actions d-flex flex-column flex-md-row gap-2">
                                    <button type="button" class="btn btn-outline-dark rounded mx-2"
                                        x-on:click="$wire.switch('configuration-setting')" wire:click.prevent="saveSchedule">Back</button>
                                    <button type="button" class="btn btn-primary rounded"
                                        x-on:click="$wire.switch('payments')" wire:click.prevent="saveSchedule">Next</button>
                                </div><!-- /Form Actions -->
                        @endif
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <!-- /Duplicate Block -->
                                                    ...
                                                    <div class="col-12 justify-content-center form-actions d-flex flex-column flex-md-row gap-2">
                                                        <button type="button" class="btn btn-outline-dark rounded mx-2"
                                                            x-on:click="$wire.switch('business-hours')" wire:click.prevent="getBusinessSchedule()">Back</button>
