                                                        ...
                                                        <div class="col-md-6 mb-md-2">
                                                            ...
                                                            <div class="d-flex actions gap-3 justify-content-end mb-3">
                                                                <div class="d-flex gap-2 align-items-center">
                                                                    <a href="#" title="Customers" aria-label="Customers"
                                                                        class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                                                        <svg aria-label="Customers" class="fill"
                                                                ...
                                                                <div class="d-flex gap-2 align-items-center">
                                                                    <a href="#" title="Customize Pricing"
                                                                        aria-label="Customize Pricing"
                                                                        class="btn btn-sm btn-secondary rounded btn-hs-icon">
                                                                        <svg aria-label="Customize Pricing" class="fill"
                                                                            width="21" height="20" viewBox="0 0 21 20"
                                                                            fill="none"
                                                                            xmlns="http://www.w3.org/2000/svg">
                                                                            <use xlink:href="/css/sprite.svg#building">
                                                                            </use>
                                                                        </svg>
                                                                    </a>
                                                                    <span class="text-sm">
                                                                ...
                                                                <div class="col-md-2  text-center ">
                                                                    <div class=" border border-primary rounded ">
                                                                        <svg width="40" height="36" viewBox="0 0 40 36"
                                                                            ...
                                                                            <defs>
                                                                                <linearGradient
                                                                                    id="paint0_linear_2957_105057"
                                                                                    x1="20" y1="0" x2="36.0479" y2="0"
                                                                        ...
                                                                        <p class="text-primary mt-2">Attach from Company
                                                                            Drive </p>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-2  rounded text-center">
                                                                    <div class=" border-primary rounded ">
                                                                        <svg width="40" height="36" viewBox="0 0 40 36"
                                                                            class="mt-2" class="mt-2" fill="none"
                                                                            xmlns="http://www.w3.org/2000/svg">
                                                                            <path
                                                                                d="M16.35 23.4921L9.702 35.2381H33.35L40 23.4921H16.35ZM11.73 2.54302L0 23.3237L6.744 35.2342L18.476 14.4535L11.73 2.54302ZM38.89 21.5344L26.698 0H13.208L25.384 21.5344H38.89Z"
                                                                                fill="url(#paint0_linear_2957_105057)" />
                                                                        ...
                                                                        <p class="text-primary mt-2">Attach from Google
                                                                            Drive </p>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-2 rounded text-center">
                                                                    <div class=" border border-primary rounded ">
                                                                        <svg width="35" height="35" viewBox="0 0 35 35"
                                                                            ...
                                                                            <defs>
                                                                                <linearGradient
                                                                                    id="paint0_linear_2957_105064"
                                                                                    x1="17.5" y1="0" x2="31.5419" y2="0"
                                                                                    gradientUnits="userSpaceOnUse">
                                                                                    <stop stop-color="#213969" />
                                                                                    <stop offset="1"
                                                                                        stop-color="#204387" />
                                                                        ...
                                                                        <p class="mt-3 text-primary py-1">Attach from
                                                                            Disk</p>
