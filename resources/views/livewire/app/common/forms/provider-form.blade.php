							...
							<div class="row">
				                ...
				                <div class="col-lg-6 mb-4 pe-lg-5">
				                  <div class="d-flex justify-content-between align-items-center mb-1">
				                    <label class="form-label mb-lg-0" for="gender-column">Gender</label>
				                ...
				                <div class="col-lg-6 mb-4 pe-lg-5">
				                  <label class="form-label" for="start-date-column">Start Date</label>
				                  <div class="d-flex align-items-center w-100">
				                    <div class="position-relative flex-grow-1">
				                ...
				                <div class="col-lg-6 mb-4 ps-lg-5">
				                  <label class="form-label" for="end-date-column">End Date</label>
				                  <div class="d-flex align-items-center w-100">
				                    <div class="position-relative flex-grow-1">
						                                  ...
						                                  <div class="d-flex align-items-center gap-4">
						                                    <div>
						                                      <div class="form-check mb-0">
						                                        ...
						                                        <label class="form-check-label" for="ContractProviderType"> Contract Provider </label>
						                            ...
						                            <div class="d-flex flex-column gap-3">
						                              <div class="d-lg-flex gap-4">
						                                ...
						                                <div class="align-self-end">
						                                  <label class="form-label text-primary">In-Person</label>
						                                  <input type="text" class="form-control text-center" placeholder="00.00" aria-label="" aria-describedby="">
						                                </div>
						                                <div class="align-self-end">
						                                  <label class="form-label text-primary">Virtual</label>
						                                  <input type="text" class="form-control text-center" placeholder="00.00" aria-label="" aria-describedby="">
						                                </div>
						                                <div class="align-self-end">
						                                ...
						                                <div class="align-self-end">
						                                  <label class="form-label text-primary">Teleconference</label>
						                                  <input type="text" class="form-control text-center" placeholder="00.00" aria-label="" aria-describedby="">
						                                </div>
						                              </div>
						                              <div class="mx-5">
						                                <div class="d-flex">
						                                  <div class="form-check form-check-inline">
						                                    ...
						                                    <label class="form-check-label" for="hide-from-customers"><small>Hide from Customers</small></label>
						                                  </div>
						                                  <div class="form-check form-check-inline">
						                                    <input class="form-check-input" id="hide-from-providers" name="" type="checkbox" tabindex="" />
						                                    <label class="form-check-label" for="hide-from-providers"><small>Hide from Providers</small></label>
						                                  </div>
						                                  <div class="form-check form-check-inline">
						                                    <input class="form-check-input" id="x-by-duration" name="" type="checkbox" tabindex="" />
						                                    <label class="form-check-label" for="x-by-duration"><small>X by Duration</small></label>
						                                  </div>
						                                </div>
						                              </div>
						                            </div>
