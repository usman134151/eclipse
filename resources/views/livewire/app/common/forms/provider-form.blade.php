					  ...
					  <div class="row">
						<div class="col-md-12 mb-md-2">
						  ...
						  <div class="row">
							...
							<div class="col-md-6 col-12">
							  <div class="mb-4">
								<label class="form-label" for="education-column">Education</label>
							...
							<div class="col-md-6 col-12">
							  <div class="mb-4">
								<label class="form-label" for="certifications-column">Certification(s)</label>
							  
								<select class="select2 form-select" id="certifications-column">
								  <option>Select Certification(s)</option>
								</select>
							  </div>
							</div>
							<div class="col-md-6 col-12">
							...
							<div class="col-md-6 col-12">
							  <div class="mb-4">
								<label class="form-label" for="phone">Provider ID</label>
								<input
								  type="text"
								  id="phone"
								  class="form-control"
							...
							<div class="col-md-6 col-12">
							  <div class="mb-4">
								<label class="form-label" for="phone">Zip Code</label>
								<input
								  type="text"
								  id="phone"
								  class="form-control"
						  ...
						  <div class="row">
							...
							<div class="col-md-6 col-12">
							  <div class="mb-4">
								<label class="form-label" for="companeyAdmins">Company-Admin(s)</label>
								<input
								  type="text"
								  id="companeyAdmins"
								  class="form-control"
							...
							<div class="col-md-6 col-12">
							  <div class="mb-4">
								<label class="form-label" for="payment-settings">Payment Settings</label>
							...
							<div class="col-md-6 col-12">
							  <div class="mb-4">
								<label class="form-label" for="remittance-temp">Select Default Remittance Template</label>
								<select class="select2 form-select" id="remittance-temp">
								  <option value="Al">Select Default Remittance Template</option>
								</select>
							  </div>
							</div>
							<div class="col-md-6 col-12">
						...
						<div class="col-md-12 col-12 mb-md-2">
						  <div class="row">
							<div class="col-md-5 col-12">
							  <h2>Provider Application Questions</h2>
							  <div class="row">
								<div class="col-6 mb-1">
								  <div class="form-check">
									<input class="form-check-input" type="radio" name="contract-provider" id="flexRadioDefault1">
									<label class="form-check-label" for="flexRadioDefault1">
									  Contract Provider
									</label>
								</div>
								<div class="form-check">
								  <input class="form-check-input" type="radio" name="staff-provider" id="flexRadioDefault1">
								  <label class="form-check-label" for="flexRadioDefault1">
									Staff Provider
								  </label>
							  </div>
							  <div class="form-check">
								<input class="form-check-input" type="radio" name="Aagency-provider" id="flexRadioDefault1">
								<label class="form-check-label" for="flexRadioDefault1">
								  Agency Provider
								</label>
							</div>
